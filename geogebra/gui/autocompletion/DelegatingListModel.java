...
/**
 * A simple {@link ListModel} implementation which forwards to a list.
 * This list should be set via the {@link #setDataList(List)} method. 
 * 
...
public class DelegatingListModel extends AbstractListModel {
	...
	/**
	 * Method for passing in the backing list for this {@link ListModel} instance.
	 * If the list changes after it was passed in one must call {@link #setDataList(List)} again.
	 * 
