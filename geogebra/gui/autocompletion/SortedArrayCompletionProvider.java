...
/**
 * Abstract base class for {@link CompletionProvider} implementations.
 * Data is backed by an array which will be sorted in the constructor.
 * 
 * @param <T> The type of the completion options; must implement Comparable
 * 
 * @author Julian Lettner
 */
public abstract class SortedArrayCompletionProvider<T extends Comparable<T>> implements CompletionProvider<T> {

	private final T[] sortedCompletionOptions;
	private final boolean caseInsensitiveCompletion;

	/**
	 * Constructor will sort the array.
	 * The caller is responsible for creating a defensive copy.
	 * 
	 ...
	 * 
	 */
	public SortedArrayCompletionProvider(T[] unsortedCompletionOptions, boolean caseInsensitiveCompletion) {
	...
	private boolean isValidCompletionOpiton(String prefixWithProperCase, String option) {
