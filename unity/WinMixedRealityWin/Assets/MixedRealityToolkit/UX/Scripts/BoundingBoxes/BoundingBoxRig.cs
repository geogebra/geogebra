...
namespace MixedRealityToolkit.UX.BoundingBoxes
{
    public class BoundingBoxRig : MonoBehaviour
    {
        ...
        // J.B.: Need to change to have bigger rotate handlers
        //private Vector3 scaleHandleSize = new Vector3(0.04f, 0.04f, 0.04f); 
        [Header("Bounding box controllers")]
        [SerializeField]
        [Tooltip("Size of scale handlers. (Default value is 0.04)")]
        private Vector3 scaleHandleSize = new Vector3(0.1f, 0.1f, 0.1f);

        [SerializeField]
        [Tooltip("Size of rotation handlers. (Default value is 0.04)")]
