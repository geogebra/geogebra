...
!ifndef uninstaller
  ...
  !define MUI_FINISHPAGE_RUN $INSTDIR\GeoGebraSMART.exe
...
Section Install Install
  ...
  !ifndef uninstaller
    ...
    ${If} 1 = $ASSOCIATE_GGB
      ...
      WriteRegStr SHCTX Software\Classes\GeoGebra.File\DefaultIcon "" $INSTDIR\GeoGebraSMART.exe,0
      WriteRegStr SHCTX Software\Classes\GeoGebra.File\shell\open\command "" '"$INSTDIR\GeoGebraSMART.exe" "%1"'
    ...
    ${If} 1 = $ASSOCIATE_GGT
      ...
      WriteRegStr SHCTX Software\Classes\GeoGebra.Tool\DefaultIcon "" $INSTDIR\GeoGebraSMART.exe,0
      WriteRegStr SHCTX Software\Classes\GeoGebra.Tool\shell\open\command "" '"$INSTDIR\GeoGebraSMART.exe" "%1"'
