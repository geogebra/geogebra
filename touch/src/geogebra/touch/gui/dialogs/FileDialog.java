...
public abstract class FileDialog extends PopupPanel
{
	...
	// StandardImageButton(DefaultIcons.INSTANCE.dialog_ok());
	...
	private StandardImageButton deleteButton = new StandardImageButton(getLafIcons().dialog_trash());
	...
	{
		String html = "<img src=\"" + getLafIcons().dialog_ok().getSafeUri().asString()
