...
public class LineStyleBar extends FlowPanel {
	...
	for (int i = 0; i < lineStyle.length; i++) {
		...
		public void onClick(ClickEvent event) {
		    ...
		    if (touchModel.getCommand().equals(ToolBarCommand.Pen) || touchModel.getCommand().equals(ToolBarCommand.FreehandShape)) {
	...
	} else if (touchModel.getCommand().equals(ToolBarCommand.Pen) || touchModel.getCommand().equals(ToolBarCommand.FreehandShape)) {
