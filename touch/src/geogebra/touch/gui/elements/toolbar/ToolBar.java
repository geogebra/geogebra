...
public class ToolBar extends FlowPanel {
	...
	public ToolBar(final TouchModel touchModel, TouchApp app, TabletGUI gui) {
		...
		this.showHideClosed = new ArrowImageButton(TouchEntryPoint
				.getLookAndFeel().getIcons().triangle_left());
		this.showHideOpened = new ArrowImageButton(TouchEntryPoint
				.getLookAndFeel().getIcons().triangle_left());
	...
	private void makeTabletToolBar(final TouchModel model) {
		...
		this.tools.add(new ToolBarButton(ToolBarMenu.ManipulateObjects, model
				.getGuiModel()));
		this.tools
