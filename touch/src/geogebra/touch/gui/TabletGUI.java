...
public class TabletGUI extends HeaderPanel implements GeoGebraTouchGUI {
	...
	this.stylingBar = new StyleBar(this.touchModel, this.euclidianViewPanel.getEuclidianView());
	this.touchModel.getGuiModel().setStylingBar(this.stylingBar);
	...
	this.algebraButton = new StandardImageButton(TouchEntryPoint.getLookAndFeel().getIcons().triangle_left());
	this.algebraButton.setStyleName("arrowRight");
	this.algebraButton = TouchEntryPoint.getLookAndFeel().setAlgebraButtonHandler(this.algebraButton, this);
	...
	this.algebraButton.setStyleName(algebraVisible ? "arrowRight" : "arrowLeft");
