...
public enum ToolBarMenu {
    ...
    Line(ToolBarCommand.LineThroughTwoPoints, new ToolBarCommand[] { ToolBarCommand.LineThroughTwoPoints, ToolBarCommand.SegmentBetweenTwoPoints,
	    ToolBarCommand.RayThroughTwoPoints, ToolBarCommand.PolylineBetweenPoints, ToolBarCommand.VectorBetweenTwoPoints,
