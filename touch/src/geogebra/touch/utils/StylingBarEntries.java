...
{
	Point(GColor.blue, new SVGResource[] { CommonResources.INSTANCE.color(), CommonResources.INSTANCE.label() }), 
	DependentPoints(GColor.darkGray,
	    new SVGResource[] { CommonResources.INSTANCE.color(), CommonResources.INSTANCE.label() }), 
	Line(GColor.black,
	    new SVGResource[] { CommonResources.INSTANCE.color(), CommonResources.INSTANCE.properties_default() }), 
	Polygon(new GColorW(153, 51, 0),
	    new SVGResource[] { CommonResources.INSTANCE.color(), CommonResources.INSTANCE.properties_default() }), 
	Move(null, 
