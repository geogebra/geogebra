...
public enum ToolBarCommand {
  ...
  AttachDetachPoint(EuclidianConstants.MODE_ATTACH_DETACH, getLafIcons().attach_detach_point(), StylingBarEntries.Point), ComplexNumbers(
      ...
      EuclidianConstants.MODE_POINT, getLafIcons().new_point(), StylingBarEntries.Point), PointOnObject(EuclidianConstants.MODE_POINT_ON_OBJECT,
      getLafIcons().point_on_object(), StylingBarEntries.Point),
  ...
  AngleBisector(EuclidianConstants.MODE_ANGULAR_BISECTOR, getLafIcons().angle_bisector(), StylingBarEntries.Line), BestFitLine(
      EuclidianConstants.MODE_FITLINE, getLafIcons().best_fit_line(), StylingBarEntries.Line), Locus(EuclidianConstants.MODE_LOCUS, getLafIcons()
      .locus(), StylingBarEntries.Line), ParallelLine(EuclidianConstants.MODE_PARALLEL, getLafIcons().parallel_line(), StylingBarEntries.Line), PerpendicularBisector(
      EuclidianConstants.MODE_LINE_BISECTOR, getLafIcons().perpendicular_bisector(), StylingBarEntries.Line), PerpendicularLine(
      EuclidianConstants.MODE_ORTHOGONAL, getLafIcons().perpendicular_line(), StylingBarEntries.Line), PolarOrDiameterLine(
  ...
  CircleThroughThreePoints(EuclidianConstants.MODE_CIRCLE_THREE_POINTS, getLafIcons().circle_through_three_points(), StylingBarEntries.Line), CircleWithCenterThroughPoint(
      ...
      EuclidianConstants.MODE_CIRCLE_SECTOR_THREE_POINTS, getLafIcons().circular_sector_with_center_between_two_points(), StylingBarEntries.Line), CircumCirculuarArcThroughThreePoints(
      EuclidianConstants.MODE_CIRCUMCIRCLE_ARC_THREE_POINTS, getLafIcons().circumcircular_arc_through_three_points(), StylingBarEntries.Line), CircumCircularSectorThroughThreePoints(
      EuclidianConstants.MODE_CIRCUMCIRCLE_SECTOR_THREE_POINTS, getLafIcons().circumcircular_sector_through_three_points(), StylingBarEntries.Line), Compasses(
      EuclidianConstants.MODE_COMPASSES, getLafIcons().compasses(), StylingBarEntries.Line), Semicircle(EuclidianConstants.MODE_SEMICIRCLE,
      getLafIcons().semicircle(), StylingBarEntries.Line),
  ...
  ConicThroughFivePoints(EuclidianConstants.MODE_CONIC_FIVE_POINTS, getLafIcons().conic_through_5_points(), StylingBarEntries.Line), Ellipse(
      ...
      EuclidianConstants.MODE_HYPERBOLA_THREE_POINTS, getLafIcons().hyperbola(), StylingBarEntries.Line), Parabola(EuclidianConstants.MODE_PARABOLA,
      getLafIcons().parabola(), StylingBarEntries.Line),

  // Measurement
  Angle(EuclidianConstants.MODE_ANGLE, getLafIcons().angle(), StylingBarEntries.Angle), Area(EuclidianConstants.MODE_AREA, getLafIcons().area(), null), CreateList(
      EuclidianConstants.MODE_CREATE_LIST, getLafIcons().create_list(), null), DistanceOrLength(EuclidianConstants.MODE_DISTANCE, getLafIcons()
      .distance_or_length(), null), Slope(EuclidianConstants.MODE_SLOPE, getLafIcons().slope(), null),
  ...
  FreehandShape(EuclidianConstants.MODE_FREEHAND_SHAPE, getLafIcons().freehand_shape(), StylingBarEntries.Line), InsertImage(
      EuclidianConstants.MODE_IMAGE, getLafIcons().insert_image(), null), InsertText(EuclidianConstants.MODE_TEXT, getLafIcons().insert_text(), null), Pen(
      EuclidianConstants.MODE_PEN, getLafIcons().pen(), StylingBarEntries.Line), RelationBetweenTwoObjects(EuclidianConstants.MODE_RELATION,
      getLafIcons().relation_between_two_objects(), null),
