...
public class TouchApp extends AppWeb {
	...
	this.getEuclidianView1().getEuclidianController().stopCollectingMinorRepaints();
	...
	if (!this.getConstructionTitle().equals("")) {
	    ...
	    this.setConstructionTitle(TouchEntryPoint.browseGUI.getChosenMaterial().getMaterialTitle());
	}
	...
	dock[0] = new DockPanelData(App.VIEW_EUCLIDIAN, "", true, false, true, new GPoint(0, 0), AwtFactory.prototype.newDimension(width
	...
	this.setConstructionTitle(this.fm.getDefaultConstructionTitle(this.getLocalization()));
	...
	this.showErrorDialog(this.getLocalization().getError(key) + ": " + error);
    }
