...
public class CurrentFile extends BuiltinFunction
{
    ...
    {
        getTopOfStackPointer(aEnvironment, aStackTop).setCons(AtomCons.getInstance(aEnvironment, aStackTop, aEnvironment.getTokenHash().lookUpStringify(aEnvironment.iInputStatus.fileName())));
    }
}
