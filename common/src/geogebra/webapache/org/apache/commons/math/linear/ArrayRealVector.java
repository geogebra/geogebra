...
public class ArrayRealVector extends AbstractRealVector implements Serializable {
    ...
    /** Default format. */
//AR    private static final RealVectorFormat DEFAULT_FORMAT =
//AR        RealVectorFormat.getInstance();
    ...
    public ArrayRealVector(double[] d) {
    	data = new double[d.length];//AR
    	for (int i = 0; i < d.length; i++)//AR
    		data[i] = d[i];//AR
        data = d;//AR .clone();
    }
    ...
    public ArrayRealVector(ArrayRealVector v, boolean deep) {
        ...
        //AR data = deep ? v.data.clone() : v.data;
    }
    ...
    public RealVector add(RealVector v)
        ...
        if (v instanceof ArrayRealVector) {
            ...
            double[] out = new double[data.length]; //AR data.clone();
            Iterator<Entry> it = v.sparseIterator();
            Entry e;
            while (it.hasNext() && (e = it.next()) != null) {
                out[e.getIndex()] = data[e.getIndex()] + e.getValue();//AR += e.getValue();
            }
    ...
    public RealVector ebeMultiply(RealVector v)
        ...
        if (v instanceof ArrayRealVector) {
            ...
            double[] out = new double[data.length]; //AR data.clone();
            for (int i = 0; i < data.length; i++) {
                out[i] = data[i] * v.getEntry(i);//AR *= v.getEntry(i);
            }
            return new ArrayRealVector(out, false);
        }
    }
   ...
   /** Find the orthogonal projection of this vector onto another vector.
    ...
    public RealMatrix outerProduct(RealVector v)
        ...
        if (v instanceof ArrayRealVector) {
            ...
            final RealMatrix out = new Array2DRowRealMatrix(m, m); //AR MatrixUtils.createRealMatrix(m, m);
            for (int i = 0; i < data.length; i++) {
    ...
    public String toString(){
        return "TODOPORTAPACHEMATH";//AR DEFAULT_FORMAT.format(this);
    }
