...
public class GeoPolygon3D extends GeoPolygon implements GeoPolygon3DInterface, ViewCreator, RotateableND, MirrorableAtPlane {
	...
	/**
	 * 
	 * @param coordSys coord sys to update
	 * @param points points that create the coord sys
	...
	/**
	 * Yields true if the points of this polygon are equal to the points of polygon
	 * p.
	 */
	@Override
