...
import geogebra.common.geogebra3D.kernel3D.algos.AlgoDrawingPadCorner3D;
import geogebra.common.geogebra3D.kernel3D.algos.AlgoVertexConic3D;
...
public class CmdVertex3D extends CmdVertex{
	...
	protected GeoPointND cornerOfDrawingPad(String label, NumberValue number,
		...
		if (!kernelA.getLoadingMode() && ev != null && AlgoDrawingPadCorner3D.is3D(ev)){
