...
public class EuclidianViewForPlaneCompanion extends EuclidianViewFor3DCompanion{
	...
	public void setTransformRegardingView(){
		...
		Coords directionView3D = ((EuclidianView3D) view.getApplication().getEuclidianView3D()).getViewDirection();
		CoordMatrix toScreenMatrix = ((EuclidianView3D) view.getApplication().getEuclidianView3D()).getToScreenMatrix();
	...
	public String getTranslatedFromPlaneString(){
		...
		if (plane instanceof GeoPlaneND) {
			return view.getApplication().getLocalization().getPlain("PlaneA",((GeoElement) plane).getLabel(StringTemplate.defaultTemplate));
		}
		return view.getApplication().getLocalization().getPlain("PlaneFromA",((GeoElement) plane).getLabel(StringTemplate.defaultTemplate));
	}
	 ...
	 * @param repaint says if repaint is needed
	 */
