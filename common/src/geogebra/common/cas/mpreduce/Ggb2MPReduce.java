...
public class Ggb2MPReduce {
	...
	public Map<String,String> getMap() {
		...
		p("Derivative.1",
				"<< begin scalar input!!; input!!:=(%0);return df(input!!,mymainvar(input!!)) end>>");
		...
		p("TaylorSeries.3",
				"<<on div$ off pri$ taylortostandard(taylor(%0,currentx!!,%1,%2))>>");
		p("TaylorSeries.4",
				"<<on div$ off pri$ taylortostandard(taylor(%0,%1,%2,%3))>>");
		p("TDistribution.2",
