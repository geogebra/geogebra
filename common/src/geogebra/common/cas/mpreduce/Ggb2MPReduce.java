...
public class Ggb2MPReduce {
	...
	public Map<String,String> getMap() {
		...
		p("Integral.3",
				"<<begin scalar integral!!, input!!; input!!:=(%0); let intrules!!;on combineexpt; integral!!:=myint(input!!,mymainvar(input!!),%1,%2); clearrules intrules!!; return if freeof(integral!!,\\'int) then integral!! else num\\_int(input!!,mainvar(input!!),%1,%2) end>>");
		p("Integral.4",
