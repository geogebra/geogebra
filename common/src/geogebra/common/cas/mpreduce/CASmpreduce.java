...
public abstract class CASmpreduce implements CASGenericInterface {
	...
	protected static final void initStaticMyMPReduceFunctions(Evaluate mpreduce1)
		...
		mpreduce1.evaluate("let({sless(~arg1,~arg2) => 'true when mynumberp(arg1-arg2) = 'true and mycompare(arg1,arg2) = -1,"
				...
				+ " sequal(~arg1,~arg2) => 'false when mynumberp(arg1-arg2) = 'true and not (mycompare(arg1,arg2) = 0),"
		...
		mpreduce1.evaluate("procedure mydivision(a,b); " +
