...
public interface GeoGebraConstants {
	...
	public static final String BUILD_DATE = "04 December 2011";
    public static final String VERSION_STRING = "4.1.26.0"; // <- update lines below when this is updated 
    //current 3D: "4.9.9.0" 
    //current ggb42: "4.1.26.0" 
