...
public interface GeoGebraConstants {
	...
	public static final String BUILD_DATE = "30 January 2012";
	public static final String VERSION_STRING = "4.9.19.0"; // <- update lines
															// below when this
															// is updated
	// current 3D: "4.9.18.0"
	// current ggb42: "4.1.49.0"
	...
	public static final String SITE_NAME = "http://www.geoegbra.org/";
