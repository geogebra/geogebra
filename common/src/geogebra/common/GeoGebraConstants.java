...
public interface GeoGebraConstants {
	...
	public static final String BUILD_DATE = "03 June 2012";
	public static final String VERSION_STRING = "4.1.87.0"; // <- update lines
															// below when this
															// is updated
	// current 3D: "4.9.22.0"
	// current ggb42: "4.1.87.0"
	...
	public static final String GGW_ABOUT_TEAM_URL="http://www.geogebra.org/cms/team";
