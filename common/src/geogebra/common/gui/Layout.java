...
public abstract class Layout {
	...
	protected static void initializeDefaultPerspectives(boolean showAllTools) {
		...
		dpData[4] = new DockPanelData(AbstractApplication.VIEW_PROPERTIES, null, false, false, false, AwtFactory.prototype.newRectangle(100, 100, 700, 500), "1,1,1", 400);
		...
		dpData[4] = new DockPanelData(AbstractApplication.VIEW_PROPERTIES, null, false, false, false, AwtFactory.prototype.newRectangle(100, 100, 700, 500), "1,1", 400);
