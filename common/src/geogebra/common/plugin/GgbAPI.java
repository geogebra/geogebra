...
public abstract class GgbAPI {
   ...
   // private PluginManager       pluginmanager=      null;    
	...
	public synchronized void setColor(String objName, int red, int green, int blue) {
		GeoElement geo = kernel.lookupLabel(objName);
		if (geo == null) return;		
		geo.setObjColor(geogebra.common.factories.AwtFactory.prototype.newColor(red, green, blue));
		geo.updateRepaint();
	}	
	...
	public synchronized String getColor(String objName) {
		GeoElement geo = kernel.lookupLabel(objName);
		if (geo == null) return "";		
		return "#" + geogebra.common.util.StringUtil.toHexString(geo.getObjectColor());		
	}	
