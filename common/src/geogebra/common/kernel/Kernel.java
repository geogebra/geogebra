...
public class Kernel {
	...
	*/
	...
	// this is actually a macro
			String label, GeoPoint2 A, GeoPoint2 B, GeoPoint2 C) {
	...
	final public static GeoPoint2[] RootMultiple(GeoFunction f) {
		// allow functions that can be simplified to factors of polynomials
		if (!f.isPolynomialFunction(true))
			return null;
	...
	public GeoElement AttachCopyToView(String label, GeoElement geoElement,
		...
		AlgoAttachCopyToView algo = new AlgoAttachCopyToView(cons,label,geoElement,viewID,corner1,corner3,corner5);
		return algo.getResult();
	}
