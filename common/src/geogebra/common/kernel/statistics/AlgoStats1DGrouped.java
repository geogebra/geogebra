...
public abstract class AlgoStats1DGrouped extends AlgoElement {
	...
	// OK
	public AlgoStats1DGrouped(Construction cons, String label, GeoList geoList, GeoList geoList2, int stat) {
		this(cons, label, geoList, geoList2, null, stat);
	}

	// OK
	AlgoStats1DGrouped(Construction cons, String label, GeoList geoList, GeoList geoList2, GeoNumeric Truncate, int stat) {
		this(cons, geoList, geoList2, Truncate, stat);
		result.setLabel(label);
	}

	// OK
	AlgoStats1DGrouped(Construction cons, GeoList geoList, GeoList geoList2, GeoNumeric Truncate, int stat) {
		super(cons);
	...
	// OK
	public AlgoStats1DGrouped(Construction cons, GeoList geoList, GeoList geoList2, int stat) {
