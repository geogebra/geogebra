...
public class RegionParameters {
	...
	/**
	 * @param rp copy parameters from given RegionParameters
	 */
	...
	*/
	...
	public final void setT1(double t1) {
		...
		if (isNaN(t1))
			return;
		this.t1 = t1;
		//isDefined = true; TODO unused //assume that setT1() is called before setT2()
	}
	/**
	...
	/**
	 * @param normal normal to the region at this place
	 */
	 ...
	 * @param isOnPath true if the point is on the frontier
	 */
