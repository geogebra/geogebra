...
public enum Commands implements CommandsConstants{
	...
	//=============================================================
   	...
   	Prove(TABLE_GEOMETRY), AreCollinear(TABLE_GEOMETRY), AreParallel(TABLE_GEOMETRY),AreConcyclic(TABLE_GEOMETRY),
	...
	//=============================================================
   	...
   	CenterView(TABLE_SCRIPTING), ZoomIn(TABLE_SCRIPTING), ZoomOut(TABLE_SCRIPTING), SetActiveView(TABLE_SCRIPTING), SelectObjects(TABLE_SCRIPTING),
