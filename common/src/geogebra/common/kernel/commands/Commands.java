...
public enum Commands implements CommandsConstants, GetCommand{
	...
	//=============================================================
   	...
   	Intersect(TABLE_GEOMETRY), IntersectPath(TABLE_GEOMETRY), IntersectRegion(TABLE_ENGLISH), Distance(TABLE_GEOMETRY), Length(TABLE_GEOMETRY),
   	...
   	CrossRatio(TABLE_GEOMETRY), ClosestPoint(TABLE_GEOMETRY), ClosestPointRegion(TABLE_GEOMETRY),
   	...
   	LocusEquation(TABLE_GEOMETRY), Envelope(TABLE_GEOMETRY),
   	Volume(TABLE_3D),
	...
	//=============================================================
   	...
   	Sample(TABLE_STATISTICS), Shuffle(TABLE_STATISTICS), FitImplicit(TABLE_STATISTICS),
	...
	//=============================================================
   	...
   	TurtleUp(TABLE_GEOGEBRA), TurtleDown(TABLE_GEOGEBRA),
  	...
  	Evaluate(TABLE_ENGLISH),   	
   	...
   	public static Commands englishToInternal(Commands comm) {
		switch(comm){
			...
			case IntersectCircle: return IntersectConic;
		}
		return comm;
	}
