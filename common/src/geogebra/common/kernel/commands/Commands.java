...
public enum Commands implements CommandsConstants, GetCommand{
	...
	//=============================================================
   	...
   	RunUpdateScript(TABLE_SCRIPTING),DensityPlot(TABLE_FUNCTION), Perspective(TABLE_SCRIPTING),
	...
	//=============================================================
   	...
   	IntersectCircle(TABLE_3D), Height(TABLE_3D), CornerThreeD(TABLE_ENGLISH), Net(TABLE_3D),
