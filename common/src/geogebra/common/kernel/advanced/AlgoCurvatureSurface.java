...
public class AlgoCurvatureSurface extends AlgoElement {
	...
	private AlgoDerivative algoCASfx, algoCASfxx, algoCASfy, algoCASfyy, algoCASfxy;

	@SuppressWarnings("javadoc")
	public AlgoCurvatureSurface(Construction cons, String label, GeoPointND A, GeoFunctionNVar f){
		this(cons, A, f);
	...
	public final void compute() {
		...
		if (!A.isFinite() || fx == null || fxx == null || fy == null || fyy == null || fxy == null) {
			n.setUndefined();
			return;
		}
