...
public class StringTemplate implements ExpressionNodeConstants {
	...
	static {
		...
		prefixedDefault.nf = geogebra.common.factories.FormatFactory.prototype
				.getNumberFormat(15);
	}
	/**
	...
	static {
		...
		giacTemplate.nf = geogebra.common.factories.FormatFactory.prototype
				.getNumberFormat(15);
	}
	...
	static {
		...
		xmlTemplate.sf = geogebra.common.factories.FormatFactory.prototype
	 ...
	 */
	static {
		editTemplate.sf = geogebra.common.factories.FormatFactory.prototype
				.getScientificFormat(GeoElement.MIN_EDITING_PRINT_PRECISION,
						20, false);
		editTemplate.nf = geogebra.common.factories.FormatFactory.prototype
	...
	public static final StringTemplate regression = new StringTemplate(
			"regression");
	static {
		regression.sf = geogebra.common.factories.FormatFactory.prototype
				.getScientificFormat(6, 20, false);
		regression.nf = geogebra.common.factories.FormatFactory.prototype
				.getNumberFormat(6);
	...
	static {
		...
		ogpTemplate.nf = geogebra.common.factories.FormatFactory.prototype
				.getNumberFormat(0);
	}
	/**
	...
	public static final StringTemplate maxPrecision = new StringTemplate(
			"maxPrecision");
	static {
		maxPrecision.sf = geogebra.common.factories.FormatFactory.prototype
				.getScientificFormat(15, 20, false);
	...
	static {
		...
		testTemplate.sf = geogebra.common.factories.FormatFactory.prototype
				.getScientificFormat(15, 20, false);
	}
	...
	static {
		...
		testNumeric.sf = geogebra.common.factories.FormatFactory.prototype
				.getScientificFormat(15, 20, false);
	}
	...
	public static StringTemplate printDecimals(StringType type, int decimals,
		...
		tpl.setType(type);
		tpl.nf = geogebra.common.factories.FormatFactory.prototype
	...
	public static StringTemplate printFigures(StringType type, int decimals,
		...
		tpl.allowMoreDigits = allowMore;
		tpl.setType(type);
		tpl.sf = geogebra.common.factories.FormatFactory.prototype
