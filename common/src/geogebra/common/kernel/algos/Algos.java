...
public enum Algos implements GetCommand{
	...
	AlgoStickGraph(Commands.StickGraph),
	AlgoStepGraph(Commands.StepGraph),
	...
	AlgoZMean2Test(Commands.ZMean2Test),
	...
	AlgoZMeanEstimate(Commands.ZMeanEstimate),
	...
	AlgoChiSquareTest(Commands.ChiSquaredTest),
...
AlgoTo2D,AlgoDependentVector3D,
	...
	AlgoTurtle(Commands.Turtle), AlgoIdentity(Commands.Identity), AlgoNSolveODE(Commands.NSolveODE),
	AlgoSolveODE(Commands.SolveODE), AlgoFunctionFreehand
	;
