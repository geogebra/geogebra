...
public abstract class AlgoAnglePolygonND extends AlgoAngle {
    ...
    public AlgoAnglePolygonND(Construction cons, String[] labels, GeoPolygon poly, GeoDirectionND orientation) {        
    ...
    AlgoAnglePolygonND(Construction cons, GeoPolygon p, GeoDirectionND orientation) {
		super(cons);
