...
public abstract class AlgoAngleLinesND extends AlgoAngle  implements DrawInformationAlgo{
     ...
     */
    AlgoAngleLinesND(Construction cons,  GeoLineND g, GeoLineND h, GeoDirectionND orientation) {
        super(cons);
    ...
    public AlgoAngleLinesND(Construction cons, String label, GeoLineND g, GeoLineND h, GeoDirectionND orientation) {
