...
public abstract class EuclidianStatic {
	...
	/** standardstroke */
	protected static GBasicStroke standardStroke = geogebra.common.factories.AwtFactory.prototype
			.newMyBasicStroke(1.0f);
	/** stroke for selected geos */
	protected static GBasicStroke selStroke = geogebra.common.factories.AwtFactory.prototype
	 ...
	 * @return stroke
	 */
	public static geogebra.common.awt.GBasicStroke getStroke(float width,
			int type) {
		float[] dash;
		...
		return geogebra.common.factories.AwtFactory.prototype.newBasicStroke(
	 ...
	 */
	public static final geogebra.common.awt.GRectangle drawMultilineLaTeX(
			App app, geogebra.common.awt.GGraphics2D tempGraphics,
			GeoElement geo, geogebra.common.awt.GGraphics2D g2,
			geogebra.common.awt.GFont font, geogebra.common.awt.GColor fgColor,
			geogebra.common.awt.GColor bgColor, String labelDesc, int xLabel,
	 ...
	 * @return bounds of resulting LaTeX formula
	 */
	protected abstract geogebra.common.awt.GRectangle doDrawMultilineLaTeX(
			App app, geogebra.common.awt.GGraphics2D tempGraphics,
			GeoElement geo, geogebra.common.awt.GGraphics2D g2,
			geogebra.common.awt.GFont font, geogebra.common.awt.GColor fgColor,
			geogebra.common.awt.GColor bgColor, String labelDesc, int xLabel,
	...
	private static geogebra.common.awt.GFont getIndexFont(
			geogebra.common.awt.GFont f) {
	 ...
	 */
	public static geogebra.common.awt.GPoint drawIndexedString(App app,
			geogebra.common.awt.GGraphics2D g3, String str, float xPos,
		...
		g3.setFont(g2font);
		return new geogebra.common.awt.GPoint(Math.round(x - xPos),
	 ...
	 */
	protected void doFillAfterImageLoaded(geogebra.common.awt.GShape shape,
			geogebra.common.awt.GGraphics2D g3,
			geogebra.common.awt.GBufferedImage gi, App app) {
	}

	/**
	 * This hack was needed for ticket #3265
	 */
	public static void fillAfterImageLoaded(geogebra.common.awt.GShape shape,
			geogebra.common.awt.GGraphics2D g3,
			geogebra.common.awt.GBufferedImage gi, App app) {
	 ...
	 */
	public final static geogebra.common.awt.GRectangle drawMultiLineText(
			App app, String labelDesc, int xLabel, int yLabel,
			geogebra.common.awt.GGraphics2D g2, boolean serif, GFont textFont) {

		int lines = 0;
		int fontSize = textFont.getSize();
		float lineSpread = fontSize * 1.5f;

		geogebra.common.awt.GFont font = app.getFontCanDisplay(labelDesc,
