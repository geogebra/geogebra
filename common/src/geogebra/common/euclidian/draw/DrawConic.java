...
public class DrawConic extends Drawable implements Previewable {
	...
	public geogebra.common.awt.GArea getShape() {
		geogebra.common.awt.GArea area = super.getShape() != null ? super
	...
	protected void updateLines() {
		...
		if (conic.type == GeoConicNDConstants.CONIC_PARALLEL_LINES
			...
			if (conic.type != GeoConicNDConstants.CONIC_LINE)
				((geogebra.common.awt.GArea) shape).exclusiveOr(drawLines[1]
						.getShape(true));
	...
	protected void drawHyperbola(geogebra.common.awt.GGraphics2D g2) {
		if (conic.isInverseFill()) {
			geogebra.common.awt.GArea a1 = AwtFactory.prototype
					.newArea(hypLeft);
			geogebra.common.awt.GArea a2 = AwtFactory.prototype
					.newArea(hypRight);
			geogebra.common.awt.GArea complement = AwtFactory.prototype
					.newArea(view.getBoundingPath());
