...
public enum Language {
	...
	Armenian("\u0570", true, "hy", "hy",
			"Armenian / \u0540\u0561\u0575\u0565\u0580\u0565\u0576",
			Country.Armenia),

	Albanian(null, true, "sq", "sq", "Albanian / Gjuha Shqipe", Country.Albania), Arabic(
			null, true, "ar", "ar", Unicode.LeftToRightMark + "Arabic"
			...
			Country.UnitedArabEmirates, Country.WesternSahara, Country.Yemen), Arabic_Morocco(
			null,
			true,
			"arMA",
			"ar_MA",
			Unicode.LeftToRightMark
					...
					+ "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u0627\u0644\u0645\u063A\u0631\u0628)"
					+ Unicode.RightToLeftMark, Country.Morocco), Arabic_Tunisia(
			null,
			true,
			"arTN",
			"ar_TN",
			Unicode.LeftToRightMark
					...
					+ Unicode.RightToLeftMark
					+ "\u0627\u0644\u0639\u0631\u0628\u064A\u0629 (\u062A\u0648\u0646\u0633)"
					+ Unicode.RightToLeftMark, Country.Tunisia), Basque(null,
			true, "eu", "eu", "Basque / Euskara", "basque"), // fudge to get
																// right flag
	Bosnian(null, true, "bs", "bs",
			"Bosnian / \u0431\u043E\u0441\u0430\u043D\u0441\u043A\u0438",
			Country.BosniaandHerzegovina), Bulgarian(
			null,
			true,
			"bg",
			"bg",
			"Bulgarian / \u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 \u0435\u0437\u0438\u043A",
			Country.Bulgaria), Catalan(null, true, "ca", "ca",
			"Catalan / Catal\u00E0", "catalonia"), // fudge to get right flag
	Valencian(null, true, "caXV", "ca_XV",
			"Catalan (Valencia) / Catal\u00E0 (Valenci\u00E0)", "valencia"), // fudge
																				// to
																				// get
																				// right
																				// flag
	Chinese_Simplified("\u984F", true, "zhCN", "zh_CN",
			"Chinese Simplified / \u7B80\u4F53\u4E2D\u6587", Country.China,
			Country.Singapore), Chinese_Traditional("\u984F", true, "zhTW",
			"zh_TW", "Chinese Traditional / \u7E41\u9AD4\u4E2D\u6587",
			Country.TaiwanProvinceofChina), Croatian(null, true, "hr", "hr",
			"Croatian / Hrvatska", Country.Croatia,
			Country.BosniaandHerzegovina), Czech(null, true, "cs", "cs",
			"Czech / \u010Ce\u0161tina", Country.CzechRepublic), Danish(null,
			true, "da", "da", "Danish / Dansk", Country.Denmark), Dutch(null,
			true, "nl", "nl", "Dutch / Nederlands (The Netherlands)",
			Country.Netherlands, Country.Suriname), Dutch_Belgium(null, true,
			"nlBE", "nl_BE", "Dutch / Nederlands (Belgium)", Country.Belgium), English_US(
			null, true, "en", "en", "English (US)",
			...
			Country.Vanuatu, Country.Zambia, Country.Zimbabwe), English_UK(
			null, true, "enGB", "en_GB", "English (UK)", Country.UnitedKingdom), English_Australia(
			null, true, "enAU", "en_AU", "English (Australia)",
			Country.Australia),
	// could have esperanto.png for flag (but we don't)
	// Esperanto(null, false, "eo","eo", "Esperanto", "esperanto"),
	Estonian(null, true, "et", "et", "Estonian / Eesti keel", Country.Estonia), Filipino(
			null, true, "tl", "tl", "Filipino", Country.Philippines), Finnish(
			null, true, "fi", "fi", "Finnish / Suomi", Country.Finland), French(
			null, true, "fr", "fr", "French / Fran\u00E7ais", Country.France,
			...
			Country.Seychelles, Country.Monaco), Galician(null, true, "gl",
			"gl", "Galician / Galego", "Galician"), // fudge to get right flag
	Georgian(
			"\u10d8",
			true,
			"ka",
	...
	German(null, true, "de", "de", "German / Deutsch", Country.Germany,
			Country.Liechtenstein, Country.Luxembourg, Country.Switzerland,
			Country.Belgium), German_Austria(null, true, "deAT", "de_AT",
			"German (Austria) / Deutsch (\u00D6sterreich)", Country.Austria),

	Greek(null, true, "el", "el",
			"Greek / \u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC",
			Country.Greece, Country.Cyprus), Hebrew("\u05d9", true, "iw", "iw",
			"Hebrew / \u05E2\u05B4\u05D1\u05B0\u05E8\u05B4\u05D9\u05EA",
			Country.Israel), Hindi(
			"\u0be7",
			true,
			"hi",
			"hi",
			"Hindi / \u092E\u093E\u0928\u0915 \u0939\u093F\u0928\u094D\u0926\u0940",
			Country.India), Hungarian(null, true, "hu", "hu",
			"Hungarian / Magyar", Country.Hungary), Icelandic(null, true, "is",
			"is", "Icelandic / \u00CDslenska", Country.Iceland), Indonesian(
			null, true, "in", "in", "Indonesian / Bahasa Indonesia",
			Country.Indonesia), Italian(null, true, "it", "it",
			"Italian / Italiano", Country.Italy, Country.Switzerland,
			Country.SanMarino, Country.VaticanCityState),
	// Irish(null, false, "ga", "ga", "Irish / Gaeilge", Country.Ireland),
	Japanese("\uff9d", true, "ja", "ja", "Japanese / \u65E5\u672C\u8A9E",
			Country.Japan),
	// Kannada("\u1103", false, "kn","kn", "Kannada", Country.India),
	Kazakh(null, true, "kk", "kk",
			"Kazakh / \u049A\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456",
			Country.Kazakhstan), Korean("\u1103", true, "ko", "ko",
			"Korean / \uD55C\uAD6D\uB9D0", Country.KoreaRepublicof,
			Country.KoreaDemocraticPeoplesRepublicof), Latvian(null, true,
			"lv", "lv", "Latvian / Latvie\u0161u valoda", Country.Latvia), Lithuanian(
			null, true, "lt", "lt", "Lithuanian / Lietuvi\u0173 kalba",
			Country.Lithuania), Malay(null, true, "ms", "ms",
			"Malay / Bahasa Malaysia", Country.Malaysia, Country.Singapore,
			Country.Indonesia, Country.BruneiDarussalam),
	...
	Mongolian(
			...
			Country.Mongolia), Nepalese("\u0947", true, "ne", "ne",
			"Nepalese / \u0928\u0947\u092A\u093E\u0932\u0940", Country.Nepal), Norwegian_Bokmal(
			null, true, "noNO", "no_NB", "Norwegian / Bokm\u00e5l",
			Country.Norway), Norwegian_Nynorsk(null, true, "noNONY", "no_NN",
			"Norwegian / Nynorsk", Country.Norway), Persian(null, true, "fa",
			"fa", "Persian / \u0641\u0627\u0631\u0633\u06CC",
			Country.IranIslamicRepublicof, Country.Afghanistan,
			Country.Tajikistan), Polish(null, true, "pl", "pl",
			"Polish / J\u0119zyk polski", Country.Poland),
	// use Brazilian as the root (ie not ptBR) as there are more speakers
	Portuguese_Brazil(null, true, "pt", "pt",
			"Portuguese (Brazil) / Portugu\u00EAs (Brasil)", Country.Brazil), Portuguese_Portugal(
			null, true, "ptPT", "pt_PT",
			"Portuguese (Portugal) / Portugu\u00EAs (Portugal)",
			Country.Portugal, Country.Mozambique, Country.Angola,
			Country.CapeVerde, Country.GuineaBissau, Country.SaoTomePrincipe,
			Country.Macau, Country.EastTimor), Romanian(null, true, "ro", "ro",
			"Romanian /  Rom\u00E2n\u0103", Country.Romania,
			Country.MoldovaRepublicof), Russian(
			"\u0439",
			true,
			"ru",
			"ru",
	...
	// Sinhala("\u0d9a", false, "si","si",
	// "Sinhala / \u0DC3\u0DD2\u0D82\u0DC4\u0DBD", Country.SriLanka),
	Serbian(null, true, "sr", "sr",
			"Serbian / \u0441\u0440\u043F\u0441\u043A\u0438", Country.Serbia,
			Country.BosniaandHerzegovina), Slovak(null, true, "sk", "sk",
			"Slovak / Slovensk\u00FD jazyk", Country.Slovakia), Slovenian(null,
			true, "sl", "sl", "Slovenian / Sloven\u0161\u010Dina",
			Country.Slovenia), Spanish(null, true, "es", "es",
			"Spanish / Espa\u00F1ol", Country.EquatorialGuinea,
			Country.Argentina, Country.Bolivia, Country.Chile,
			Country.Colombia, Country.CostaRica, Country.Cuba,
			...
			Country.Venezuela, Country.PuertoRico), Spanish_UY(null, true,
			"esUY", "es_UY", "Spanish / Espa\u00F1ol (Uruguay)",
			Country.Uruguay), Spanish_ES(null, true, "esES", "es_ES",
			"Spanish / Espa\u00F1ol (Espa\u00F1a)", Country.Spain), Swedish(
			null, true, "sv", "sv", "Swedish / Svenska", Country.Sweden,
			Country.Finland),
	// Tamil("\u0be7", false, "ta","ta",
	...
	Thai(null, true, "th", "th",
			"Thai / \u0E20\u0E32\u0E29\u0E32\u0E44\u0E17\u0E22",
			Country.Thailand), Turkish(null, true, "tr", "tr",
			"Turkish / T\u00FCrk\u00E7e", Country.Turkey, Country.Cyprus), Ukrainian(
			null,
			true,
			"uk",
			"uk",
			"Ukrainian / \u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430 \u043C\u043E\u0432\u0430",
			Country.Ukraine), Uyghur(null, true, "ug", "ug", "Uyghur",
			Country.China), Vietnamese(null, true, "vi", "vi",
			"Vietnamese / Ti\u1EBFng Vi\u1EC7t", Country.VietNam), Welsh(null,
			true, "cy", "cy", "Welsh / Cymraeg", "wales"), // fudge to get right
															// flag
	Yiddish("\u05d9\u05b4", true, "ji", "ji",
	 ...
	 *            currently not used
	 */
	Language(String testChar, boolean fullyTranslated, String locale,
