...
public enum Language {
	...
	English_UK(true, "enGB", "en_GB", "English (UK)", Country.UnitedKingdom),
	English_Australia(true, "en_AU", "enAU", "English (Australia)", Country.Australia),
	...
	German_Austria(true, "deAT","de_AT", "German (Austria) / Deutsch (\u00D6sterreich)", Country.Austria),
	...
	Norwegian_Bokmal(true, "noNO","no_NB", "Norwegian / Bokm\u00e5l", Country.Norway ),
	Norwegian_Nynorsk(true, "noNONY","no_NN", "Norwegian / Nynorsk", Country.Norway),
	...
	Portuguese_Portugal(true, "ptPT","pt_PT", "Portuguese (Portugal) / Portugu\u00EAs (Portugal)", Country.Portugal, Country.Mozambique, Country.Angola, Country.CapeVerde, Country.GuineaBissau, Country.SaoTomePrincipe, Country.Macau, Country.EastTimor),
