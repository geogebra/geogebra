...
public enum Language {
	...
	Afrikaans(null, false, false, "af","af", "Afrikaans", Country.SouthAfrica),
	Armenian("\u0570", false, false, "hy","hy", "Armenian / \u0540\u0561\u0575\u0565\u0580\u0565\u0576", Country.Armenia),

	Albanian(null, false, false, "sq","sq", "Albanian / Gjuha Shqipe", Country.Albania),
	Arabic(null, false, false, "ar", "ar", Unicode.LeftToRightMark+"Arabic"+Unicode.LeftToRightMark+" / "+Unicode.RightToLeftMark+"\u0627\u0644\u0639\u0631\u0628\u064A\u0629"+Unicode.RightToLeftMark,
	...
	Basque(null, false, false, "eu","eu", "Basque / Euskara", "basque"), // fudge to get right flag
	Bosnian(null, false, false, "bs","bs", "Bosnian / \u0431\u043E\u0441\u0430\u043D\u0441\u043A\u0438", Country.BosniaandHerzegovina),
	Bulgarian(null, false, false, "bg","bg", "Bulgarian / \u0431\u044A\u043B\u0433\u0430\u0440\u0441\u043A\u0438 \u0435\u0437\u0438\u043A", Country.Bulgaria),
	Catalan(null, false, false, "ca","ca", "Catalan / Catal\u00E0", "catalonia"), // fudge to get right flag
	Chinese_Simplified("\u984F", false, false, "zhCN","zh_CN", "Chinese Simplified / \u7B80\u4F53\u4E2D\u6587", Country.China, Country.Singapore),
	Chinese_Traditional("\u984F", false, false, "zhTW","zh_TW", "Chinese Traditional / \u7E41\u9AD4\u4E2D\u6587", Country.TaiwanProvinceofChina),
	Croatian(null, false, false, "hr","hr", "Croatian / Hrvatska", Country.Croatia, Country.BosniaandHerzegovina),
	Czech(null, false, false, "cs","cs", "Czech / \u010Ce\u0161tina", Country.CzechRepublic),
	Danish(null, false, false, "da","da", "Danish / Dansk", Country.Denmark),
	Dutch(null, false, false, "nl","nl", "Dutch / Nederlands", Country.Netherlands, Country.Belgium, Country.Suriname),
	...
	English_UK(null, false, false, "enGB", "en_GB", "English (UK)", Country.UnitedKingdom),
	English_Australia(null, false, false, "enAU", "en_AU", "English (Australia)", Country.Australia),
	Estonian(null, false, false, "et","et", "Estonian / Eesti keel", Country.Estonia),
	Filipino(null, false, false, "tl","tl", "Filipino", Country.Philippines),
	Finnish(null, false, false, "fi","fi", "Finnish / Suomi", Country.Finland),
	French(null, false, false, "fr", "fr",
	...
	Galician(null, false, false, "gl","gl", "Galician / Galego", "Galician"), // fudge to get right flag
	...
	German_Austria(null, false, false, "deAT","de_AT", "German (Austria) / Deutsch (\u00D6sterreich)", Country.Austria),
	
	Greek(null, false, false, "el","el", "Greek / \u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC", Country.Greece, Country.Cyprus),
	Hebrew("\u05d9", false, false, "iw","iw", "Hebrew / \u05E2\u05B4\u05D1\u05B0\u05E8\u05B4\u05D9\u05EA", Country.Israel),
	Hindi("\u0be7", false, false, "hi","hi", "Hindi / \u092E\u093E\u0928\u0915 \u0939\u093F\u0928\u094D\u0926\u0940", Country.India),
	Hungarian(null, true, true, "hu", "hu", "Hungarian / Magyar", Country.Hungary),
	Icelandic(null, false, false, "is","is", "Icelandic / \u00CDslenska", Country.Iceland),
	Indonesian(null, false, false, "in","in", "Indonesian / Bahasa Indonesia", Country.Indonesia),
	Italian(null, false, false, "it","it", "Italian / Italiano", Country.Italy, Country.Switzerland, Country.SanMarino, Country.VaticanCityState),
	Irish(null, false, false, "ga", "ga", "Irish / Gaeilge", Country.Ireland),
	Japanese("\uff9d", false, false, "ja","ja", "Japanese / \u65E5\u672C\u8A9E", Country.Japan),
	Kazakh(null, false, false, "kk","kk", "Kazakh / \u049A\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456", Country.Kazakhstan),
	Korean("\u1103", false, false, "ko","ko", "Korean / \uD55C\uAD6D\uB9D0", Country.KoreaRepublicof, Country.KoreaDemocraticPeoplesRepublicof),
	Lithuanian(null, false, false, "lt","lt", "Lithuanian / Lietuvi\u0173 kalba", Country.Lithuania),
	Malay(null, false, false, "ms","ms", "Malay / Bahasa Malaysia", Country.Malaysia, Country.Singapore, Country.Indonesia, Country.BruneiDarussalam),
	Malayalam("\u0D2E", false, false, "ml","ml", "Malayalam / \u0D2E\u0D32\u0D2F\u0D3E\u0D33\u0D02", Country.India),
	Macedonian(null, false, false, "mk","mk", "Macedonian / \u041C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438 \u0458\u0430\u0437\u0438\u043A", Country.Macedonia),
	Marathi("\u092e", false, false, "mr","mr", "Marathi / \u092E\u0930\u093E\u0920\u0940", Country.India),
	Mongolian(null, false, false, "mn","mn", "Mongolian / \u041C\u043E\u043D\u0433\u043E\u043B \u0445\u044D\u043B", Country.Mongolia),
	Nepalese("\u0947", false, false, "ne","ne", "Nepalese / \u0928\u0947\u092A\u093E\u0932\u0940", Country.Nepal),
	Norwegian_Bokmal(null, false, false, "noNO","no_NB", "Norwegian / Bokm\u00e5l", Country.Norway ),
	Norwegian_Nynorsk(null, false, false, "noNONY","no_NN", "Norwegian / Nynorsk", Country.Norway),
	Persian(null, false, false, "fa","fa", "Persian / \u0641\u0627\u0631\u0633\u06CC", Country.IranIslamicRepublicof, Country.Afghanistan, Country.Tajikistan),
	Polish(null, false, false, "pl","pl", "Polish / J\u0119zyk polski", Country.Poland),
	// use Brazilian as the root (ie not ptBR) as there are more speakers
	Portuguese_Brazil(null, false, false, "pt","pt", "Portuguese (Brazil) / Portugu\u00EAs (Brasil)", Country.Brazil),
	Portuguese_Portugal(null, false, false, "ptPT","pt_PT", "Portuguese (Portugal) / Portugu\u00EAs (Portugal)", Country.Portugal, Country.Mozambique, Country.Angola, Country.CapeVerde, Country.GuineaBissau, Country.SaoTomePrincipe, Country.Macau, Country.EastTimor),
	Romanian(null, false, false, "ro","ro", "Romanian /  Rom\u00E2n\u0103", Country.Romania, Country.MoldovaRepublicof),
	Russian("\u0439", false, false, "ru","ru", "Russian / \u0420\u0443\u0441\u0441\u043A\u0438\u0439 \u044F\u0437\u044B\u043A", Country.RussianFederation, Country.Kazakhstan, Country.Belarus, Country.Kyrgyzstan, Country.Tajikistan),
	Sinhala("\u0d9a", false, false, "si","si", "Sinhala / \u0DC3\u0DD2\u0D82\u0DC4\u0DBD", Country.SriLanka),
	Serbian(null, false, false, "sr","sr", "Serbian / \u0441\u0440\u043F\u0441\u043A\u0438", Country.Serbia, Country.BosniaandHerzegovina),
	Slovak(null, false, false, "sk","sk", "Slovak / Slovensk\u00FD jazyk", Country.Slovakia),
	Slovenian(null, false, false, "sl","sl", "Slovenian / Sloven\u0161\u010Dina", Country.Slovenia),
	Spanish(null, false, false, "es", "es", "Spanish / Espa\u00F1ol", Country.Spain,
	...
	Swedish(null, false, false, "sv","sv", "Swedish / Svenska", Country.Sweden, Country.Finland),
	...
	Vietnamese(null, false, false, "vi","vi", "Vietnamese / Ti\u1EBFng Vi\u1EC7t", Country.VietNam),
	Welsh(null, false, false, "cy","cy", "Welsh / Cymraeg", "wales"), // fudge to get right flag
	Yiddish("\u05d9\u05b4", false, false, "ji","ji", "Yiddish / \u05D9\u05D9\u05B4\u05D3\u05D9\u05E9", Country.Israel),
	
	Interlingua(null, false, false, "ia", "ia", "Interlingua", Country.UnitedStatesofAmerica);
