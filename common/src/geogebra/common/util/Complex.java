...
public class Complex {
	 ...
	 * 
	 * Object[] msg = {"Re z:", feld1, "Im z:", feld2, "Re w:", feld3, "Im w:",
	 * feld4}; javax.swing.JOptionPane optionPane = new javax.swing.JOptionPane(
	 * msg );
	 * 
	 * optionPane.createDialog(null,"Eingabe").setVisible(true);
	 * 
	 * //double[] z = { Double.parseDouble( feld1.getText() ),
	 * Double.parseDouble( feld2.getText() ) }; //double[] w = {
	 * Double.parseDouble( feld3.getText() ), Double.parseDouble(
	 * feld4.getText() ) }; //double[] result = {0.,.0};
	 * 
	 * Complex z = new Complex(Double.parseDouble( feld1.getText() ),
	 * Double.parseDouble( feld2.getText() ) ); Complex w = new
	 * Complex(Double.parseDouble( feld3.getText() ), Double.parseDouble(
	 * feld4.getText() ) ); Complex result; java.text.DecimalFormat digit = new
	 ...
	 * 
	 * ausgabe += "\n multiply(" + toString(z, digit); ausgabe += ", " +
	 * toString(w, digit); ausgabe += ") = "; ausgabe += toString( result, digit
	 ...
	 * 
	 * 
	 * //double[] v = gamma(z); zeit = System.currentTimeMillis(); ausgabe +=
	 * "\n \u0393(" + toString(z, digit) + ") = " + toString(v,digit);
	 * //digit.format( abs(z) ); ausgabe += "  (" + digit.format(zeit - start) +
	 * " ms)"; //System.out.println("### v = (" + v[0] + ", " + v[1] + ")");
	 * 
	 * v = lnGamma(z); zeit = System.currentTimeMillis(); ausgabe +=
	 * "\n ln \u0393(" + toString(z, digit) + ") = " + toString(v,digit);
	 * //digit.format( abs(z) ); ausgabe += "  (" + digit.format(zeit - start) +
	 * " ms)";
	 * 
