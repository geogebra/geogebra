...
public interface KPartiteGraph<V, E> extends Graph<V, E> {
	/**
	 * Returns all vertices which satisfy the specified <code>partition</code>
	 * predicate.
	 * 
	 * @param partition
	 *            <code>Predicate</code> which defines a partition
	 * @return all vertices satisfying <code>partition</code>
	 */
	public Collection<V> getVertices(Predicate<V> partition);

	/**
	 * Returns the set of <code>Predicate</code> instances which define this
	 * graph's partitions.
	 * 
	 * @return the set of <code>Predicate</code> instances which define this
	 *         graph's partitions
	 */
