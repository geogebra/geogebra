...
public class TestGraphs {
	...
	public static Graph<String, Number> createChainPlusIsolates(
		...
		if (chain_length > 0) {
			...
			for (int i = 1; i < chain_length; i++) {
				v[i] = "v" + i;
				g.addVertex(v[i]);
				g.addEdge(Double.valueOf(Math.random()), v[i], v[i - 1]);
			}
		}
	...
	private static void createEdge(Graph<String, Number> g, String v1Label,
			String v2Label) {
		g.addEdge(Double.valueOf(Math.random()), v1Label, v2Label);
	}
	...
	public static Graph<String, Number> getSmallGraph() {
		...
		graph.addEdge(Double.valueOf(0), v[0], v[1], EdgeType.DIRECTED);
		graph.addEdge(Double.valueOf(.1), v[0], v[1], EdgeType.DIRECTED);
		graph.addEdge(Double.valueOf(.2), v[0], v[1], EdgeType.DIRECTED);
		graph.addEdge(Double.valueOf(.3), v[1], v[0], EdgeType.DIRECTED);
		graph.addEdge(Double.valueOf(.4), v[1], v[0], EdgeType.DIRECTED);
		graph.addEdge(Double.valueOf(.5), v[1], v[2]);
		graph.addEdge(Double.valueOf(.6), v[1], v[2]);
