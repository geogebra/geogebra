...
public class ComparableComparator<T extends Comparable>
	 ...
	 *             when <i>obj1</i> is <code>null</code>, or when
	 ...
	 * {@link Comparator Comparator} whose ordering is known to be equivalent to
	 * mine.
	 * <p/>
	 ...
	 * behavior to remain consistent with the {@link Comparator#equals(Object)}
	 * contract.
	 *
	 * @param object
