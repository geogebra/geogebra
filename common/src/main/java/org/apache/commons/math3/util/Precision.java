...
//	}
	...
	/**
	 * Returns true if the arguments are equal or within the range of allowed error
	 * (inclusive). Two float numbers are considered equal if there are
	 * {@code (maxUlps - 1)} (or fewer) floating point numbers between them, i.e.
	 * two adjacent floating point numbers are considered equal. Adapted from
	 * <a href=
	 * "http://randomascii.wordpress.com/2012/02/25/comparing-floating-point-numbers-2012-edition/">
	 * Bruce Dawson</a>. Returns {@code false} if either of the arguments is NaN.
	 *
