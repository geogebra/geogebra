 ...
 * immutable.
 *
 * @version $Revision: 1073687 $ $Date: 2011-02-23 11:39:25 +0100 (mer. 23 fevr.
 *          2011) $
 * @since 2.0
 */
public class BigFraction extends Number implements FieldElement<BigFraction>,
		Comparable<BigFraction>, Serializable {
	...
	private static final BigInteger ONE_HUNDRED_DOUBLE = BigInteger
			.valueOf(100);
	...
	/**
	 * <p>
	 * Create a {@link BigFraction} equivalent to the passed <tt>BigInteger</tt>
	 * , ie "num / 1".
	 * </p>
	 *
	 * @param num
	...
	public BigFraction(BigInteger num, BigInteger den) {
		if (num == null) {
			throw new NullPointerException(LocalizedFormats.NUMERATOR);
		}
		if (den == null) {
			throw new NullPointerException(LocalizedFormats.DENOMINATOR);
		}
	 ...
	 * exactly, considering its internal bits representation. This does work for
	 * all values except NaN and infinities and does not requires any loop or
	 * convergence threshold.
	 * </p>
	 * <p>
	 * Since this conversion is exact and since double numbers are sometimes
	 * approximated, the fraction created may seem strange in some cases. For
	 * example calling <code>new BigFraction(1.0 / 3.0)</code> does <em>not</em>
	 * create the fraction 1/3 but the fraction 6004799503160661 /
	...
	public BigFraction(final double value, final double epsilon,
			final int maxIterations) throws FractionConversionException {
	 ...
	 * <p>
	 * Create a {@link BigFraction} given the numerator and denominator as
	 * simple <tt>int</tt>. The {@link BigFraction} is reduced to lowest terms.
	 * </p>
	 *
	 * @param num
	 *            the numerator.
	 ...
	 * <p>
	 * Create a {@link BigFraction} given the numerator and denominator as
	 * simple <tt>long</tt>. The {@link BigFraction} is reduced to lowest terms.
	 * </p>
	 *
	 * @param num
	 *            the numerator.
	...
	public double percentageValue() {
		return (numerator.divide(denominator)).multiply(ONE_HUNDRED_DOUBLE)
				.doubleValue();
	}
