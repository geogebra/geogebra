...
public class NonMonotonousSequenceException extends MathIllegalNumberException {
	 ...
	 */
	public NonMonotonousSequenceException(Number wrong, Number previous,
			int index) {
	 ...
	 */
	public NonMonotonousSequenceException(Number wrong, Number previous,
			int index, MathUtils.OrderDirection direction, boolean strict) {
		super(direction == MathUtils.OrderDirection.INCREASING
				? (strict ? LocalizedFormats.NOT_STRICTLY_INCREASING_SEQUENCE
