...
/**
 * Extends the definition of {@link UnivariateStatistic} with {@link #increment}
 * and {@link #incrementAll(double[])} methods for adding values and updating
 * internal state.
 * <p>
...
public interface StorelessUnivariateStatistic extends UnivariateStatistic {
	...
	/**
	 * Updates the internal state of the statistic to reflect the addition of
	 * the new value.
	 * 
	 * @param d
	 *            the new value.
	 ...
	 * values in the values array. Does not clear the statistic first -- i.e.,
	 * the values are added <strong>incrementally</strong> to the dataset.
	 *
	 * @param values
	 ...
	 * values in the designated portion of the values array. Does not clear the
	 * statistic first -- i.e., the values are added
	 ...
	 * 
	 * @return value of the statistic, <code>Double.NaN</code> if it has been
	 *         cleared or just instantiated.
	 */
	double getResult();
