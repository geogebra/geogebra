...
public class CauchyDistributionImpl extends AbstractContinuousDistribution
	...
	/**
	 * Creates cauchy distribution with the medain equal to zero and scale equal
	 * to one.
	 */
	...
	/**
	 * Returns the lower bound of the support for this distribution. The lower
	 * bound of the support of the Cauchy distribution is always negative
	 * infinity, regardless of the parameters.
	 *
	...
	/**
	 * Returns the upper bound of the support for this distribution. The upper
	 * bound of the support of the Cauchy distribution is always positive
	 * infinity, regardless of the parameters.
	 *
