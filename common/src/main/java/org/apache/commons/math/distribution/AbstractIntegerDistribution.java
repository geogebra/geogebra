 ...
 * distribution.
 *
 * @version $Revision: 1067494 $ $Date: 2011-02-05 20:49:07 +0100 (sam. 05 fevr.
 *          2011) $
 */
public abstract class AbstractIntegerDistribution extends AbstractDistribution
	...
	/**
	 * Computes the cumulative probability function and checks for NaN values
	 * returned. Throws MathException if the value is NaN. Rethrows any
	 * MathException encountered evaluating the cumulative probability function.
	 * Throws MathException if the cumulative probability function returns NaN.
	 *
	 * @param argument
	 *            input value
	...
	/**
	 * Use this method to get information about whether the lower bound of the
	 * support is inclusive or not. For discrete support, only true here is
	 * meaningful.
	 *
	...
	/**
	 * Use this method to get information about whether the upper bound of the
	 * support is inclusive or not. For discrete support, only true here is
	 * meaningful.
	 *
