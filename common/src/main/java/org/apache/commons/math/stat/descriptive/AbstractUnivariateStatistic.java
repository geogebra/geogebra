...
public abstract class AbstractUnivariateStatistic
	 ...
	 * <code>evaluate(double[], double[], int, int)</code> methods to verify
	 * that the begin and length parameters designate a subarray of positive
	 * length and the weights are all non-negative, non-NaN, finite, and not all
	 * zero.
	 * <p>
	 * <ul>
	 * <li>returns <code>true</code> iff the parameters designate a subarray of
