 ...
 * 
 * @version $Revision: 1003993 $ $Date: 2010-10-03 18:39:16 +0200 (dim. 03 oct.
 *          2010) $
 * @since 2.0
 */
public class ArrayRealVector extends AbstractRealVector
	...
	public ArrayRealVector(double[] d, int pos, int size) {
		if (d.length < pos + size) {
			throw MathRuntimeException.createIllegalArgumentException(
					LocalizedFormats.POSITION_SIZE_MISMATCH_INPUT_ARRAY, pos,
					size, d.length);
		}
		data = new double[size];
	...
	public RealVector unitVector() throws ArithmeticException {
		...
		if (norm == 0) {
			throw MathRuntimeException
					.createArithmeticException(LocalizedFormats.ZERO_NORM);
		}
	...
	protected void checkVectorDimensions(int n)
		...
		if (data.length != n) {
			throw MathRuntimeException.createIllegalArgumentException(
					LocalizedFormats.VECTOR_LENGTH_MISMATCH, data.length, n);
		}
	}
