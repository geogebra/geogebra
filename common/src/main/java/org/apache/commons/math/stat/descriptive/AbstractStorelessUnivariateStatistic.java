 ...
 * interface.
 * <p>
 * Provides default <code>evaluate()</code> and <code>incrementAll(double[])
 ...
 *          2010) $
 */
public abstract class AbstractStorelessUnivariateStatistic extends
		AbstractUnivariateStatistic implements StorelessUnivariateStatistic {
	 ...
	 * possibly more accurate implementation that works directly with the input
	 * array.
	 * </p>
	 * <p>
