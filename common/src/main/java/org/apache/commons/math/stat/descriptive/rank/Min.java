 ...
 * <p>
 * <ul>
 * <li>The result is <code>NaN</code> iff all values are <code>NaN</code> (i.e.
 * <code>NaN</code> values have no impact on the value of the statistic).</li>
 * <li>If any of the values equals <code>Double.NEGATIVE_INFINITY</code>, the
...
public class Min extends AbstractStorelessUnivariateStatistic
	...
	/**
	 * Copy constructor, creates a new {@code Min} identical to the
	 * {@code original}
	 *
	 * @param original
	 ...
	 * (i.e. <code>NaN</code> values have no impact on the value of the
	 * statistic).</li>
	 ...
	 *             if the array is null or the array index parameters are not
	 *             valid
	 */
	@Override
