...
/**
 * An interface to classes that implement an algorithm to calculate the eigen
 * decomposition of a real matrix.
 * <p>
 * The eigen decomposition of matrix A is a set of two matrices: V and D such
 * that A = V &times; D &times; V<sup>T</sup>. A, V and D are all m &times; m
 * matrices.
 * </p>
 * <p>
 ...
 * {@link #getImagEigenvalue(int) getImagEigenvalue} methods to pick up a single
 * eigenvalue have been added,</li>
 ...
 * </ul>
 * 
 * @see <a href="http://mathworld.wolfram.com/EigenDecomposition.html">MathWorld
 *      </a>
 * @see <a href="http://en.wikipedia.org/wiki/Eigendecomposition_of_a_matrix">
 *      Wikipedia</a>
 * @version $Revision: 997726 $ $Date: 2010-09-16 14:39:51 +0200 (jeu. 16 sept.
 *          2010) $
 * @since 2.0
 */
public interface EigenDecomposition {
	 ...
	 * </p>
	 * <p>
	 * No assumption is made about the orientation of the system axes formed by
	 * the columns of V (e.g. in a 3-dimension space, V can form a left- or
	 * right-handed system).
	 * </p>
	 * 
	 * @return the V matrix
	 ...
	 * </p>
	 * <p>
	 * Real eigenvalues are on the diagonal while complex values are on 2x2
	 * blocks { {real +imaginary}, {-imaginary, real} }.
	 * </p>
	 * 
	 * @return the D matrix
	...
	/**
	 * Returns a copy of the real parts of the eigenvalues of the original
	 * matrix.
	 * 
	...
	/**
	 * Returns the imaginary part of the i<sup>th</sup> eigenvalue of the
	 * original matrix.
	 * 
	 * @param i
	 *            index of the eigenvalue (counting from 0)
