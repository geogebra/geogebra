 ...
 *
 * @version $Revision: 822850 $ $Date: 2009-10-07 14:56:42 -0400 (Wed, 07 Oct
 *          2009) $
 * @since 2.0
 */
public class MathRuntimeException extends RuntimeException {
	...
	/**
	 * Constructs a new <code>MathRuntimeException</code> with specified nested
	 ...
	 *            format arguments
	 */
	public MathRuntimeException(final Throwable rootCause, final String pattern,
			final Object... arguments) {
		super(rootCause);
		this.pattern = pattern;
	}
	...
	public static IllegalStateException createIllegalStateException(
			String string, int row) {
		// TODO Auto-generated method stub
		return new IllegalStateException(string);
	}

	public static NullPointerException createNullPointerException(
			String string) {
		// TODO Auto-generated method stub
	 ...
	 * specified formatted detail message. Message formatting is delegated to
	 * {@link java.text.MessageFormat}.
	 * 
	 * @param pattern
	 *            format specifier
