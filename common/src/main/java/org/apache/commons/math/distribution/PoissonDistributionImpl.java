 ...
 *
 * @version $Revision: 1054524 $ $Date: 2011-01-03 05:59:18 +0100 (lun. 03 janv.
 *          2011) $
 */
public class PoissonDistributionImpl extends AbstractIntegerDistribution
	 ...
	 * approximation of Gamma#regularizedGammaP or continued fraction
	 * approximation of Gamma#regularizedGammaQ.
	 */
	...
	/**
	 * Create a new Poisson distribution with the given mean, convergence
	...
	/**
	 * Create a new Poisson distribution with the given mean and convergence
	 * criterion.
	 *
	 * @param p
	 *            the Poisson mean
	...
	/**
	 * Create a new Poisson distribution with the given mean and maximum number
	 * of iterations.
	 *
	 * @param p
	 *            the Poisson mean
	 ...
	 * parameter values. There is no integer infinity, so this method returns
	 * <code>Integer.MAX_VALUE</code> and
	 * {@link #isSupportUpperBoundInclusive()} returns <code>true</code>.
	 *
	 * @return upper bound of the support (always <code>Integer.MAX_VALUE</code>
