...
public class FDistributionImpl extends AbstractContinuousDistribution
	...
	/**
	 * Create a F distribution using the given degrees of freedom and inverse
	...
	public double density(double x) {
		...
		final double lognxm = FastMath.log(
	 ...
	 *             if <code>degreesOfFreedom</code> is not positive.
	 */
	private void setDenominatorDegreesOfFreedomInternal(
	 ...
	 *
	 * For denominator degrees of freedom parameter <code>b</code>, the mean is
	 * <ul>
	 ...
	 *
	 * For numerator degrees of freedom parameter <code>a</code> and denominator
	 * degrees of freedom parameter <code>b</code>, the variance is
	 * <ul>
	 * <li>if <code>b &gt; 4</code> then
	 * <code>[ 2 * b^2 * (a + b - 2) ] / [ a * (b - 2)^2 * (b - 4) ]</code></li>
	 * <li>else <code>undefined</code>
	 * </ul>
	 *
	 * @return the variance
