...
public class NormalDistributionImpl extends AbstractContinuousDistribution
	...
	private void setStandardDeviationInternal(double sd) {
		if (sd <= 0.0) {
			throw MathRuntimeException.createIllegalArgumentException(
					LocalizedFormats.NOT_POSITIVE_STANDARD_DEVIATION, sd);
		}
	...
	public double density(double x) {
		double x0 = x - mean;
		return FastMath
				.exp(-x0 * x0 / (2 * standardDeviation * standardDeviation))
				/ (standardDeviation * SQRT2PI);
	}

	/**
	 * For this distribution, X, this method returns P(X &lt; <code>x</code>).
	 * If <code>x</code>is more than 40 standard deviations from the mean, 0 or
	 * 1 is returned, as in these cases the actual value is within
	 ...
	 *
	 * For standard deviation parameter <code>s</code>, the variance is
	 * <code>s^2</code>
	 *
	 * @return the variance
	 * @since 2.2
