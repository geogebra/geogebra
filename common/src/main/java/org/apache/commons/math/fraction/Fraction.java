...
public class Fraction extends Number
	...
	public Fraction negate() {
		if (numerator == Integer.MIN_VALUE) {
			throw MathRuntimeException.createArithmeticException(
					LocalizedFormats.OVERFLOW_IN_FRACTION, numerator,
					denominator);
		}
	...
	private Fraction addSub(Fraction fraction, boolean isAdd) {
		...
		return new Fraction(w.intValue(), MathUtils
				.mulAndCheck(denominator / d1, fraction.denominator / d2));
	}
	...
	public Fraction multiply(Fraction fraction) {
		...
		return getReducedFraction(
				...
				MathUtils.mulAndCheck(denominator / d2,
	...
	public static Fraction getReducedFraction(int numerator, int denominator) {
		if (denominator == 0) {
			throw MathRuntimeException.createArithmeticException(
					LocalizedFormats.ZERO_DENOMINATOR_IN_FRACTION, numerator,
					denominator);
		}
		if (numerator == 0) {
