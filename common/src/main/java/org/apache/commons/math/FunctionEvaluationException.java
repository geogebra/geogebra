 ...
 *
 * @version $Revision: 885278 $ $Date: 2009-11-29 16:47:51 -0500 (Sun, 29 Nov
 *          2009) $
 */
public class FunctionEvaluationException extends MathException {
	...
	/**
	 * Construct an exception indicating the argument value that caused the
	 * function evaluation to fail.
	 *
	 * @param argument
	 ...
	 * @since 1.2
	 */
	public FunctionEvaluationException(double argument, String pattern,
			Object... arguments) {
	...
	/**
	 * Constructs an exception with specified root cause. Message formatting is
