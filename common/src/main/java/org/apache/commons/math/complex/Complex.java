...
public class Complex implements FieldElement<Complex>, Serializable {
	 ...
	 * returned value has infinite imaginary part of the opposite sign - e.g.
	 * the conjugate of <code>1 + POSITIVE_INFINITY i</code> is
	 ...
	 * <code>rhs</code> is infinite (one or both parts infinite), {@link #ZERO}
	 * is returned.</li>
	 ...
	 * <p>
	 * If both the real and imaginary parts of two Complex numbers are exactly
	 * the same, and neither is <code>Double.NaN</code>, the two Complex objects
	 ...
	 * @return true if two Complex objects are equal, false if object is null,
	 *         not an instance of Complex, or not equal to this Complex instance
	 *
	 */
	@Override
	...
	/**
	 * Compute the
	 * <a href="http://mathworld.wolfram.com/Cosine.html" TARGET="_top"> cosine
	 * </a> of this complex number.
	 * <p>
	 * Implements the formula:
	 * 
	 * <pre>
	...
	/**
	 * Compute the
	 * <a href="http://mathworld.wolfram.com/HyperbolicCosine.html" TARGET=
	 * "_top"> hyperbolic cosine</a> of this complex number.
	 * <p>
	 * Implements the formula:
	 * 
	 * <pre>
	...
	/**
	 * Compute the
	 * <a href="http://mathworld.wolfram.com/NaturalLogarithm.html" TARGET=
	 * "_top"> natural logarithm</a> of this complex number.
	 * <p>
	 * Implements the formula:
	 * 
	 * <pre>
	...
	/**
	 * Compute the
	 * <a href="http://mathworld.wolfram.com/Sine.html" TARGET="_top"> sine</a>
	...
	/**
	 * Compute the
	 * <a href="http://mathworld.wolfram.com/HyperbolicTangent.html" TARGET=
	 * "_top"> hyperbolic tangent</a> of this complex number.
	 * <p>
	 * Implements the formula:
	 * 
	 * <pre>
	 ...
	 * point representing this number in the complex plane. The value returned
	 * is between -PI (not inclusive) and PI (inclusive), with negative values
	 * returned for numbers with negative imaginary parts.
	 * </p>
	 * <p>
	 * If either real or imaginary part (or both) is NaN, NaN is returned.
	 * Infinite parts are handled as java.Math.atan2 handles them, essentially
	 * treating finite parts as zero in the presence of an infinite coordinate
	 * and returning a multiple of pi/4 depending on the signs of the infinite
	 ...
	 * </p>
	 * <p>
	 * if neither part is NaN, but at least one part is infinite, the result is
	 * a one-element list containing {@link #INF}.
	 * </p>
	 *
	 * @param n
	 *            degree of root
