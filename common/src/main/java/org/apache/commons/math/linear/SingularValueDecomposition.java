 ...
 * </ul>
 * 
 * @see <a href="http://mathworld.wolfram.com/SingularValueDecomposition.html">
 *      MathWorld</a>
 * @see <a href="http://en.wikipedia.org/wiki/Singular_value_decomposition">
 *      Wikipedia</a>
 * @version $Revision: 928081 $ $Date: 2010-03-26 23:36:38 +0100 (ven. 26 mars
 *          2010) $
 * @since 2.0
 */
public interface SingularValueDecomposition {
	 ...
	 * <p>
	 * The L<sub>2</sub> norm is max(|A &times; u|<sub>2</sub> / |u|<sub>2</sub>
	 * ), where |.|<sub>2</sub> denotes the vectorial 2-norm (i.e. the
