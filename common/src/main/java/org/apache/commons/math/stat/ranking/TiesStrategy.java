 ...
 * original array, for example (1,3,4,3) is ranked as (1,2,4,3)</li>
 * <li>MINIMUM - Tied values are assigned the minimum applicable rank, or the
 * rank of the first occurrence. For example, (1,3,4,3) is ranked as (1,2,4,2)
 * </li>
 * <li>MAXIMUM - Tied values are assigned the maximum applicable rank, or the
 * rank of the last occurrence. For example, (1,3,4,3) is ranked as (1,3,4,3)
 * </li>
 ...
 *
 * @since 2.0
 * @version $Revision: 981332 $ $Date: 2010-08-02 00:24:31 +0200 (lun. 02 aout
 *          2010) $
 */
