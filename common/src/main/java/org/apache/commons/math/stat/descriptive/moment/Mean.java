 ...
 * </ol>
 * <p>
 * If {@link #evaluate(double[])} is used to compute the mean of an array of
 * stored values, a two-pass, corrected algorithm is used, starting with the
 * definitional formula computed using the array of stored values and then
...
public class Mean extends AbstractStorelessUnivariateStatistic
	 ...
	 * <p>
	 * Statistics based on (constructed from) external moments cannot be
	...
	/**
	 * Copy constructor, creates a new {@code Mean} identical to the
	 * {@code original}
	 *
	 * @param original
	...
	/**
	 * Returns the weighted arithmetic mean of the entries in the specified
	 ...
	 * </p>
	 * <p>
	 * See {@link Mean} for details on the computing algorithm. The two-pass
	 * algorithm described above is used here, with weights applied in computing
	 * both the original estimate and the correction factor.
	 * </p>
	 * <p>
