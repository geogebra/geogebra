 ...
 * <p>
 * The LU-decomposition of matrix A is a set of three matrices: P, L and U such
 * that P&times;A = L&times;U. P is a rows permutation matrix that is used to
 * rearrange the rows of A before so that it can be decomposed. L is a lower
 ...
 * getDeterminant},</li>
 * <li>the <code>getDoublePivot</code> method has been removed (but the int
 * based {@link #getPivot() getPivot} method has been kept),</li>
 * <li>the <code>solve</code> and <code>isNonSingular</code> methods have been
 * replaced by a {@link #getSolver() getSolver} method and the equivalent
 * methods provided by the returned {@link DecompositionSolver}.</li>
 * </ul>
 *
 * @see <a href="http://mathworld.wolfram.com/LUDecomposition.html">MathWorld
 *      </a>
 * @see <a href="http://en.wikipedia.org/wiki/LU_decomposition">Wikipedia</a>
 * @version $Revision: 826627 $ $Date: 2009-10-19 12:27:47 +0200 (lun. 19 oct.
 *          2009) $
 * @since 2.0
 */
