...
public class PascalDistributionImpl extends AbstractIntegerDistribution
	...
	private void setNumberOfSuccessesInternal(int successes) {
		if (successes < 0) {
			throw MathRuntimeException.createIllegalArgumentException(
					LocalizedFormats.NEGATIVE_NUMBER_OF_SUCCESSES, successes);
		}
	...
	public double cumulativeProbability(int x) throws MathException {
		...
		if (x < 0) {
			...
			ret = Beta.regularizedBeta(probabilityOfSuccess, numberOfSuccesses,
					x + 1);
		}
		return ret;
	}
	...
	public double probability(int x) {
		...
		if (x < 0) {
			...
			ret = MathUtils.binomialCoefficientDouble(x + numberOfSuccesses - 1,
					numberOfSuccesses - 1)
	 ...
	 * parameters. Positive infinity is represented by
	 * <code>Integer.MAX_VALUE</code> together with
	 ...
	 * Returns the mean.
	 *
	 * For number of successes <code>r</code> and probability of success
	 * <code>p</code>, the mean is <code>( r * p ) / ( 1 - p )</code>
	 *
	 * @return the mean
	 * @since 2.2
	 */
	 ...
	 *
	 * For number of successes <code>r</code> and probability of success
	 * <code>p</code>, the mean is <code>( r * p ) / ( 1 - p )^2</code>
	 *
	 * @return the variance
	 * @since 2.2
	 */
