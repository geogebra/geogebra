 ...
 * Commons-Math v3.0, the same functionality will be achieved by directly using
 * the {@link #map(UnivariateRealFunction)} and
 * {@link #mapToSelf(UnivariateRealFunction)} together with new function objects
 * (not available in v2.2).
 * </p>
 *
...
public interface RealVector {
	...
	/**
	 * Generic dense iterator. It iterates in increasing order of the vector
	 * index.
	 *
	 ...
	 * iteration. No guarantees are made about order of iteration. In dense
	 * implementations, this method will often delegate to {@link #iterator()}.
	 *
	...
	/**
	 * Map {@link Math#exp(double)} operation to each entry. The instance is
	 * changed in-place.
	 *
	 * @return the mapped vector.
	 * deprecated in 2.2 (to be removed in 3.0).
