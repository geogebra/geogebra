 ...
 * </ul>
 * 
 * @version $Revision: 1074294 $ $Date: 2011-02-24 22:18:59 +0100 (jeu. 24 fevr.
 *          2011) $
 * @since 2.2
 */
public class FastMath {
	 ...
	 */
	private static final double EIGHTHS[] = { 0, 0.125, 0.25, 0.375, 0.5, 0.625,
			0.75, 0.875, 1.0, 1.125, 1.25, 1.375, 1.5, 1.625 };
	...
	public static double tanh(double x) {
		...
		if (x >= 0.5) {
			...
			// Correct for rounding in division
			ratiob += (na - daa * ratioa - daa * ratiob - dab * ratioa
					- dab * ratiob) / da;
	...
	public static double atanh(double a) {
		...
		if (a > 0.15) {
			...
			final double a2 = a * a;
			if (a > 0.087) {
				absAtanh = a * (1 + a2 * (F_1_3 + a2
						* (F_1_5 + a2 * (F_1_7 + a2 * (F_1_9 + a2 * (F_1_11 + a2
								* (F_1_13 + a2 * (F_1_15 + a2 * F_1_17))))))));
			} else if (a > 0.031) {
				absAtanh = a * (1 + a2 * (F_1_3 + a2 * (F_1_5 + a2 * (F_1_7
	...
	private static double sinQ(double xa, double xb) {
		...
		if (xb != 0.0) {
			t = ((costA + costB) * (cosEpsA + cosEpsB)
					- (sintA + sintB) * (sinEpsA + sinEpsB)) * xb; // approximate
																	// cosine*xb
			c = a + t;
			d = -(c - a - t);
			a = c;
	...
	private static double tanQ(double xa, double xb, boolean cotanFlag) {
		...
		// rounding
		double err = (sina - esta * cosaa - esta * cosab - estb * cosaa
				- estb * cosab) / cosa; // Correction for division rounding
	...
	private static double atan(double xa, double xb, boolean leftPlane) {
		...
		if (xa < 1.0) {
			...
			double temp = 1.0 / xa;
			idx = (int) (-((-1.7168146928204136 * temp * temp + 8.0) * temp)
					+ 13.07);
		}
	...
	public static double cbrt(double x) {
		...
		final double mant = Double.longBitsToDouble(
	...
	public static float min(final float a, final float b) {
		...
		/*
		 * if (a > b) { return b; } if (a < b) { return a; } // if either arg is
		 * NaN, return NaN if (a != b) { return Float.NaN; } // min(+0.0,-0.0)
		 * == -0.0 // 0x80000000 == Float.floatToRawIntBits(-0.0d) int bits =
		 * Float.floatToRawIntBits(a); if (bits == 0x80000000) { return a; }
		 * return b;
		 */
	}
	...
	public static double min(final double a, final double b) {
		...
		/*
		 * if (a > b) { return b; } if (a < b) { return a; } // if either arg is
		 * NaN, return NaN if (a != b) { return Double.NaN; } // min(+0.0,-0.0)
		 * == -0.0 // 0x8000000000000000L == Double.doubleToRawLongBits(-0.0d)
		 * long bits = Double.doubleToRawLongBits(a); if (bits ==
		 * 0x8000000000000000L) { return a; } return b;
		 */
	}
	...
	public static float max(final float a, final float b) {
		...
		/*
		 * if (a > b) { return a; } if (a < b) { return b; } // if either arg is
		 * NaN, return NaN if (a != b) { return Float.NaN; } // min(+0.0,-0.0)
		 * == -0.0 // 0x80000000 == Float.floatToRawIntBits(-0.0d) int bits =
		 * Float.floatToRawIntBits(a); if (bits == 0x80000000) { return b; }
		 * return a;
		 */
	}
	...
	public static double max(final double a, final double b) {
		 ...
		 * == -0.0 // 0x8000000000000000L == Double.doubleToRawLongBits(-0.0d)
		 * long bits = Double.doubleToRawLongBits(a); if (bits ==
		 * 0x8000000000000000L) { return b; } return a;
		 */
	}
