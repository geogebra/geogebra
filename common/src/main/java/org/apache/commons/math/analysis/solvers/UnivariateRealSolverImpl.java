...
public abstract class UnivariateRealSolverImpl extends ConvergingAlgorithmImpl
	 ...
	 * @since 2.2
	 */
	public double solve(int maxEval, UnivariateRealFunction function,
			double min, double max)
			throws ConvergenceException, FunctionEvaluationException {
		throw MathRuntimeException.createUnsupportedOperationException(
	...
	protected void verifyBracketing(final double lower, final double upper,
		...
		if (!isBracketing(lower, upper, function)) {
			throw MathRuntimeException.createIllegalArgumentException(
					LocalizedFormats.SAME_SIGN_AT_ENDPOINTS, lower, upper,
