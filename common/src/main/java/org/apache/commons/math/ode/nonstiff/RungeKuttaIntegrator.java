 ...
 *
 * <p>
 * These methods are explicit Runge-Kutta methods, their Butcher arrays are as
 * follows :
 * 
 * <pre>
 *    0  |
...
public abstract class RungeKuttaIntegrator extends AbstractIntegrator {
	 ...
	 *            integration step
	 */
	protected RungeKuttaIntegrator(final String name, final double[] c,
			final double[][] a, final double[] b,
			final RungeKuttaStepInterpolator prototype, final double step) {
		super(name);
		this.c = c;
		this.a = a;
		this.b = b;
