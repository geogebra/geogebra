 ...
 * </p>
 * <p>
 * As shown by the presence of the P matrix, this decomposition is implemented
...
public class LUDecompositionImpl implements LUDecomposition {
	 ...
	 *            threshold (based on partial row norm) under which a matrix is
	 *            considered singular
	...
	private static class Solver implements DecompositionSolver {
		 ...
		 *            singularity indicator
		 */
		private Solver(final double[][] lu, final int[] pivot,
