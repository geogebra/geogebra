...
public class DormandPrince54Integrator extends EmbeddedRungeKuttaIntegrator {
	...
	private static final double[] STATIC_C = { 1.0 / 5.0, 3.0 / 10.0, 4.0 / 5.0,
			8.0 / 9.0, 1.0, 1.0 };
	...
	private static final double[] STATIC_B = { 35.0 / 384.0, 0.0,
	...
	public DormandPrince54Integrator(final double minStep, final double maxStep,
		...
		super(METHOD_NAME, true, STATIC_C, STATIC_A, STATIC_B,
				new DormandPrince54StepInterpolator(), minStep, maxStep,
	...
	/** {@inheritDoc} */
	@Override
	protected double estimateError(final double[][] yDotK, final double[] y0,
		...
		for (int j = 0; j < mainSetDimension; ++j) {
			final double errSum = E1 * yDotK[0][j] + E3 * yDotK[2][j]
					+ E4 * yDotK[3][j] + E5 * yDotK[4][j] + E6 * yDotK[5][j]
					+ E7 * yDotK[6][j];
