...
public class GammaDistributionImpl extends AbstractContinuousDistribution
	...
	private void setAlphaInternal(double newAlpha) {
		if (newAlpha <= 0.0) {
			throw MathRuntimeException.createIllegalArgumentException(
					LocalizedFormats.NOT_POSITIVE_ALPHA, newAlpha);
		}
		this.alpha = newAlpha;
	}
	...
	private void setBetaInternal(double newBeta) {
		if (newBeta <= 0.0) {
			throw MathRuntimeException.createIllegalArgumentException(
					LocalizedFormats.NOT_POSITIVE_BETA, newBeta);
		}
		this.beta = newBeta;
	}
	 ...
	 * <code>beta</code>, the mean is <code>alpha * beta</code>
	 *
	 * @return the mean
	 * @since 2.2
	 */
	 ...
	 *
	 * For shape parameter <code>alpha</code> and scale parameter
	 * <code>beta</code>, the variance is <code>alpha * beta^2</code>
	 *
	 * @return the variance
	 * @since 2.2
	 */
