 ...
 * <p>
 * Uses commons-math
 * {@link org.apache.commons.math.distribution.TDistributionImpl} implementation
...
public class TTestImpl implements TTest {
	 ...
	 * <strong><code> n2</code></strong> is the size of second sample; <strong>
	 * <code> m1</code></strong> is the mean of first sample; <strong>
	 * <code> m2</code></strong> is the mean of second sample</li>
	 * </ul>
	 ...
	 * <p>
	 * with <strong>
	 * <code>var1<code></strong> the variance of the first sample and
	 ...
	 * <strong><code> n2</code></strong> is the size of second sample; <strong>
	 * <code> m1</code></strong> is the mean of first sample; <strong>
	 * <code> m2</code></strong> is the mean of second sample and <strong>
	...
	/**
	 * Performs a <a href=
	 * "http://www.itl.nist.gov/div898/handbook/eda/section3/eda353.htm"> two-
	 * sided t-test</a> evaluating the null hypothesis that the mean of the
	 * population from which <code>sample</code> is drawn equals <code>mu</code>
	 * .
	 * <p>
	 * Returns <code>true</code> iff the null hypothesis can be rejected with
	 * confidence <code>1 - alpha</code>. To perform a 1-sided test, use
	 ...
	 * "http://www.basic.nwu.edu/statguidefiles/sg_glos.html#one-sample">here
	 * </a>
	 * </p>
	 * <p>
	 * <strong>Preconditions</strong>:
	 ...
	 * Performs a <a href=
	 * "http://www.itl.nist.gov/div898/handbook/eda/section3/eda353.htm"> two-
	 * sided t-test</a> evaluating the null hypothesis that <code>sample1</code>
	 ...
	 * Performs a <a href=
	 * "http://www.itl.nist.gov/div898/handbook/eda/section3/eda353.htm"> two-
	 * sided t-test</a> evaluating the null hypothesis that
	 ...
	 * @return t test statistic
	 */
	protected double homoscedasticT(double m1, double m2, double v1, double v2,
			double n1, double n2) {
	...
	protected double tTest(double m1, double m2, double v1, double v2,
			double n1, double n2) throws MathException {
	...
	protected double homoscedasticTTest(double m1, double m2, double v1,
			double v2, double n1, double n2) throws MathException {
