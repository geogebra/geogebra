 ...
 *
 * @version $Revision: 1073276 $ $Date: 2011-02-22 10:34:52 +0100 (mar. 22 fevr.
 *          2011) $
 */
public final class StatUtils {
	...
	/**
	 * Returns the sum of the entries in the specified portion of the input
	 ...
	 * @param values
	 *            the input array
	 * @return the sum of the natural logs of the values or Double.NaN if the
	 *         array is empty
	 * @throws IllegalArgumentException
	 *             if the array is null
	 */
	 ...
	 * portion of the input array, or <code>Double.NaN</code> if the designated
	 * subarray is empty.
	 * <p>
	 * Throws <code>IllegalArgumentException</code> if the array is null.
	 * </p>
	 ...
	 * @param length
	 *            the number of elements to include
	 * @return the sum of the natural logs of the values or Double.NaN if length
	 *         = 0
	 * @throws IllegalArgumentException
	 *             if the array is null or the array index parameters are not
	 *             valid
	...
	/**
	 * Returns the variance of the entries in the specified portion of the input
	 * array, or <code>Double.NaN</code> if the designated subarray is empty.
	 * <p>
	 * See {@link org.apache.commons.math.stat.descriptive.moment.Variance} for
	 * details on the computing algorithm.
	...
	/**
	 * Returns the variance of the entries in the specified portion of the input
	 * array, using the precomputed mean value. Returns <code>Double.NaN</code>
	 ...
	 * supplied only to save computation when the mean has already been
	 * computed.
	 * </p>
	 * <p>
	 * Returns 0 for a single-value (i.e. length = 1) sample.
	 ...
	 * precomputed mean value. Returns <code>Double.NaN</code> if the array is
	 * empty.
	 * <p>
	 * See {@link org.apache.commons.math.stat.descriptive.moment.Variance} for
	 * details on the computing algorithm.
	...
	public static double sumDifference(final double[] sample1,
		...
		if (n != sample2.length) {
			throw MathRuntimeException.createIllegalArgumentException(
					LocalizedFormats.DIMENSIONS_MISMATCH_SIMPLE, n,
					sample2.length);
		}
		if (n < 1) {
			throw MathRuntimeException.createIllegalArgumentException(
	 ...
	 * elements of the input arrays -- i.e., var(sample1[i] - sample2[i]).
	 *
	 * @param sample1
	 *            the first array
	 * @param sample2
	 ...
	 * @throws IllegalArgumentException
	 *             if the arrays do not have the same length or their common
	...
	/**
	 * Normalize (standardize) the series, so in the end it is having a mean of
	 ...
	 * 
	 *        // Add the data from the series to stats for (int i = 0; i <
	 *        sample.length; i++) { stats.addValue(sample[i]); }
	 * 
	 *        // Compute mean and standard deviation double mean =
	 *        stats.getMean(); double standardDeviation =
	 *        stats.getStandardDeviation();
	 * 
	 *        // initialize the standardizedSample, which has the same length as
	 *        the sample double[] standardizedSample = new
	 *        double[sample.length];
	 * 
	 *        for (int i = 0; i < sample.length; i++) { // z = (x-
	 *        mean)/standardDeviation standardizedSample[i] = (sample[i] - mean)
