...
public class MatrixUtils {
	...
	/**
	 * Returns a {@link RealMatrix} whose entries are the the values in the the
	 * input array.
	 * <p>
	 * The type of matrix returned depends on the dimension. Below 2
	 * <sup>12</sup> elements (i.e. 4096 elements or 64&times;64 for a square
	 ...
	 *             if <code>data</code> is not rectangular (not all rows have
	 *             the same length) or empty
	 * @throws NullPointerException
	 *             if either <code>data</code> or <code>data[0]</code> is null
	 ...
	 *
	 * @param diagonal
	 *            diagonal elements of the matrix (the array elements will be
	 *            copied)
	...
	/**
	 * Creates a row {@link RealMatrix} using the data from the input array.
	 *
	 * @param rowData
	 *            the input row data
	...
	public static void checkRowIndex(final AnyMatrix m, final int row) {
		if (row < 0 || row >= m.getRowDimension()) {
			throw new MatrixIndexException(
					LocalizedFormats.ROW_INDEX_OUT_OF_RANGE, row, 0,
					m.getRowDimension() - 1);
		}
	}
	...
	public static void checkColumnIndex(final AnyMatrix m, final int column)
		...
		if (column < 0 || column >= m.getColumnDimension()) {
			throw new MatrixIndexException(
					LocalizedFormats.COLUMN_INDEX_OUT_OF_RANGE, column, 0,
	...
	public static void checkSubMatrixIndex(final AnyMatrix m,
		...
		if (startRow > endRow) {
			throw new MatrixIndexException(
					LocalizedFormats.INITIAL_ROW_AFTER_FINAL_ROW, startRow,
					endRow);
		}
	 ...
	 */
	public static void checkAdditionCompatible(final AnyMatrix left,
			final AnyMatrix right) throws IllegalArgumentException {
	 ...
	 */
	public static void checkSubtractionCompatible(final AnyMatrix left,
			final AnyMatrix right) throws IllegalArgumentException {
		if ((left.getRowDimension() != right.getRowDimension())
				|| (left.getColumnDimension() != right.getColumnDimension())) {
			throw MathRuntimeException.createIllegalArgumentException(
	 ...
	 */
	public static void checkMultiplicationCompatible(final AnyMatrix left,
			final AnyMatrix right) throws IllegalArgumentException {
