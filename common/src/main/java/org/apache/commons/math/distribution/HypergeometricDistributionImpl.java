...
public class HypergeometricDistributionImpl extends AbstractIntegerDistribution
	 ...
	 *
	 * For population size <code>N</code>, number of successes <code>m</code>,
	 * and sample size <code>n</code>, the lower bound of the support is
	 ...
	 *
	 * For number of successes <code>m</code> and sample size <code>n</code>,
	 * the upper bound of the support is <code>min(m, n)</code>
	 *
	 ...
	 *
	 * For population size <code>N</code>, number of successes <code>m</code>,
	 * and sample size <code>n</code>, the mean is <code>n * m / N</code>
	 *
	 * @return the mean
	 * @since 2.2
	 */
	 ...
	 *
	 * For population size <code>N</code>, number of successes <code>m</code>,
	 * and sample size <code>n</code>, the variance is
