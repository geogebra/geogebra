...
public class BinomialDistributionImpl extends AbstractIntegerDistribution
	...
	public double cumulativeProbability(int x) throws MathException {
		...
		if (x < 0) {
			...
			ret = 1.0 - Beta.regularizedBeta(getProbabilityOfSuccess(), x + 1.0,
					numberOfTrials - x);
		}
		return ret;
	}
	 ...
	 * Returns the mean.
	 *
	 * For <code>n</code> number of trials and probability parameter
	 * <code>p</code>, the mean is <code>n * p</code>
	 *
	 * @return the mean
	 * @since 2.2
	 */
	 ...
	 *
	 * For <code>n</code> number of trials and probability parameter
	 * <code>p</code>, the variance is <code>n * p * (1 - p)</code>
	 *
	 * @return the variance
	 * @since 2.2
	 */
