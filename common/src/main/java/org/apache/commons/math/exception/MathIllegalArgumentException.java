...
/**
 * Base class for all preconditions violation exceptions. This class is not
 * intended to be instantiated directly: it should serve as a base class to
 * create all the exceptions that share the semantics of the standard
 * {@link IllegalArgumentException}, but must also provide a localized message.
 *
 * @since 2.2
...
public class MathIllegalArgumentException extends IllegalArgumentException
	 ...
	 *            Arguments.
	 */
	protected MathIllegalArgumentException(String specific, String general,
			Object... args) {
	 ...
	 *            Arguments.
	 */
	protected MathIllegalArgumentException(String general, Object... args) {
