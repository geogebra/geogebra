...
public interface Distribution {
	 ...
	 * distribution, this method returns P(X &le; x). In other words, this
	 * method represents the (cumulative) distribution function, or CDF, for
	 * this distribution.
	 *
	 * @param x
	...
	/**
	 * For a random variable X whose values are distributed according to this
	 * distribution, this method returns P(x0 &le; X &le; x1).
	 *
	 * @param x0
