...
public interface DifferentiableMultivariateVectorialOptimizer {
	 ...
	 * {@link #optimize(DifferentiableMultivariateVectorialFunction, double[], double[], double[])
	 ...
	 * The cost function to be minimized is &sum;weight<sub>i</sub>(objective
	 * <sub>i</sub>-target<sub>i</sub>)<sup>2</sup>
	 * </p>
	 * 
	 * @param f
	 *            objective function
	 ...
	 *                if the objective function throws one during the search
	 * @exception OptimizationException
	 *                if the algorithm failed to converge
	 * @exception IllegalArgumentException
	 *                if the start point dimension is wrong
	 */
	VectorialPointValuePair optimize(
			DifferentiableMultivariateVectorialFunction f, double[] target,
			double[] weights, double[] startPoint)
