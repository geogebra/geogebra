...
public abstract class App implements UpdateSelection {
	...
	public String getFullHTML5ExportString() {
		...
		sb.append(
				"\"language\":\"" + getLocalization().getLanguage() + "\",\n");
		...
		String GeoGebra_loading = convertImageToDataURIIfPossible(
				GeoGebraConstants.GEOGEBRA_LOADING_PNG);
		String applet_play = convertImageToDataURIIfPossible(
		...
		GBufferedImage preview = getActiveEuclidianView().getExportImage(1);
