...
public class AxesNumberingDistanceProperty extends AbstractProperty implements BooleanProperty {
     ...
     */
    public AxesNumberingDistanceProperty(Localization localization, EuclidianSettings euclidianSettings) {
    ...
    public void setValue(boolean value) {
        ...
        for (int i = 0; i < length; i++) {
            euclidianSettings.setAutomaticAxesNumberingDistance(!value, i, value);
        }
    }
}
