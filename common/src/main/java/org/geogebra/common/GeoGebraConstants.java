...
public interface GeoGebraConstants {
	...
	/** last build date */
	public static final String BUILD_DATE = "14 March 2018";
	/** complete version string */
	public static final String VERSION_STRING = "5.0.445.0";
	...
	public final static String GEOGEBRA_HELP_WEBSITE = "https://wiki.geogebra.org/";
