...
public interface GeoGebraConstants {
	...
	/** last build date */
	public static final String BUILD_DATE = "14 November 2023";
	/** complete version string */

	public static final String VERSION_STRING = "5.2.813.0";
	...
	public final static String GEOGEBRA_WIKI = "https://wiki.geogebra.org/";
