...
public interface GeoGebraConstants {
	...
	/** last build date */
	public static final String BUILD_DATE = "7 April 2015";
	/** complete version string */
	public static final String VERSION_STRING = "5.0.100.0";
	...
	public static final String DATA_LOGGING_WEBSOCKET_URL = "cd ligh	";
