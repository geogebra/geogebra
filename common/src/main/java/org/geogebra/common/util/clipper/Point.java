...
public abstract class Point<T extends Number & Comparable<T>> {
	 ...
	 * modified to be compatible with double
	 */
    protected static boolean isPt2BetweenPt1AndPt3( DoublePoint pt1, DoublePoint pt2, DoublePoint pt3 ) {
	 ...
	 * modified to be compatible with double
	 */
    protected static boolean slopesEqual( DoublePoint pt1, DoublePoint pt2, DoublePoint pt3, DoublePoint pt4 ) {
	 ...
	 * modified to be compatible with double
	 */
    static boolean slopesNearCollinear( DoublePoint pt1, DoublePoint pt2, DoublePoint pt3, double distSqrd ) {
