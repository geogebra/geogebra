...
public class MyDouble extends ValidExpression
	...
	public static double parseDouble(Localization app, String str) {
		StringBuilder sb = appendChars(str, false);
		try {
	...
	/**
	 * Appends the characters from a given string
	 * @param str String to be parsed (input)
	 * @param isRecurringDecimal Whether or not we want to append Unicode.OVERLINE (\u0305)
	 * @return StringBuilder
	 */
	public static StringBuilder appendChars(String str, boolean isRecurringDecimal) {
