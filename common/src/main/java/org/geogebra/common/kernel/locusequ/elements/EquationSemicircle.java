...
/**
 * @author sergio EquationElement for {@link AlgoSemicircle}.
 */
public class EquationSemicircle extends EquationGenericConicPart {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationSemicircle(final GeoElement conic,
	...
	protected void computeMatrix() {
		...
		AlgoSemicircle algo = (AlgoSemicircle) this.getResult()
				.getParentAlgorithm();
