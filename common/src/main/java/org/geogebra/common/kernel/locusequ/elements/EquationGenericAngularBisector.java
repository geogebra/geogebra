...
/**
 * @author sergio Generic base class for angular bisectors.
 */
public abstract class EquationGenericAngularBisector
		extends EquationGenericLine {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationGenericAngularBisector(final GeoElement el,
