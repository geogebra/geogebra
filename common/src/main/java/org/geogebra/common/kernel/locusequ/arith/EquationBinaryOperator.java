...
public abstract class EquationBinaryOperator extends EquationOperator {
	 ...
	 * @param expr2
	 *            for the secon parameter.
	 */
	public EquationBinaryOperator(final EquationExpression expr1,
			final EquationExpression expr2) {
		super(expr1, expr2);
	}
	...
	/**
	 * Subclasses must implement this method representing current operator for
	 * doubles.
	 * 
	 * @param a
	 *            value for first expression
	 * @param b
	 *            value for second expression
