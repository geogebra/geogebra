...
/**
 * @author sergio EquationElement for {@link AlgoAngularBisectorLines}
 */
public class EquationAngularBisectorLines
	 ...
	 *            {@link EquationScope}
	 */
	public EquationAngularBisectorLines(final GeoElement line,
			final EquationScope scope) {
		super(line, scope);

		AlgoAngularBisectorLines algo = (AlgoAngularBisectorLines) line
				.getParentAlgorithm();
