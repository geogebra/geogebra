...
/**
 * @author sergio Represents a system with its equation list and its scope.
 */
public class EquationSystem {
	...
	/**
	 * Some heuristic check if two equation systems looks same. If their string
	 * representation are equal then we assume yes, otherwise not.
	 * 
	 * @param system
	 *            the equation system to compare
