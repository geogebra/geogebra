...
/**
 * @author sergio Represents a Numeric Value.
 */
public class EquationNumericValue extends EquationValue {
	...
	/**
	 * There is no constructor for this object and this method should be used
	 * instead.
	 * 
	 * @param value
	 *            the double value it represents.
	 ...
	 * 
	 * @param value
	 *            represented in this numeric value
	 */
