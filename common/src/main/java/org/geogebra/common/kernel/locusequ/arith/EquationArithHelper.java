...
/**
 * @author sergio A class that should be static imported when you want to make
 *         some calculations.
 * 
 *         I seriously considered to make all classes but this and
 *         EquationExpression package private.
 */
public class EquationArithHelper {
	...
	/**
	 * @param x
	 *            Expression to be multiplied by itself.
	 ...
	 * @return base ^ exp
	 */
	public static EquationExpression pow(EquationExpression base,
			EquationExpression exp) {
		if (!base.isSimplifiable() || !exp.isSimplifiable()
	 ...
	 * @return (end1 + end2)/2;
	 */
	public static EquationExpression mid(EquationExpression end1,
			EquationExpression end2) {
	 ...
	 *            the other ends.
	 * @param middle
	 *            the expression that will be set as the middle.
	 ...
	 */
	public static EquationExpression det3(EquationExpression a1,
			EquationExpression a2, EquationExpression a3, EquationExpression a4,
			EquationExpression a5, EquationExpression a6, EquationExpression a7,
			EquationExpression a8, EquationExpression a9) {
		return diff(
				sum(times(a1, a5, a9), times(a3, a4, a8), times(a2, a6, a7)),
				sum(times(a3, a5, a7), times(a1, a6, a8), times(a2, a4, a9)));
	}

	public static EquationExpression det4(EquationExpression a1,
			EquationExpression a2, EquationExpression a3, EquationExpression a4,
			EquationExpression a5, EquationExpression a6, EquationExpression a7,
			EquationExpression a8, EquationExpression a9,
			EquationExpression a10, EquationExpression a11,
			EquationExpression a12, EquationExpression a13,
			EquationExpression a14, EquationExpression a15,
			EquationExpression a16) {
		return sum(times(a1, det3(a6, a7, a8, a10, a11, a12, a14, a15, a16)),
				times(a2, det3(a5, a7, a8, a9, a11, a12, a13, a15, a16))
						.getOpposite(),
				times(a3, det3(a5, a6, a8, a9, a10, a12, a13, a14, a16)),
				times(a4, det3(a5, a6, a7, a9, a10, a11, a13, a14, a15))
						.getOpposite());
	}

	public static EquationExpression det5(EquationExpression a1,
			EquationExpression a2, EquationExpression a3, EquationExpression a4,
			EquationExpression a5, EquationExpression a6, EquationExpression a7,
			EquationExpression a8, EquationExpression a9,
			EquationExpression a10, EquationExpression a11,
			EquationExpression a12, EquationExpression a13,
			EquationExpression a14, EquationExpression a15,
			EquationExpression a16, EquationExpression a17,
			EquationExpression a18, EquationExpression a19,
			EquationExpression a20, EquationExpression a21,
			EquationExpression a22, EquationExpression a23,
			EquationExpression a24, EquationExpression a25) {
		return sum(
				times(a1,
						det4(a7, a8, a9, a10, a12, a13, a14, a15, a17, a18, a19,
								a20, a22, a23, a24, a25)),
				times(a2,
						det4(a6, a8, a9, a10, a11, a13, a14, a15, a16, a18, a19,
								a20, a21, a23, a24, a25)).getOpposite(),
				times(a3,
						det4(a6, a7, a9, a10, a11, a12, a14, a15, a16, a17, a19,
								a20, a21, a22, a24, a25)),
				times(a4,
						det4(a6, a7, a8, a10, a11, a12, a13, a15, a16, a17, a18,
								a20, a21, a22, a23, a25)).getOpposite(),
				times(a5, det4(a6, a7, a8, a9, a11, a12, a13, a14, a16, a17,
						a18, a19, a21, a22, a23, a24)));
	}

	/**
	 * @param args
	 *            EquationExpression to be "summed".
	...
	public static EquationExpression sum(EquationExpression... args) {
		...
		case 2:
			if (!args[0].isSimplifiable() || !args[1].isSimplifiable()) {
				if (args[0].isSimplifiable() && args[0].computeValue() == 0.0) {
					return args[1];
				} else if (args[1].isSimplifiable()
						&& args[1].computeValue() == 0.0) {
					return args[0];
				}
		...
		default:
			...
			return new EquationSumOperator(EquationNumericValue.from(value),
					sumRaw(symbolic
							.toArray(new EquationExpression[symbolic.size()])));
		}
	}
	...
	public static EquationExpression sumRaw(EquationExpression... args) {
		...
		case 2:
			return new EquationSumOperator(args[0], args[1]);
		default:
			EquationExpression[] args2 = new EquationExpression[args.length
					- 1];
	...
	/**
	 * @param args
	 *            EquationExpression to be "substracted".
	 * @return A EquationExpression like
	...
	/**
	 * @param args
	 *            EquationExpression to be "multiplied".
	 * @return A EquationExpression like "(args[0]*args[1]*...)".
	 */
	public static EquationExpression times(EquationExpression... args) {
		...
		case 1:
			return args[0];
		case 2:
			if (args[0].containsSymbolicValues()
					|| args[1].containsSymbolicValues()) {
				if (!args[0].containsSymbolicValues()
						&& args[0].computeValue() == 1.0) {
					return args[1];
				} else if (!args[1].containsSymbolicValues()
						&& args[1].computeValue() == 1.0) {
					return args[0];
				}
	 ...
	 */
	public static EquationExpression div(EquationExpression numerator,
			EquationExpression denominator) {
		if (!numerator.isSimplifiable() || !denominator.isSimplifiable()
