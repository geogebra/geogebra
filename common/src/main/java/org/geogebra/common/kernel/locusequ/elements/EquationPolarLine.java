...
/**
 * @author sergio EquationElement for {@link AlgoPolarLine}
 */
public class EquationPolarLine extends EquationGenericLine {
	...
	public EquationPolarLine(final GeoElement line, final EquationScope scope) {
		...
		EquationGenericConic c = (EquationGenericConic) getScope()
				.getElement(conic);
	 ...
	 * 
	 * @param conic
	 *            {@link EquationGenericConic}
	 * @param p
	 *            {@link EquationPoint}
	 * @param scope
	 *            {@lin EquationScope}
	 */
	public EquationPolarLine(final EquationGenericConic conic,
			final EquationPoint p, final EquationScope scope) {
		this.setScope(scope);
	 ...
	 *            {@link EquationPoint}
	 */
	protected void getCoefficientsFromConic(final EquationGenericConic conic,
