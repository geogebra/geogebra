...
/**
 * @author sergio Represents the midpoint of other two.
 */
public class EquationMidpoint extends EquationSymbolicPoint
	...
	public GeoPoint getPoint() {
		return a.getPoint(); // non-sense at all, but hey, it is an
								// EquationAuxiliarElement.
	}

	@Override
	protected String getId() {
		return null; // non-sense at all, but hey, it is an
						// EquationAuxiliarElement.
	}
	...
	public EquationExpression getXExpression() {
		if (this.x == null) {
			this.x = div(sum(this.a.getXExpression(), this.b.getXExpression()),
	...
	public EquationExpression getYExpression() {
		if (this.y == null) {
			this.y = div(sum(this.a.getYExpression(), this.b.getYExpression()),
					EquationNumericValue.from(2));
		}
		return this.y;
	}
	...
	public EquationExpression getZExpression() {
		if (this.z == null) {
			this.z = div(sum(this.a.getZExpression(), this.b.getZExpression()),
					EquationNumericValue.from(2));
		}
		return this.z;
	}
