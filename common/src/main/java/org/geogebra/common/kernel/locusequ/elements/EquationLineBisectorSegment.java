...
/**
 * @author sergio EquationElement for {@link AlgoLineBisectorSegment}
 */
public class EquationLineBisectorSegment extends EquationGenericBisector {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationLineBisectorSegment(final GeoElement line,
			final EquationScope scope) {
		super(line, scope);

		AlgoLineBisectorSegment algo = (AlgoLineBisectorSegment) line
				.getParentAlgorithm();
