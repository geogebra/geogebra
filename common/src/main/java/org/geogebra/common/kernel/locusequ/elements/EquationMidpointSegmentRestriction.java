...
/**
 * @author sergio Restriction for {@link AlgoMidpointSegment}.
 */
public class EquationMidpointSegmentRestriction
	 ...
	 *            {@link EquationScope}
	 */
	public EquationMidpointSegmentRestriction(final GeoElement geo,
			final AlgoMidpointSegment algo, final EquationScope scope) {
