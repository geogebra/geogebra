...
/**
 * @author sergio EquationElement for {@link AlgoLinePointLine}
 */
public class EquationLinePointLine extends EquationGenericLine {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationLinePointLine(final GeoElement element,
			final EquationScope scope) {
		super(element, scope);
		AlgoLinePointLine algo = (AlgoLinePointLine) this.getResult()
				.getParentAlgorithm();
