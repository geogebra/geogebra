...
public abstract class EquationExpression {
	 ...
	 * 
	 * @return an {@link EquationExpression} for the opposite of
	 *         <code>this</code>.
	 */
	 ...
	 * 
	 * @return an {@link EquationExpression} for the inverse of
	 *         <code>this</code>.
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is an auxiliar symbolic
	 *         value?
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is a special symbolic
	 *         value.
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is a any kind of symbolic
	 *         value.
	 */
	public boolean isAnySymbolicValue() {
		return this.isAuxiliarSymbolicValue() || this.isSymbolicValue()
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is a substraction
	 *         operator.
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is an exponential
	 *         operator.
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is a square root
	 *         operator.
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is this is an opposite
	 *         operator.
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is this an inverse
	 *         operator.
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> is an absolute value
	 *         operator.
	 */
	 ...
	 * 
	 * @return <code>true</code> iff <code>this</code> contains any kind of
	 *         symbolic value.
	 */
	...
	/**
	 * Computes the value of current expression. It does so iff
	 * containsSymbolicValues returns true.
	 * 
	 * @return the value of computing current expression. If it contains
	 *         symbolic values it returns NaN.
	 */
	...
	/**
	 * An abstract method with the actual implementation of computeValue.
	 * 
	...
	public boolean isSimplifiable() {
		return !this.containsSymbolicValues()
				&& !Double.isNaN(this.computeValue());
	}
