...
/**
 * @author sergio Common base class for bisectors.
 */
public abstract class EquationGenericBisector extends EquationGenericLine {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationGenericBisector(final GeoElement line,
	...
	protected void setExtremePoints(final EquationPoint a,
