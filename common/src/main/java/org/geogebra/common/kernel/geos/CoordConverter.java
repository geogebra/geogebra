...
public interface CoordConverter {
     ...
     * @param startValue initial parameter value
     * @param view       3D view
    ...
    /**
     * @param parent     changeable parent
     * @param startPoint start point
     */
    void record(ChangeableParent parent, Coords startPoint);

    /**
     * @param startPoint3D     start point
     * @param direction        movement direction
     * @param rayOrigin        hitting origin
     * @param rayDirection     hitting direction
     * @param translationVec3D output parameter for translation
     */
