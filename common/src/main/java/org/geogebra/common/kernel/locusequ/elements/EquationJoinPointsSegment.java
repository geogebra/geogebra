...
/**
 * @author sergio Equation Element for {@link AlgoJoinPointsSegment}
 */
public class EquationJoinPointsSegment extends EquationGenericSegment {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationJoinPointsSegment(final GeoElement element,
			final EquationScope scope) {
		super(element, scope);

		AlgoJoinPointsSegment algo = (AlgoJoinPointsSegment) this.getResult()
				.getParentAlgorithm();
		this.q = algo.getQ();
