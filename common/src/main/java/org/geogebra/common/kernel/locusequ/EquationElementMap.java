...
/**
 * @author sergio Scope for elementss. Maps elements to symbolic representation.
 */
public class EquationElementMap {
	 ...
	 * 
	 * @param scope
	 *            {@link EquationScope} associated to this map.
	 */
	 ...
	 */
	public EquationElement put(final GeoElement key,
			final EquationElement value) {
	 ...
	 */
	private EquationElementInterface createEquationElement(
			final GeoElement key) {
	 ...
	 * 
	 * @param orig
	 *            the element that will get the symbolic representation from
	 *            target.
	 * @param target
	 *            produces the symbolic representation.
	 */
