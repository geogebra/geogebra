...
/**
 * @author sergio Represents the sum of two expressions.
 */
public class EquationSumOperator extends EquationBinaryOperator {

	public EquationSumOperator(EquationExpression expr1,
			EquationExpression expr2) {
		super(expr1, expr2);
	}
	 ...
	 * { T a,b; a = this.getFirstExpression().translate(translator); b =
	 * this.getSecondExpression().translate(translator); return
	 * translator.sum(a,b); }
	 */

	@Override
	public long toLong() {
		return this.getFirstExpression().toLong()
				+ this.getSecondExpression().toLong();
	}

	@Override
	public String toString() {
		return "(" + this.getFirstExpression().toString() + "+"
