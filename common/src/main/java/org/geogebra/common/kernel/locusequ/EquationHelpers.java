...
/**
 * @author sergio Just a class full of helpers ready to static import them.
 */
public class EquationHelpers {
	 ...
	 * 
	 * @param element
	 *            whose predecessors points will be returned.
	 * @return an array of points. If element is a point it will be the last
	 *         point in array.
	 */
	public static GeoPoint[] getDependentPredecessorPointsForElement(
			final GeoElement element) {
		// Count points.
		...
		while (it.hasNext()) {
			el = it.next();
			if (el.isGeoPoint() && !el.isIndependent()) {
	 ...
	 * 
	 * @param element
	 *            whose predecessor points are returned.
	 * @return an array of points. If given element is a point it won't be
	 *         returned.
	 */
	public static GeoPoint[] getPredecessorPointsForElement(
			final GeoElement element) {
	 ...
	 * 
	 * @param el
	 *            element whose points will be returned.
