...
/**
 * @author sergio EquationElement for {@link AlgoOrthoLinePointLine}
 */
public class EquationOrthoLinePointLine extends EquationGenericLine {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationOrthoLinePointLine(final GeoElement l,
			final EquationScope scope) {
		super(l, scope);
		AlgoOrthoLinePointLine algo = (AlgoOrthoLinePointLine) l
				.getParentAlgorithm();

		this.lParam = algo.getl();
		this.lParamEqu = (EquationGenericLine) this.getScope()
				.getElement(this.lParam);
