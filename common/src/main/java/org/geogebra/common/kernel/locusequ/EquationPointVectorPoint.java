...
/**
 * @author sergio Represents the point resulted from applying a vector to
 *         another point.
 */
public class EquationPointVectorPoint extends EquationPoint
		implements EquationAuxiliaryElement {
	 ...
	 *            point
	 */
	public EquationPointVectorPoint(SymbolicVector vector,
			EquationPoint point) {
		super();
		this.vector = vector; // Just in case;
		this.point = point; // Just in case;
		this.independent = this.vector.isIndependent()
				&& this.point.isIndependent();
