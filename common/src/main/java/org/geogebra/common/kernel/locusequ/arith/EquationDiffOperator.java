...
/**
 * @author sergio Represents the subtraction of two expressions.
 */
public class EquationDiffOperator extends EquationBinaryOperator {
	 ...
	 *            second expression.
	 */
	public EquationDiffOperator(final EquationExpression expr1,
	 ...
	 * { T a, b;
	 * 
	 * a = this.getFirstExpression().translate(translator); b =
