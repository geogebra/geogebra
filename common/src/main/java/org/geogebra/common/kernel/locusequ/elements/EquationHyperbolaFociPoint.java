...
/**
 * @author sergio {@link EquationElement} for {@link AlgoHyperbolaFociPoint}
 */
public class EquationHyperbolaFociPoint extends EquationGenericConic {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationHyperbolaFociPoint(final GeoElement hyperbola,
	...
	protected void computeMatrix() {
		...
		EquationExpression a2 = pow(
				div(diff(dist(f1, ep), dist(f2, ep)),
						EquationNumericValue.from(2)),
				EquationNumericValue.from(2));
		EquationExpression c2 = div(dist2(f1, f2),
				EquationNumericValue.from(4));
