...
/**
 * @author sergio Represents the scope for a locus. It is basically a map from
 *         points an elements to their symbolic representation.
 */
public class EquationScope implements EquationScopeInterface {
	...
	public EquationList getRestrictionsFromAlgo(AlgoElement algo) {
		...
		if (algo instanceof RestrictionAlgoForLocusEquation) {
			return ((EquationRestriction) algo.buildEquationElementForGeo(null,
	...
	/**
	 * @param orig
	 *            The point that will be replaced
	 * @param target
	 *            The point that will replace orig.
	 */
	...
	/**
	 * @param orig
	 *            The element that will be replaced
	 * @param target
	 *            The element that will replace orig.
	 */
	...
	public EquationAuxiliarSymbolicPoint getNewAuxiliarPoint() {
		EquationAuxiliarSymbolicPoint p = new EquationAuxiliarSymbolicPoint(
				this.auxPointIndex);
