...
/**
 * @author sergio Represent expr1/expr2
 */
public class EquationDivOperator extends EquationBinaryOperator {
	 ...
	 *            of fraction
	 */
	public EquationDivOperator(final EquationExpression numerator,
			final EquationExpression denominator) {
	 ...
	 * { T num, denom; num = this.getNumerator().translate(translator); denom =
	 * this.getDenominator().translate(translator);
	 * 
