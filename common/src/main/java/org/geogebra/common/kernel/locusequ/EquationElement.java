...
public abstract class EquationElement implements EquationElementInterface {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationElement(final GeoElement element,
	...
	public EquationAuxiliarSymbolicPoint getNewIncidentPoint() {
		EquationAuxiliarSymbolicPoint np = this.getScope()
				.getNewAuxiliarPoint();
	...
	/**
	 * @param p
	 *            A {@link GeoPoint} in the element.
	 * @param scope2
	 *            The {@link EquationPointMap} where the {@link EquationPoint}
	 *            for p is.
	...
	/**
	 * Given a point p, this method retrieves all restriction of this element
	 * applied to it.
	 * 
	 * @param p
	 *            the point.
	...
	/**
	 * @param p
	 *            The {@link EquationPoint} to be in the element.
	 * @return A String containing the equation representing that p is in the
	 *         element.
	 */
