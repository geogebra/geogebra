...
/**
 * @author sergio EquationElement for {@link AlgoAngularBisectorPoints}
 */
public class EquationAngularBisectorPoints
		extends EquationGenericAngularBisector {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationAngularBisectorPoints(final GeoElement line,
			final EquationScope scope) {
		super(line, scope);

		AlgoAngularBisectorPoints algo = (AlgoAngularBisectorPoints) line
				.getParentAlgorithm();
