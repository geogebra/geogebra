...
import org.geogebra.common.kernel.locusequ.arith.EquationFirstCoordinateValue;
import org.geogebra.common.kernel.locusequ.arith.EquationNumericValue;
import org.geogebra.common.kernel.locusequ.arith.EquationSecondCoordinateValue;
import org.geogebra.common.kernel.locusequ.arith.EquationSymbolicValue;
import org.geogebra.common.kernel.locusequ.arith.EquationThirdCoordinateValue;

/**
 * @author sergio Represents a point.
 */
public abstract class EquationPoint {
	 ...
	 */
	public static EquationPoint fromCoordinates(final EquationExpression x,
			final EquationExpression y, final EquationExpression z) {
	 ...
	 */
	public boolean isIndependent() {
		return this.getXExpression().isNumericValue() && this.getYExpression()
				.isNumericValue() /*
