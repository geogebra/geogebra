...
/**
 * @author sergio Given an {@link EquationPoint} returns another one prepared
 *         for a vector.
 * 
 *         Given v = a - b, v = (a.x - b.x, a.y - b.y), vu = ((a.x - b.x)/|v|,
 *         (a.y - b.y)/|v|)
 */
public class EquationUnitaryPoint extends EquationPoint
	 ...
	 * 
	 * @param p
	 *            a {@link EquationPoint}
	 * @param mod
	 *            the {@link EquationExpression} for the module of the vector.
	 */
	public EquationUnitaryPoint(final EquationPoint p,
			final EquationExpression mod) {
		super();
		this.point = p;
		this.module = mod;
	}
	 ...
	 * 
	 * @see
	 * geogebra.kernel.locusequ.EquationPoint#getIndexesFrom(geogebra.kernel.
	 * locusequ.EquationPoint)
	 */
	@Override
