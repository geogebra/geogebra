...
/**
 * @author sergio EquationElement for AlgoCirclePointRadius
 */
public class EquationCirclePointRadius extends EquationGenericConic {
	 ...
	 *            {@link EquationScope}
	 */
	public EquationCirclePointRadius(final GeoElement el,
	...
	protected void computeMatrix() {
		AlgoCirclePointRadius algo = (AlgoCirclePointRadius) this.getResult()
				.getParentAlgorithm();
		...
		if (rGeo.isGeoNumeric()) {
			EquationExpression r = EquationNumericValue
					.from(((GeoNumeric) rGeo).getValue());
			r2 = sqr(r);
