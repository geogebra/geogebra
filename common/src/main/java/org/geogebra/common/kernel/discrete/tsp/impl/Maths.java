...
public final class Maths {
	...
	/**
	 * fast inverse square root. originally from quake 3:
	 * http://en.wikipedia.org/wiki/Fast_inverse_square_root
	 *
	 * works by making a clever guess as to the starting point for newton's
	 * method. 1 pass is a good approximation.
	 */
