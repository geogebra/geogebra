...
public class Ggb2giac {
	...
	public static Map<String, String> getMap(App app) {
		...
		String integralPart3 = "[constant := 1],"
				...
				+ "when(ggbintanssimplified==undef||length(\"\"+ggbintans)<=length(\"\"+ggbintanssimplified),when(regroup(ggbintans)==undef,integrate(REPLACEME0,REPLACEME1,REPLACEME2,REPLACEME3),regroup(ggbintans)),ggbintanssimplified)"
