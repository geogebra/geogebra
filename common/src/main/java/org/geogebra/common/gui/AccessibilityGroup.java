...
public enum AccessibilityGroup {
	MENU, GEOGEBRA_LOGO, SUBAPP_CHOOSER, SHARE, ASSIGN, SIGN_IN, AVATAR, ALGEBRA_CLOSE, UNDO, REDO,
	EV_CONTROLS, EV2_CONTROLS, EV3D_CONTROLS, PAGE_LIST_OPEN, NOTES_TOOLBAR_HEADER,
	NOTES_TOOL_SELECT, NOTES_TOOL_TOOLS, NOTES_TOOL_MEDIA, NOTES_COLOR_PANEL, NOTES_COLOR_CUSTOM,
	NOTES_PEN_THICKNESS_SLIDER, ALT_GEOTEXT, GEO_ELEMENT, ALGEBRA_ITEM;
