...
public class FormatSTL extends Format {
     ...
     * @param ny  normal y
     * @param nz  normal z
     * @param v1x first vertex x
     * @param v1y first vertex y
     * @param v1z first vertex z
     * @param v2x second vertex x
     * @param v2y second vertex y
     * @param v2z second vertex z
     * @param v3x third vertex x
     * @param v3y third vertex y
     * @param v3z third vertex z
     */
