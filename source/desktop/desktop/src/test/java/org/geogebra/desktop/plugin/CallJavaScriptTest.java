...
class CallJavaScriptTest {
	...
	void testAlert() {
		...
		((ScriptManagerD) app.getScriptManager())
				.evalJavaScript("alert(1);alert(undefined,2);ggbApplet.evalCommand('a=42')");
	...
	void testEval() {
		...
		assertEquals(
				"Access to Java class \"java.lang.Class\" is prohibited. " + "(Error at line:#1)",
				ex.getMessage());
	}
}
