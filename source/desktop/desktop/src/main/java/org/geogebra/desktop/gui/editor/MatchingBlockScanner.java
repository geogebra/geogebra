...
public final class MatchingBlockScanner {
	...
	private static final String ZZ_CMAP_PACKED =
			"\12\1\1\1\2\1\1\1\24\1\1\0\5\1\1\2\1\3\61\1" + "\1\2\1\1\1\3\35\1\1\2\1\1\1\3\uff82\1";
	...
	public MatchingPositions getMatchingBlock(int pos, boolean lr) {
		...
		try {
			if (lr) {
				...
				String str =
						new StringBuilder(doc.getText(end, start - end + 1)).reverse().toString();
	...
	public static final class MatchingPositions {
		public int firstB;
		public int firstE;
		public int secondB;
		public int secondE;
