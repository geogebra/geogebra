...
public class MyResourceBundle extends PropertyResourceBundle {
	 ...
	 */
	public static final ResourceBundle createBundle(String name, Locale locale) {
	...
	public static MyResourceBundle loadSingleBundleFile(String name) {
		ResourceBundle.Control control = ResourceBundle.Control.getControl(Control.FORMAT_PROPERTIES);
