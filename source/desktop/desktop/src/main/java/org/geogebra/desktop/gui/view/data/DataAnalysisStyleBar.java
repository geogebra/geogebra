...
public class DataAnalysisStyleBar extends JToolBar implements ActionListener, SetLabels {
	...
	private void createGUI() {
		...
		btnShowStatistics = new ToggleButtonD(
				app.getScaledIcon(GuiResourcesD.STYLINGBAR_VARIABLE_ANALYSIS_STATISTICS), iconHeight);
		...
		btnShowData = new ToggleButtonD(
				app.getScaledIcon(GuiResourcesD.STYLINGBAR_VARIABLE_ANALYSIS_DATA), iconHeight);
		...
		btnShowPlot2 = new ToggleButtonD(
				app.getScaledIcon(GuiResourcesD.STYLINGBAR_VARIABLE_ANALYSIS_2PLOT), iconHeight);
		btnShowPlot2.addActionListener(this);
		btnShowPlot2.setFocusPainted(false);
		btnShowPlot2.setFocusable(false);

		// create export button
		btnExport = new ToggleButtonD(app.getScaledIcon(GuiResourcesD.EXPORT16), iconHeight);
	...
	public void updateGUI() {
		...
		switch (model.getMode()) {
			case DataAnalysisModel.MODE_ONEVAR:
				if (daView.getDataSource() != null && daView.groupType() == GroupType.RAWDATA) {
	...
	private JPanel createDataSourcePanel() {
		...
		btnDataSource =
				new ToggleButtonD(app.getScaledIcon(GuiResourcesD.ARROW_CURSOR_GRABBING), iconHeight);
	...
	private void buildRoundingButton() {
		...
		btnRounding = new JButton(app.getScaledIcon(GuiResourcesD.TRIANGLE_DOWN));
	...
	public void setLabels() {
		...
		String swapString = loc.getMenu("Column.X") + " \u21C6 " + loc.getMenu("Column.Y");
