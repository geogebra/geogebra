 ...
 * CAS cell renderer
 */
public class CASTableCellRenderer extends CASTableCell implements TableCellRenderer {
	...
	public Component getTableCellRendererComponent(
		...
		if (value instanceof GeoCasCell) {
			...
			if (cell.isUseAsText()) {
				setFont(casFont.deriveFont(
						cell.getFontStyle(), (float) (casFont.getSize() * cell.getFontSizeMultiplier())));
