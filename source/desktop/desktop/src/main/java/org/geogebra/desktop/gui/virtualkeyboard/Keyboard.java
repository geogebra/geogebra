...
public class Keyboard {
	 ...
	 */
	public void type(
			boolean altPressed, boolean ctrlPressed, boolean shiftPressed, CharSequence characters) {
	 ...
	 */
	public void doType(
			boolean altPressed, boolean ctrlPressed, boolean shiftPressed, int... keyCodes) {
		if (altPressed) {
			robot.keyPress(KeyEvent.VK_ALT);
		}
		if (ctrlPressed) {
