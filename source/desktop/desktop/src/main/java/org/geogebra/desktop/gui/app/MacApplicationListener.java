...
public class MacApplicationListener
		implements QuitHandler, AboutHandler, OpenFilesHandler, SystemEventListener, PrintFilesHandler {
	...
	private static synchronized GeoGebraFrame getGGBInstance() {
		...
		while (wnd == null) {
			try {
				...
				Log.debug("MacApplicationListener.getGGBInstance(): " + e.getMessage());
				wnd = null;
			}
		}
		return wnd;
