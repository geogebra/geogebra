...
public class ViewTextFieldD extends ViewTextField {
	...
	private AutoCompleteTextFieldD newAutoCompleteTextField(int length, Drawable drawTextField) {
		return new AutoCompleteTextFieldD(length, euclidianView.getApplication(), drawTextField);
	}
