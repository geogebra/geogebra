...
public class HelpDialog {
	...
	public void openToolHelp(int mode) {
		...
		if (mode >= EuclidianConstants.MACRO_MODE_ID_OFFSET) {
			...
			Macro macro = app.getKernel().getMacro(mode - EuclidianConstants.MACRO_MODE_ID_OFFSET);
			...
			if (img == null || img.isSVG()) {
				...
				// use image as icon
				icon = new ImageIcon(ImageManagerD.addBorder(img.getImage(), border, null));
			}
		...
		Object[] options = {loc.getMenu("ShowOnlineHelp"), loc.getMenu("Cancel")};
