...
public class HelpOnKeywordPanel extends JPanel {
	...
	private HelpOnKeywordPanel() {
		...
		LookAndFeel.installColors(textarea, "ToolTip.background", "ToolTip.foreground");
	...
	private void init(AppD app, String command) {
		String help =
				app.getLocalization().getCommand(app.getReverseCommand(command) + Localization.syntaxStr);
