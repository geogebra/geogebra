...
public final class GeoGebraLexer extends Lexer implements GeoGebraLexerConstants {
	...
	public GeoGebraLexer(AppD app) {
		...
		Iterator<GeoElement> iter =
				app.getKernel().getConstruction().getGeoSetLabelOrder().iterator();
		while (iter.hasNext()) {
	 ...
	 */
	public GeoGebraLexer(java.io.InputStream in) throws UnsupportedEncodingException {
