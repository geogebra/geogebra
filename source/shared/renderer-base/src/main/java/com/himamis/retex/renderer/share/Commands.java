		...
		switch (s) {
			...
			case "Dstrok":
				return new Command0A() {
					...
					public Atom newI(TeXParser tp) {
						...
						return new RowAtom(
								vra, new RomanAtom(new CharAtom('D', TextStyle.MATHNORMAL), "\u0110"));
					}
				};
			case "dstrok":
				return new Command0A() {
			...
			case "Hstrok":
				return new Command0A() {
					...
					public Atom newI(TeXParser tp) {
						...
						vra.setRaise(Unit.EX, 0.55);
						return new RowAtom(
								vra, new RomanAtom(new CharAtom('H', TextStyle.MATHNORMAL), "\u0126"));
					}
				};
			case "hstrok":
				return new Command0A() {
			...
			case "smallfrowneq":
				return new Command0A() {
					@Override
					public Atom newI(TeXParser tp) {
						final Atom at = new UnderOverAtom(
