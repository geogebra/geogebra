...
public abstract class Arc2D extends RectangularShape implements GArc2D {
	 ...
	 * @since 1.2
	 */
	public void setArc(GRectangle2D rect, double angSt, double angExt, int closure) {
	...
	public void setArcByCenter(
		...
		setArc(x - radius, y - radius, radius * 2.0, radius * 2.0, angSt, angleExt, closure);
	}
	 ...
	 * @since 1.2
	 */
	public void setArcByTangent(GPoint2D p1, GPoint2D p2, GPoint2D p3, double radius) {
	 ...
	 * @since 1.2
	 */
	protected abstract GRectangle2D makeBounds(double x, double y, double w, double h);
	...
	public boolean contains(double x, double y) {
		...
		boolean inside = (Line2D.relativeCCW(x1, y1, x2, y2, 2 * normx, 2 * normy)
						* Line2D.relativeCCW(x1, y1, x2, y2, 0, 0)
				>= 0);
	...
	public boolean intersects(double x, double y, double w, double h) {
		 ...
		 * outside of rectangle with left top corner coordinates
