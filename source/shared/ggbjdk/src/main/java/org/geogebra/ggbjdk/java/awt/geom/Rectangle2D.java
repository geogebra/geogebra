...
public abstract class Rectangle2D extends RectangularShape implements GRectangle2D {
	 ...
	 * @since 1.2
	 */
	public static void intersect(GRectangle2D src1, GRectangle2D src2, GRectangle2D dest) {
	 ...
	 * @since 1.2
	 */
	public static void union(GRectangle2D src1, GRectangle2D src2, GRectangle2D dest) {
