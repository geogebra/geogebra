...
public class SamplerTest extends BaseUnitTest {
	...
	protected IntervalTupleList functionValues(
			String functionDescription, double xmin, double xmax, double ymin, double ymax) {
		return functionValues(functionDescription, xmin, xmax, ymin, ymax, DEFAULT_NUMBER_OF_SAMPLES);
	}
	...
	protected IntervalTupleList functionValues(
		...
		FunctionSampler sampler = PlotterUtils.newSampler(function, range, numberOfSamples, null);
