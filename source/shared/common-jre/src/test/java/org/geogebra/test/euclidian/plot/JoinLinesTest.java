...
public class JoinLinesTest {
	...
	public void toTopStraight() {
		...
		TupleNeighbours neighbours = new TupleNeighbours(
				...
				inverted(4.816197980612419, 4.83085778160562,
	...
	public void toBottomStraight() {
		...
		TupleNeighbours neighbours = new TupleNeighbours(
				...
				inverted(1.6799999999998059, 1.6999999999998059,
	...
	public void toBottomLeft() {
		...
		TupleNeighbours neighbours = new TupleNeighbours(
				...
				inverted(-0.010000000000410209, 0.009999999999589795,
	...
	public void toBottomRight() {
		...
		TupleNeighbours neighbours = new TupleNeighbours(
				...
				inverted(3.129999999999592, 3.1499999999995922,
	...
	public void noTopLineToSingletonInfinity() {
		...
		TupleNeighbours neighbours = new TupleNeighbours(
				...
				inverted(-1.9566986919627993e-13, 0.01999999999980433,
	...
	public void connectedSemiInfiniteRightNeighbourKeepsBottomBoundaryBehavior() {
		...
		neighbours.set(
				...
				new IntervalTuple(connected(0, 1), currentY),
				new IntervalTuple(connected(1, 2),
						connected(5, Double.POSITIVE_INFINITY)));
