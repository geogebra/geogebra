...
class SpreadsheetReferenceParsingTests {
	...
	void testParseCellReferences() {
		assertEquals(
				new SpreadsheetReference(new SpreadsheetCellReference(0, 0), null),
				SpreadsheetReferenceParsing.parseReference("A1"));
		assertEquals(
				new SpreadsheetReference(new SpreadsheetCellReference(0, false, 0, true), null),
				SpreadsheetReferenceParsing.parseReference("$A1"));
		assertEquals(
				new SpreadsheetReference(new SpreadsheetCellReference(0, true, 0, false), null),
				SpreadsheetReferenceParsing.parseReference("A$1"));
		assertEquals(
				new SpreadsheetReference(new SpreadsheetCellReference(0, true, 0, true), null),
				SpreadsheetReferenceParsing.parseReference("$A$1"));
		assertEquals(
				new SpreadsheetReference(new SpreadsheetCellReference(0, true, 0, true), null),
				SpreadsheetReferenceParsing.parseReference("ASDF $A$1"));
		assertEquals(
				new SpreadsheetReference(new SpreadsheetCellReference(1, 1), null),
				SpreadsheetReferenceParsing.parseReference("B2"));
		assertEquals(
				new SpreadsheetReference(
						new SpreadsheetCellReference(1, 26), new SpreadsheetCellReference(9, 26)),
