...
class CheckIfTrivialTest extends BaseSimplifyTestSetup {
	...
	void testReduceToIntegers(String definition, String expected) {
	...
	void testIgnoreZeros(String definition, String expected) {
		shouldSimplify(definition, expected);
	...
	void testShouldNotChange(String definition, String expected) {
		shouldSimplify(definition, expected);
	}
}
