...
class EditorScreenReaderTest {
	...
	void testReaderQuadratic() {
		checkReader(
				"1+x^2",
				"start of formula 1 plus x squared",
				"after 1 before plus",
				"after plus before x",
				"after x before superscript",
				"start of superscript before 2",
	...
	void testReaderPower() {
		checkReader(
				...
				"after x before superscript",
				"start of superscript before 3",
				"end of superscript after 3",
				"after x cubed before plus",
				"after plus before x",
				"after x before superscript",
				"start of superscript before 4",
	...
	void testSin() {
		checkReader(
				...
				"after s before in",
				"after si before n",
				"after sin before open parenthesis",
				"start of parentheses before x",
				"after x before plus",
				"after plus before 1",
	...
	void testMinusSin() {
		checkReader(
				...
				"after 3 before minus",
				"after minus before function",
				"before sin",
				"after s before in",
				"after si before n",
				"after sin before open parenthesis",
	...
	void testCbrt() {
		checkReader(
				...
				"start of cube root before x",
				"after x before plus",
				"after plus before 1",
				"end of cube root after 1",
	...
	void testNroot() {
		checkReader(
				"nroot(x,4)",
				"start of formula start 4th root x end root",
				"start of index before 4",
				"end of index after 4",
	...
	void testQuotes() {
		checkReader(
				...
				"start of quotes before a",
				"after a before open brace",
				"after open brace before b",
				"after b before close brace",
	...
	void testAbs() {
		checkReader(
				...
				"start of absolute value before x",
				"after x before plus",
				"after plus before 1",
				"end of absolute value after 1",
	...
	void testReaderSqrt() {
		checkReader(
				...
				"after plus before 2x",
				"after 2 before x",
				"after 2x before plus",
				"after plus before fraction",
				"start of numerator before 1",
				"end of numerator after 1",
				"start of denominator before x",
				"end of denominator after x",
				"after fraction before plus",
				"after plus before 33",
				"after 3 before 3",
				"end of square root after 33",
	...
	void testReaderSqrtPi() {
		checkReader(
				...
				"start of square root before pi",
				"end of square root after pi",
	...
	void testBrackets() {
		checkReader(
				...
				"after 2 before times",
				"after times before open parenthesis",
				"start of parentheses before 3",
				"after 3 before plus",
				"after plus before 4",
				"end of parentheses after 4",
				"after close parenthesis before minus",
	...
	void testBracketsIncomplete() {
		checkReader(
				...
				"after 3 before minus",
				"after minus before open parenthesis",
				"parentheses blank",
	...
	void testGreek() {
		checkReader(
				"2*pi*x",
				"start of formula 2 times pi times x",
				"after 2 before times",
				"after times before pi",
				"after p before i",
				"after pi before times",
				"after times before x",
				"end of formula 2 times pi times x");
	}
	...
	void testFunction() {
		checkReader(
				...
				"before f",
				"after f before open parenthesis",
				"start of parentheses before x",
				"end of parentheses after x");
	}
	...
	void testPoint() {
		checkReader(
				...
				"after B before =",
				"after = before open parenthesis",
				"start of coordinate before 1",
				"end of coordinate after 1");
	}
	...
	void testComma() {
		checkReader(
				...
				"before f",
				"after f before open parenthesis",
				"start of parentheses before 1",
				"after 1 before comma",
				"after comma before 2");
	}
	...
	void shouldNotRemoveCommasForPoints() throws ParseException {
		...
		SequenceNode argument = ((ArrayNode) mf.getRootNode().getChild(0)).getChild(0);
	...
	private static void checkReader(String input, String... output) {
		...
		for (String s : output) {
			String readerOutput = mfi.getEditorState().getDescription(er, null).replaceAll(" +", " ");
