...
class ClipRectTest {
	...
	void shouldExpandBoundsByPixelMarginScaledToWorldUnits() {
		EuclidianViewBounds bounds = newBounds(-14.900000000000029, 9.220000000000018,
				-24.190000000000026, 1.110000000000001,
				1206, 1265);
		...
		assertAll(
				() -> assertEquals(bounds.getXmin() - mx, clipRect.getXmin(),
						MAX_DOUBLE_PRECISION),
				() -> assertEquals(bounds.getXmax() + mx, clipRect.getXmax(),
						MAX_DOUBLE_PRECISION),
				() -> assertEquals(bounds.getYmin() - my, clipRect.getYmin(),
						MAX_DOUBLE_PRECISION),
				() -> assertEquals(bounds.getYmax() + my, clipRect.getYmax(),
						MAX_DOUBLE_PRECISION)
	...
	void testDependencyOfClipAndBoundsRectangle() {
		...
		assertAll(() -> assertEquals(clipRect.getXmin(), boundsRectangle.getXmin()),
