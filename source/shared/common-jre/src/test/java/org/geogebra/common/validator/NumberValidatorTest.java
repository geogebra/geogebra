...
class NumberValidatorTest extends BaseUnitTest {
	...
	void testExceptionThrowing() {
		assertThrows(NumberFormatException.class, () -> numberValidator.getDouble("a", null));

		assertThrows(NumberValueOutOfBoundsException.class, () -> numberValidator.getDouble("-1", 0.0));
	}

	@Test
	void testConversion() {
		assertEquals(-1.0, numberValidator.getDouble("-1", -2.0), DELTA);
	}
}
