...
public class ArithmeticTest extends BaseUnitTest {
	...
	public void testRounding() {
		...
		t("round(6.740340335894E10, 6.0)", "6.740340335894E10");
		t("round(6.740340335894E10, 7.0)", "6.740340335894E10");
		t("round(6.740340335894E10, 8.0)", "6.740340335894E10");
		t("round(6.740340335894E10, 9.0)", "6.740340335894E10");
		t("round(6.740340335894E10, 10.0)", "6.740340335894E10");
		t("round(6.740340335894E10, 0.0)", "6.740340335894E10");
		t("round(6.740340335894E10, 1.0)", "6.740340335894E10");
		t("round(6.740340335894E10, -1.0)", "6.740340335894E10");
	...
	public void shouldSwitchFunctionVariableName() {
		...
		assertEquals("x", g.getVarString(StringTemplate.testTemplate));
		add("SetValue(r,2)");
		assertEquals("t - 1", g.toValueString(StringTemplate.testTemplate));
		assertEquals("t", g.getVarString(StringTemplate.testTemplate));
	}
