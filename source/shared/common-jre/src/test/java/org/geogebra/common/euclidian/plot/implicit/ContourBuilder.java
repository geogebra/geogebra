...
public class ContourBuilder {
	 ...
	 * @return this builder for chaining
	 */
	public ContourBuilder withBounds(double xmin, double xmax, double ymin, double ymax, int width,
			int height) {
		return withBounds(
				BaseContourTestSetup.newBounds(xmin, xmax, ymin, ymax, width, height)
		);
	}
	...
	public ContourBuilder withDirectConvert() {
		polynomial =
				converter.bernsteinPolynomial2DFrom(geo, new BoundsRectangle(bounds, 10, 10));
		return this;
	}
