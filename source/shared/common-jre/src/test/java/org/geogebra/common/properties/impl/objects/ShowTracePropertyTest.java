...
class ShowTracePropertyTest extends BaseUnitTest {
	...
	@Test
	void testConstructorForNumeric() {
	...
	@Test
	void testConstructorForText() {
		GeoText text = addAvInput("\"\"");
		assertThrows(
				NotApplicablePropertyException.class, () -> new ShowTraceProperty(getLocalization(), text));
	}
}
