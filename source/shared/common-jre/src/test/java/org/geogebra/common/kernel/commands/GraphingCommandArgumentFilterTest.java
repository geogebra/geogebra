...
class GraphingCommandArgumentFilterTest extends BaseAppTestSetup {
	...
	@Test
	void testParallelLineWithPointAndLineIsFiltered() {
	...
	@Test
	void testParallelLineWithPointAndFunctionIsFiltered() {
	...
	@Test
	void testLineWithTwoPointsAllowed() {
		evaluateGeoElement("A = (1,2)");
