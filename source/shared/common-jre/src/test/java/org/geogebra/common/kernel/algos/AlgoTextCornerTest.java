...
class AlgoTextCornerTest extends BaseUnitTest {

	@Test
	void cornerInputBox() {
		add("ib=InputBox()");
		assertThat(
				add("Sequence(Corner(ib,k),k,1,4)"),
	...
	void cornerCheckbox() {
		add("cb=Checkbox()");
		assertThat(
				add("Sequence(Corner(cb,k),k,1,4)"),
