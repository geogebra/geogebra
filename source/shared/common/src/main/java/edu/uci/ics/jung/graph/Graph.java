...
/**
 * A graph consisting of a set of vertices of type <code>V</code> set and a set
 * of edges of type <code>E</code>. Edges of this graph type have exactly two
 * endpoints; whether these endpoints must be distinct depends on the
 * implementation.
 * <P>
 ...
 * <li>vertices and edges of different types (for example, bipartite or
 * multimodal graphs)
...
public interface Graph<V, E> extends Hypergraph<V, E> {
	 ...
	 * @return <code>true</code> if the add is successful, <code>false</code>
	 *         otherwise
	 ...
	 * legal for this graph, this method will throw
