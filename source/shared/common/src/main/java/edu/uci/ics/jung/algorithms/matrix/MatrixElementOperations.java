 ...
 * arithmetic); this is handled by computePathData().</li>
 * <li>Aggregating the properties of all such paths, and assigning the result to
 * a new edge in the output graph (analogous to element addition in matrix
 * arithmetic); this is handled by mergePaths().</li>
 * </ol>
 * <p>
...
public interface MatrixElementOperations<E> {
	 ...
	 * @return aggregation of data from the edges of the 2-edge path (from
	 *         source of e1 to destination of e2) comprised of (e1, e2)
	 */
