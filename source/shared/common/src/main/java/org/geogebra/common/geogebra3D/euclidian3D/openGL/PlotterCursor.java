...
public class PlotterCursor {
	...
	private static float size_start_move = 7f;
	private static float size_move = 40f;
	private static float thickness3 = 2 * thickness;

	private static float size_cube = size_start_move;

	private static float TARGET_DOT_ALPHA = 0.87f;

	private static float TARGET_CIRCLE_THICKNESS =
			EuclidianStyleConstants.DEFAULT_LINE_THICKNESS * PlotterBrush.LINE3D_THICKNESS / 2f;
	private static float TARGET_CIRCLE_RADIUS = 50f;
	private static float TARGET_CIRCLE_ALPHA = 0.38f;
	...
	private void tnv(float x, float y, float z, float nx1, float ny1, float nz1) {
		manager.texture(0, 0);
	...
	private void cursorCross3D() {
		...
		quadSymxOyRotOz90SymOz(
				thickness, t, t, -thickness, t, t, -thickness, t, size2, thickness, t, size2);

		quadSymxOyRotOz90SymOz(
				thickness, t, t, thickness, size2, t, -thickness, size2, t, -thickness, t, t);

		quadRotOz90SymOz(t, t, thickness, t, t, -thickness, t, size2, -thickness, t, size2, thickness);

		quadRotOz90SymOz(
				-t, t, thickness, -t, size2, thickness, -t, size2, -thickness, -t, t, -thickness);
		...
		quadSymxOyRotOz90SymOz(t, t, t, t, t, size2, t, thickness, size2, t, thickness, t);

		quadSymxOyRotOz90SymOz(thickness, t, t, thickness, t, size2, t, t, size2, t, t, t);

		quadSymxOyRotOz90SymOz(t, t, t, t, t, thickness, t, size2, thickness, t, size2, t);

		quadSymxOyRotOz90SymOz(thickness, t, t, t, t, t, t, size2, t, thickness, size2, t);

		quadSymxOyRotOz90SymOz(-t, t, t, -t, size2, t, -t, size2, thickness, -t, t, thickness);

		quadSymxOyRotOz90SymOz(-thickness, t, t, -thickness, size2, t, -t, size2, t, -t, t, t);

		quadSymxOyRotOz90SymOz(
				t, size2, t, t, size2 + t - thickness, t, -t, size2 + t - thickness, t, -t, size2, t);
		...
		quadRotOz90SymOz(
				t, size2, t, t, size2, -t, t, size2 + t - thickness, -t, t, size2 + t - thickness, t);
		...
		quadSymxOyRotOz90SymOz(
				t, t, size2, t, t, size2 + t - thickness, t, -t, size2 + t - thickness, t, -t, size2);
	...
	private void cursorCylinder() {
		...
		for (int i = 1; i <= latitude; i++) {
			...
			quadSymOz(
					x2, y0 * r2, z0 * r2, x1, y0 * r1, z0 * r1, x1, y1 * r1, z1 * r1, x2, y1 * r2, z1 * r2);
		}
	}
	...
	private void quadSymxOyRotOz90SymOz(
			float x1,
			float y1,
			float z1,
			float x2,
