...
public class KernelCAS {
	 ...
	 */
	public static GeoLine tangent(Construction cons, String label, GeoPointND P, GeoFunctionable f) {
	 ...
	 */
	public static GeoLine tangent(
			Construction cons, String label, GeoPointND P, GeoCurveCartesian f) {
