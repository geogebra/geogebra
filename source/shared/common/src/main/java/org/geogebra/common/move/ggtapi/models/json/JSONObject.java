 ...
 * <li><a id="lossy">When the requested type is a long, other {@link Number}
 ...
 * coerced, the sentinel value {@link JSONObject#NULL} is coerced to the string
 * "null".
 * </ul>
 *
 * <p>
 ...
 * {@link JSONObject#NULL}. In particular, calling {@code put(name, null)}
 * removes the named entry from the object but
 * {@code put(name, JSONObject.NULL)} stores an entry whose value is
...
public class JSONObject {
	 ...
	 *            Integer, Long, Double, {@link #NULL}, or {@code null}. May not
	 *            be {@link Double#isNaN() NaNs} or {@link Double#isInfinite()
	 *            infinities}.
	 * @return this object.
	 */
	 ...
	 * @param name
	 *            key
	 * @return whether corresponding value is one of null, NULL
	 */
	 ...
	 * @param name
	 *            key
	 * @return whether corresponding object is null
	 */
	 ...
	 * @param name
	 *            key
	 * @return object value for given key
	 *
	 * @throws JSONException
	 ...
	 * @param name
	 *            key
	 * @return boolean value for given key or null
	 */
	 ...
	 * @param fallback
	 *            fallback
	 * @return boolean for given key or fallback
	 */
	 ...
	 * @param name
	 *            key
	 * @return double value for given key
	 *
	 * @throws JSONException
	 *             if the mapping doesn't exist or cannot be coerced to a
	 *             double.
	 ...
	 *            key
	 *
	 * @return number value for given key or NaN
	 */
	 ...
	 *            fallback
	 *
	 * @return number value for given key or fallback
	 */
	 ...
	 * @param fallback
	 *            fallback
	 * @return int value for given key or fallback
	 */
	 ...
	 * @param name
	 *            key
	 * @return long value for given key or 0
	 */
	 ...
	 * @param fallback
	 *            fallback
	 * @return long value for given key or fallback
	 */
	 ...
	 * @param name
	 *            key
	 * @return string value for given key or null
	 */
	 ...
	 * @param fallback
	 *            fallback
	 * @return string value for given key or fallback
	 */
	 ...
	 * @param name
	 *            key
	 * @return array value for given key
	 *
	 * @throws JSONException
	 *             if the mapping doesn't exist or is not a {@code
	 *     JSONArray}.
	 */
	 ...
	 * @param name
	 *            key
	 * @return object value for given key or null
	 */
	 ...
	 * @param names
	 *            keys
	 * @return array of values for given keys
	 */
	 ...
	 *            string.
	 * @return escaped string in quotes
	 */
	 ...
	 * {@code JSONArray} or {@code JSONObject}, no wrapping is necessary. If the
	 * object is {@code NULL}, no wrapping is necessary. If the object is an
	 * array or {@code Collection}, returns an equivalent {@code JSONArray}. If
	 * the object is a {@code Map}, returns an equivalent {@code JSONObject}. If
	 * the object is a primitive wrapper type or {@code String}, returns the
	 * object. Otherwise if the object is from a {@code java} package, returns
	...
	public boolean equals(Object obj) {
		return obj instanceof JSONObject && nameValuePairs.equals(((JSONObject) obj).nameValuePairs);
	}
}
