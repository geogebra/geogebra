...
public class GeometryToolCollectionFactory extends AbstractToolCollectionFactory {
	...
	private void createStandardLevel(ToolCollectionImpl impl) {
		...
		impl.extendCategory(
				ToolCategory.MEDIA, EuclidianConstants.MODE_IMAGE, EuclidianConstants.MODE_TEXT);
	}
	...
	private void createAdvancedLevel(ToolCollectionImpl impl) {
		...
		impl.extendCategory(ToolCategory.CONSTRUCT, EuclidianConstants.MODE_LOCUS);

		impl.extendCategory(
				ToolCategory.MEASURE, EuclidianConstants.MODE_SLIDER, EuclidianConstants.MODE_SLOPE);
		...
		impl.extendCategory(ToolCategory.TRANSFORM, EuclidianConstants.MODE_MIRROR_AT_CIRCLE);
