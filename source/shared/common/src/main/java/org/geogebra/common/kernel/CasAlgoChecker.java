...
public class CasAlgoChecker implements Inspecting {
	...
	public boolean check(ExpressionValue v) {
		...
		if (v.isOperation(Operation.EQUAL_BOOLEAN) || v.isOperation(Operation.NOT_EQUAL)) {
	...
	public boolean isAlgoUsingCas(AlgoElement algo) {
		return algo instanceof UsesCAS
				|| algo instanceof AlgoCasCellInterface
				|| (algo instanceof DependentAlgo && hasExpressionWithCasOperations((DependentAlgo) algo))
