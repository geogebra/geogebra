...
public class SuiteToolCollectionFactory extends AbstractToolCollectionFactory {
	...
	private void createAdvancedLevel(ToolCollectionImpl impl) {
		...
		impl.extendCategory(ToolCategory.EDIT, EuclidianConstants.MODE_COPY_VISUAL_STYLE);

		impl.extendCategory(ToolCategory.MEDIA);

		impl.extendCategory(
				ToolCategory.MEASURE, EuclidianConstants.MODE_ANGLE_FIXED, EuclidianConstants.MODE_SLOPE);
