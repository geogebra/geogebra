...
public final class ColorMask {
	 ...
	 */
	public static boolean getRed(final int colorMask) {
		switch (colorMask) {
			case NONE:
			case ALPHA:
			case BLUE:
	 ...
	 */
	public static boolean getGreen(final int colorMask) {
		switch (colorMask) {
			case NONE:
			case ALPHA:
			case RED:
	 ...
	 */
	public static boolean getBlue(final int colorMask) {
		switch (colorMask) {
			case NONE:
			case ALPHA:
			case RED:
	 ...
	 */
	public static boolean getAlpha(final int colorMask) {
