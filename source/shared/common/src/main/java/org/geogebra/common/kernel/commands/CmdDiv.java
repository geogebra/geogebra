		...
		switch (n) {
			case 2:
				...
				if ((ok[0] = arg[0] instanceof GeoNumberValue)
					...
					AlgoDiv algo =
							new AlgoDiv(cons, c.getLabel(), (GeoNumberValue) arg[0], (GeoNumberValue) arg[1]);

					GeoElement[] ret = {algo.getResult()};
					return ret;
				} else if ((ok[0] = arg[0].isGeoFunction()) && (ok[1] = arg[1].isGeoFunction())) {

					AlgoPolynomialDiv algo =
							new AlgoPolynomialDiv(cons, c.getLabel(), (GeoFunction) arg[0], (GeoFunction) arg[1]);
