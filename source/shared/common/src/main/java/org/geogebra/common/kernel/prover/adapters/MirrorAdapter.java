...
public class MirrorAdapter extends ProverAdapter {
	...
	public PPolynomial[] getBotanaPolynomials(
			GeoElementND geo,
			GeoElement inGeo,
			GeoLineND mirrorLine,
			GeoPointND mirrorPoint,
			GeoConicND mirrorCircle)
		...
		if (mirrorLine instanceof GeoLine) {
			...
			if (inGeo.isGeoLine()) {
				...
				PVariable[] mirrorLineVars = ((GeoLine) mirrorLine).getBotanaVars(mirrorLine);
				...
				if (inGeoVars != null && mirrorLineVars != null) {
					...
					// PV1 = V1P'
					botanaPolynomials[0] = v1_1.multiply(new PPolynomial(2)).subtract(p1).subtract(p_1);
					botanaPolynomials[1] = v1_2.multiply(new PPolynomial(2)).subtract(p2).subtract(p_2);
					...
					// A, V1, B collinear
					botanaPolynomials[2] =
							PPolynomial.collinear(A[0], A[1], botanaVars[4], botanaVars[5], B[0], B[1]);

					// PV1 orthogonal AB
					botanaPolynomials[3] = PPolynomial.perpendicular(
							inGeoVars[0], inGeoVars[1], botanaVars[4], botanaVars[5], A[0], A[1], B[0], B[1]);
					...
					// QV2 = V2Q'
					botanaPolynomials[4] = v2_1.multiply(new PPolynomial(2)).subtract(q1).subtract(q_1);
					botanaPolynomials[5] = v2_2.multiply(new PPolynomial(2)).subtract(q2).subtract(q_2);

					// A, V2, B collinear
					botanaPolynomials[6] =
							PPolynomial.collinear(A[0], A[1], botanaVars[6], botanaVars[7], B[0], B[1]);

					// QV2 orthogonal AB
					botanaPolynomials[7] = PPolynomial.perpendicular(
							inGeoVars[2], inGeoVars[3], botanaVars[6], botanaVars[7], A[0], A[1], B[0], B[1]);
			...
			// we want to mirror a point to a line
				...
				// CV = VC'
				botanaPolynomials[0] = v1.multiply(new PPolynomial(2)).subtract(c_1).subtract(c1);
				botanaPolynomials[1] = v2.multiply(new PPolynomial(2)).subtract(c_2).subtract(c2);
				...
				// A,V,B collinear
				botanaPolynomials[2] =
						PPolynomial.collinear(A[0], A[1], B[0], B[1], botanaVars[2], botanaVars[3]);
				...
				// C',N,V collinear
				botanaPolynomials[5] = PPolynomial.collinear(
						botanaVars[0],
						botanaVars[1],
						botanaVars[2],
						botanaVars[3],
			...
			// mirror circle to line
				...
				// AV = VA'
				botanaPolynomials[0] = v1.multiply(new PPolynomial(2)).subtract(a_1).subtract(a1);
				botanaPolynomials[1] = v2.multiply(new PPolynomial(2)).subtract(a_2).subtract(a2);

				// C, V, D collinear
				botanaPolynomials[2] =
						PPolynomial.collinear(vl[0], vl[1], botanaVars[4], botanaVars[5], vl[2], vl[3]);
				...
				// AV orthogonal CD
				botanaPolynomials[3] = d1.subtract(c1).add(a2).subtract(n1_2);
				botanaPolynomials[4] = a1.subtract(d2).add(c2).subtract(n1_1);
				...
				// BT = TB'
				botanaPolynomials[6] = t1.multiply(new PPolynomial(2)).subtract(b_1).subtract(b1);
				botanaPolynomials[7] = t2.multiply(new PPolynomial(2)).subtract(b_2).subtract(b2);

				// C, T, D collinear
				botanaPolynomials[8] =
						PPolynomial.collinear(vl[0], vl[1], botanaVars[6], botanaVars[7], vl[2], vl[3]);

				PPolynomial n2_1 = new PPolynomial(botanaVars[10]);
				PPolynomial n2_2 = new PPolynomial(botanaVars[11]);

				// BT orthogonal CD
				botanaPolynomials[9] = d1.subtract(c1).add(b2).subtract(n2_2);
				botanaPolynomials[10] = b1.subtract(d2).add(c2).subtract(n2_1);

				// B', T, N2 collinear
				botanaPolynomials[11] = PPolynomial.collinear(
						botanaVars[1],
						botanaVars[2],
						botanaVars[6],
						botanaVars[7],
			...
			// mirror parabola about line
				...
				// AV1 = V1A'
				botanaPolynomials[0] = new PPolynomial(2).multiply(v1_1).subtract(a1).subtract(a_1);
				botanaPolynomials[1] = new PPolynomial(2).multiply(v1_2).subtract(a2).subtract(a_2);

				// A', V1, N1 collinear
				botanaPolynomials[2] = PPolynomial.collinear(
						botanaVars[4],
						botanaVars[5],
						botanaVars[10],
						botanaVars[11],
				...
				// M1, V1, M2 collinear
				botanaPolynomials[3] =
						PPolynomial.collinear(vl[0], vl[1], botanaVars[10], botanaVars[11], vl[2], vl[3]);

				// AN1 orthogonal M1M2
				botanaPolynomials[4] = m2_1.subtract(m1_1).add(a2).subtract(n1_2);
				botanaPolynomials[5] = a1.subtract(m2_2).add(m1_2).subtract(n1_1);
				...
				// BV2 = V2B'
				botanaPolynomials[6] = new PPolynomial(2).multiply(v2_1).subtract(b1).subtract(b_1);
				botanaPolynomials[7] = new PPolynomial(2).multiply(v2_2).subtract(b2).subtract(b_2);

				// B', V2, N2 collinear
				botanaPolynomials[8] = PPolynomial.collinear(
						botanaVars[6],
						botanaVars[7],
						botanaVars[12],
						botanaVars[13],
				...
				// M1, V2, M2 collinear
				botanaPolynomials[9] =
						PPolynomial.collinear(vl[0], vl[1], botanaVars[12], botanaVars[13], vl[2], vl[3]);

				// BN2 orthogonal M1M2
				botanaPolynomials[10] = m2_1.subtract(m1_1).add(b2).subtract(n2_2);
				botanaPolynomials[11] = b1.subtract(m2_2).add(m1_2).subtract(n2_1);
				...
				// FV3 = V3F'
				botanaPolynomials[12] = new PPolynomial(2).multiply(v3_1).subtract(f1).subtract(f_1);
				botanaPolynomials[13] = new PPolynomial(2).multiply(v3_2).subtract(f2).subtract(f_2);

				// F', V3, N3 collinear
				botanaPolynomials[14] = PPolynomial.collinear(
						botanaVars[8],
						botanaVars[9],
						botanaVars[14],
						botanaVars[15],
				...
				// M1, V3, M2 collinear
				botanaPolynomials[15] =
						PPolynomial.collinear(vl[0], vl[1], botanaVars[14], botanaVars[15], vl[2], vl[3]);

				// FN3 orthogonal M1M2
				botanaPolynomials[16] = m2_1.subtract(m1_1).add(f2).subtract(n3_2);
				botanaPolynomials[17] = f1.subtract(m2_2).add(m1_2).subtract(n3_1);
				...
				// A', T', B' collinear
				botanaPolynomials[19] = PPolynomial.collinear(
						botanaVars[4],
						botanaVars[5],
						botanaVars[2],
						botanaVars[3],
		...
		// case mirroring GeoElement about point
			...
			if (inGeo.isGeoPoint()) {
				...
				// AB vector = BA' vector
				botanaPolynomials[0] = b1.multiply(new PPolynomial(2)).subtract(a1).subtract(a_1);
				botanaPolynomials[1] = b2.multiply(new PPolynomial(2)).subtract(a2).subtract(a_2);
			...
			// mirror line about point
				...
				// AP vector = PA' vector
				botanaPolynomials[0] = p1.subtract(a1).subtract(a_1.subtract(p1));
				botanaPolynomials[1] = p2.subtract(a2).subtract(a_2.subtract(p2));

				// BP vector = PB' vector
				botanaPolynomials[2] = p1.subtract(b1).subtract(b_1.subtract(p1));
				botanaPolynomials[3] = p2.subtract(b2).subtract(b_2.subtract(p2));
			...
			// mirror parabola about point
				...
				// PM vector = MP' vector
				botanaPolynomials[0] = new PPolynomial(2).multiply(m1).subtract(p1).subtract(p_1);
				botanaPolynomials[1] = new PPolynomial(2).multiply(m2).subtract(p2).subtract(p_2);

				// TM vector = MT' vector
				botanaPolynomials[2] = new PPolynomial(2).multiply(m1).subtract(t1).subtract(t_1);
				botanaPolynomials[3] = new PPolynomial(2).multiply(m2).subtract(t2).subtract(t_2);

				// AM vector = MA' vector
				botanaPolynomials[4] = new PPolynomial(2).multiply(m1).subtract(a1).subtract(a_1);
				botanaPolynomials[5] = new PPolynomial(2).multiply(m2).subtract(a2).subtract(a_2);

				// BM vector = MB' vector
				botanaPolynomials[6] = new PPolynomial(2).multiply(m1).subtract(b1).subtract(b_1);
				botanaPolynomials[7] = new PPolynomial(2).multiply(m2).subtract(b2).subtract(b_2);

				// FM vector = MF' vector
				botanaPolynomials[8] = new PPolynomial(2).multiply(m1).subtract(f1).subtract(f_1);
				botanaPolynomials[9] = new PPolynomial(2).multiply(m2).subtract(f2).subtract(f_2);
			...
			// mirror ellipse about point
				...
				if (vellipse[6] == vellipse[8] && vellipse[7] == vellipse[9]) {
					...
					// AP vector = PA' vector
					botanaPolynomials[0] = new PPolynomial(2).multiply(p1).subtract(a1).subtract(a_1);
					botanaPolynomials[1] = new PPolynomial(2).multiply(p2).subtract(a2).subtract(a_2);

					// CP vector = PC' vector
					botanaPolynomials[2] = new PPolynomial(2).multiply(p1).subtract(c1).subtract(c_1);
					botanaPolynomials[3] = new PPolynomial(2).multiply(p2).subtract(c2).subtract(c_2);
					...
					// AM vector = MA' vector
					botanaPolynomials[2] = new PPolynomial(2).multiply(m1).subtract(a1).subtract(a_1);
					botanaPolynomials[3] = new PPolynomial(2).multiply(m2).subtract(a2).subtract(a_2);

					// BM vector = MB' vector
					botanaPolynomials[4] = new PPolynomial(2).multiply(m1).subtract(b1).subtract(b_1);
					botanaPolynomials[5] = new PPolynomial(2).multiply(m2).subtract(b2).subtract(b_2);

					// CM vector = MC' vector
					botanaPolynomials[6] = new PPolynomial(2).multiply(m1).subtract(c1).subtract(c_1);
					botanaPolynomials[7] = new PPolynomial(2).multiply(m2).subtract(c2).subtract(c_2);
					...
					botanaPolynomials[9] = PPolynomial.sqrDistance(
									botanaVars[6], botanaVars[7], botanaVars[8], botanaVars[9])
							.subtract(d1.multiply(d1));

					// d2^2=Polynomial.sqrDistance(b_1,b_2,c_1,c_2)
					botanaPolynomials[10] = PPolynomial.sqrDistance(
									botanaVars[6], botanaVars[7], botanaVars[8], botanaVars[9])
							.subtract(d2.multiply(d2));

					// e1^2=Polynomial.sqrDistance(a_1,a_2,p_1,p_2)
					botanaPolynomials[11] = PPolynomial.sqrDistance(
									botanaVars[6], botanaVars[7], botanaVars[0], botanaVars[1])
							.subtract(e1.multiply(e1));

					// e2^2=Polynomial.sqrDistance(b_1,b_2,p_1,p_2)
					botanaPolynomials[12] = PPolynomial.sqrDistance(
									botanaVars[8], botanaVars[9], botanaVars[0], botanaVars[1])
			...
			// mirror hyperbola about point
				...
				// d1^2=Polynomial.sqrDistance(a_1,a_2,c_1,c_2)
				botanaPolynomials[9] = PPolynomial.sqrDistance(
								botanaVars[6], botanaVars[7], botanaVars[10], botanaVars[11])
						.subtract(d1.multiply(d1));

				// d2^2=Polynomial.sqrDistance(b_1,b_2,c_1,c_2)
				botanaPolynomials[10] = PPolynomial.sqrDistance(
								botanaVars[8], botanaVars[9], botanaVars[10], botanaVars[11])
						.subtract(d2.multiply(d2));

				// e1^2=Polynomial.sqrDistance(a_1,a_2,p_1,p_2)
				botanaPolynomials[3] = PPolynomial.sqrDistance(
								botanaVars[6], botanaVars[7], botanaVars[0], botanaVars[1])
						.subtract(e1.multiply(e1));

				// e2^2=Polynomial.sqrDistance(b_1,b_2,p_1,p_2)
				botanaPolynomials[4] = PPolynomial.sqrDistance(
								botanaVars[8], botanaVars[9], botanaVars[0], botanaVars[1])
						.subtract(e2.multiply(e2));
			...
			if (inGeo.isGeoPoint()) {
				...
				botanaPolynomials[0] =
						oa.multiply(b1.subtract(o1)).add(o1.subtract(b_1).multiply(denominator));

				botanaPolynomials[1] =
						oa.multiply(b2.subtract(o2)).add(o2.subtract(b_2).multiply(denominator));
			...
			// mirror circle about circle
				...
				PVariable[] vcircle = circle.getBotanaVars(circle);
				PVariable[] vmirrorcircle = mirrorcircle.getBotanaVars(mirrorcircle);
				...
				PPolynomial oc = c1.subtract(o1)
						.multiply(c1.subtract(o1))
						.add(c2.subtract(o2).multiply(c2.subtract(o2)));

				// a^2 - circle power of (A,B) circle
				PPolynomial ab = b1.subtract(a1)
						.multiply(b1.subtract(a1))
				...
				// from: http://mathworld.wolfram.com/Inversion.html
				botanaPolynomials[0] =
						oc.multiply(a1.subtract(o1)).add(o1.subtract(a_1).multiply(denominator1));
				botanaPolynomials[1] =
						oc.multiply(a2.subtract(o2)).add(o2.subtract(a_2).multiply(denominator1));
				...
				// from: http://mathworld.wolfram.com/Inversion.html
				botanaPolynomials[2] =
						oc.multiply(b1.subtract(o1)).add(o1.subtract(b_1).multiply(denominator2));
				botanaPolynomials[3] =
						oc.multiply(b2.subtract(o2)).add(o2.subtract(b_2).multiply(denominator2));
