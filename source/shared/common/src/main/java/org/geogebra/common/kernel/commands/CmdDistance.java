		...
		switch (n) {
			case 2:
				...
				if ((ok[0] = arg[0].isGeoPoint()) && (ok[1] = arg[1].isGeoPoint())) {
					GeoElement[] ret = {
						getAlgoDispatcher().distance(c.getLabel(), (GeoPointND) arg[0], (GeoPointND) arg[1])
					};
					return ret;
				}
				...
				// distance between point and line
					...
					GeoElement[] ret = {
						getAlgoDispatcher().distance(c.getLabel(), (GeoPointND) arg[0], arg[1])
					};
					return ret;
				}
				...
				// distance between line and point
					...
					GeoElement[] ret = {
						getAlgoDispatcher().distance(c.getLabel(), (GeoPointND) arg[1], arg[0])
					};
					return ret;
				}
				...
				// distance between line and line
					...
					GeoElement[] ret = {
						getAlgoDispatcher().distance(c.getLabel(), (GeoLine) arg[0], (GeoLine) arg[1])
					};
					return ret;
				}
