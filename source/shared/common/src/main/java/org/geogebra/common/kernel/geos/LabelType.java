...
public class LabelType {
	 ...
	 */
	static final char[] functionLabels = {'f', 'g', 'h', 'p', 'q', 'r', 's', 't'};

	/**
	 * Labels for lines
	 */
	static final char[] lineLabels = {
		'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'p', 'q', 'r', 's', 't', 'a', 'b', 'c', 'd', 'e'
	};

	/**
	 * Labels for vectors
	 */
	static final char[] vectorLabels = {
		'u', 'v', 'w', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'p', 'q',
		'r', 's', 't'
	};
	 ...
	 * Labels for conics
	 */
	static final char[] conicLabels = {'c', 'd', 'e', 'f', 'g', 'h', 'k', 'p', 'q', 'r', 's', 't'};

	/**
	 * All lowercase labels
	 */
	static final char[] lowerCaseLabels = {
		'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's',
		't', 'u', 'v', 'w'
	};
	 ...
	 */
	static final char[] integerLabels = {
		'n', 'i', 'j', 'k', 'l', 'm',
	};
