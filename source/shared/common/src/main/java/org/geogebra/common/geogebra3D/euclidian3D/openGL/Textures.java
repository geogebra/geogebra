...
public class Textures {
	...
	public void init() {
		...
		renderer.getRendererImpl().genTextures2D(TEXTURES_NUMBER, texturesIndex);
	...
	public void setDashFromLineType(int lineType) {
		renderer.getRendererImpl().setDashTexture(getDashFromLineType(lineType));
	}
	 ...
	 */
	public static int getDashFromLineType(int lineType) {
		switch (lineType) {
	...
	public void setDashFromLineTypeHidden(int lineType) {
		renderer.getRendererImpl().setDashTexture(getDashFromLineTypeHidden(lineType));
	}
	 ...
	 */
	public static int getDashFromLineTypeHidden(int lineType) {
		switch (lineType) {
			case EuclidianStyleConstants.LINE_TYPE_FULL:
	 ...
	 * @return dash id
	 */
	public static int getDashIdFromLineType(int lineType, int lineTypeHidden) {
	...
	private static int getDashIdFromLineType(int lineType) {
		switch (lineType) {
			case EuclidianStyleConstants.LINE_TYPE_FULL:
			default:
				return DASH_ID_FULL;
