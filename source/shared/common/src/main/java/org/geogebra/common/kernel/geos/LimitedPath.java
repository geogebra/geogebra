...
public interface LimitedPath extends Path {
	 ...
	 */
	void setAllowOutlyingIntersections(boolean flag);
	 ...
	 */
	void setKeepTypeOnGeometricTransform(boolean flag);
	 ...
	 */
	GeoElement[] createTransformedObject(Transform t, String label);
