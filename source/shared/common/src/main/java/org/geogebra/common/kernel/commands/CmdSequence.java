		...
		switch (n) {
			case 1:
				if (arg[0] instanceof GeoNumberValue) {
					...
					AlgoSequenceRange algo = new AlgoSequenceRange(cons, (GeoNumberValue) arg[0]);
			...
			case 2:
				if ((ok[0] = arg[0] instanceof GeoNumberValue)
					...
					AlgoSequenceRange algo =
							new AlgoSequenceRange(cons, (GeoNumberValue) arg[0], (GeoNumberValue) arg[1], null);
					algo.getOutput(0).setLabel(c.getLabel());
					return algo.getOutput();
				}
			...
			case 3:
				if ((ok[0] = arg[0] instanceof GeoNumberValue)
					...
					AlgoSequenceRange algo = new AlgoSequenceRange(
			...
			case 4:
				if ((ok[0] = arg[0].isGeoElement())
					...
					AlgoSequence algo = new AlgoSequence(
							cons,
							c.getLabel(),
							arg[0],
							(GeoNumeric) arg[1],
