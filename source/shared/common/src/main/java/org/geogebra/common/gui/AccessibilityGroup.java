...
public enum AccessibilityGroup {
	...
	UNDO, REDO, PROBABILITY, PROBABILITY_OVERLAY, PROBABILITY_TABLE,
	ALGEBRA_CLOSE, UNDO_GRAPHICS, REDO_GRAPHICS,
	UNDO_SCI_CALC, REDO_SCI_CALC, SETTINGS,
	...
	EV_CONTROLS, EV2_CONTROLS, EV3D_CONTROLS, PAGE_LIST_OPEN, SPREADSHEET,
