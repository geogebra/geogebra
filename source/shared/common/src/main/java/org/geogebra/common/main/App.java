...
public abstract class App implements UpdateSelection, AppInterface, EuclidianHost,
	...
	/** These two filter unwanted info, such as equations generated by tools, from the output. */
	private ToStringConverter<GeoElement> labelDescriptionConverter;
	private ToStringConverter<GeoElement> valueConverter;
	/**
	...
	/**
	 * The label description converter can be used to filter unwanted information from a
	 * {@link GeoElement}s label description, such as equations generated by tools.
	 *
	 * @return A `ToStringConverter` for use in {@link GeoElement#getLabelDescription()}.
	...
	public ToStringConverter<GeoElement> getLabelDescriptionConverter() {
		if (labelDescriptionConverter == null) {
			if (getConfig().shouldHideEquations()) {
				labelDescriptionConverter = new ProtectiveLabelDescriptionConverter();
			} else {
				labelDescriptionConverter = new DefaultLabelDescriptionConverter();
			}
		}
		return labelDescriptionConverter;
	}
