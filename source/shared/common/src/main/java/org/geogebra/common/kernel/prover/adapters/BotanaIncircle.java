	...
	public PPolynomial[] getPolynomials(GeoElement[] input) throws NoSymbolicParametersException {
		...
		if (input[0] != null && input[1] != null && input[2] != null) {
			...
			botanaPolynomials[0] = PPolynomial.equidistant(
					botanaVars[2], botanaVars[3], botanaVars[0], botanaVars[1], botanaVars[4], botanaVars[5]);
			// IFb=IFc
			botanaPolynomials[1] = PPolynomial.equidistant(
					botanaVars[4], botanaVars[5], botanaVars[0], botanaVars[1], botanaVars[6], botanaVars[7]);
			// A,Fb,C are collinear
			botanaPolynomials[2] =
					PPolynomial.collinear(vA[0], vA[1], botanaVars[4], botanaVars[5], vC[0], vC[1]);
			// A,Fc,B are collinear
			botanaPolynomials[3] =
					PPolynomial.collinear(vA[0], vA[1], botanaVars[6], botanaVars[7], vB[0], vB[1]);
			// B,Fa,C are collinear
			botanaPolynomials[4] =
					PPolynomial.collinear(vB[0], vB[1], botanaVars[2], botanaVars[3], vC[0], vC[1]);
			// AC is perpendicular to IFb
			botanaPolynomials[5] = PPolynomial.perpendicular(
					vA[0], vA[1], vC[0], vC[1], botanaVars[0], botanaVars[1], botanaVars[4], botanaVars[5]);
			// AB is perpendicular to IFc
			botanaPolynomials[6] = PPolynomial.perpendicular(
					vA[0], vA[1], vB[0], vB[1], botanaVars[0], botanaVars[1], botanaVars[6], botanaVars[7]);
			// BC is perpendicular to IFa
			botanaPolynomials[7] = PPolynomial.perpendicular(
					vB[0], vB[1], vC[0], vC[1], botanaVars[0], botanaVars[1], botanaVars[2], botanaVars[3]);
			return botanaPolynomials;
		}
