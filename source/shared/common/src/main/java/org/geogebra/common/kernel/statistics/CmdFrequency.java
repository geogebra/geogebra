...
public class CmdFrequency extends CommandProcessor {
		...
		switch (n) {
			...
			case 2:
				...
				// arg[0] = class list, arg[1] = data list
					...
					if (arg[1].isGeoList()) {
						return frequency((GeoList) arg[0], (GeoList) arg[1]);
					}
			...
			case 3:
				...
				if ((ok[0] = arg[0].isGeoBoolean())
					...
					return frequency((GeoBoolean) arg[0], (GeoList) arg[1], (GeoList) arg[2]);
				}
				// arg[0] = class list, arg[1] = data list, arg[2] = useDensity
				else if ((ok[0] = arg[0].isGeoList())
						&& (ok[1] = arg[1].isGeoList())
						&& (ok[2] = arg[2].isGeoBoolean())) {
					return frequency((GeoList) arg[0], (GeoList) arg[1], (GeoBoolean) arg[2]);
				} else if (!ok[0]) {
					throw argErr(c, arg[0]);
				} else if (!ok[1]) {
					throw argErr(c, arg[1]);
			...
			case 4:
				...
				if ((ok[0] = arg[0].isGeoList())
					...
					return frequency(
							(GeoList) arg[0], (GeoList) arg[1], (GeoBoolean) arg[2], (GeoNumeric) arg[3]);
				}
				...
				// arg[3] = useDensity
					...
					return frequency(
							(GeoBoolean) arg[0], (GeoList) arg[1], (GeoList) arg[2], (GeoBoolean) arg[3]);
	...
	private GeoList frequency(GeoList dataList) {
		AlgoFrequency algo = new AlgoFrequency(cons, null, null, dataList);
	 ...
	 */
	private GeoList frequency(GeoBoolean isCumulative, GeoList dataList) {
		AlgoFrequency algo = new AlgoFrequency(cons, isCumulative, null, dataList);
		return algo.getResult();
	}
	 ...
	 */
	private GeoList frequency(GeoList classList, GeoList dataList) {
		AlgoFrequency algo;
	 ...
	 */
	private GeoList frequency(GeoList classList, GeoList dataList, GeoBoolean useDensity) {
		AlgoFrequency algo = new AlgoFrequency(cons, null, classList, dataList, useDensity, null);
		return algo.getResult();
	}
	...
	private GeoList frequency(
			GeoList classList, GeoList dataList, GeoBoolean useDensity, GeoNumeric scaleFactor) {
		AlgoFrequency algo =
				new AlgoFrequency(cons, null, classList, dataList, useDensity, scaleFactor);
		return algo.getResult();
	}
	 ...
	 */
	private GeoList frequency(GeoBoolean isCumulative, GeoList classList, GeoList dataList) {
		AlgoFrequency algo = new AlgoFrequency(cons, isCumulative, classList, dataList, null, null);
		return algo.getResult();
	}
	 ...
	 */
	private GeoList frequency(
			GeoBoolean isCumulative, GeoList classList, GeoList dataList, GeoBoolean useDensity) {
		AlgoFrequency algo =
				new AlgoFrequency(cons, isCumulative, classList, dataList, useDensity, null);
		return algo.getResult();
	}
	...
	private GeoList frequency(
		...
		AlgoFrequency algo =
				new AlgoFrequency(cons, isCumulative, classList, dataList, useDensity, scaleFactor);
		return algo.getResult();
	}
}
