		...
		switch (n) {
			case 2:
				if ((ok[0] = arg[0].isGeoList()) && (ok[1] = arg[1].isGeoList())) {
					AlgoContingencyTable algo = new AlgoContingencyTable(
							cons, c.getLabel(), (GeoList) arg[0], (GeoList) arg[1], null);
			...
			case 3:
				if ((ok[0] = arg[0].isGeoList())
					...
					AlgoContingencyTable algo = new AlgoContingencyTable(
							cons, c.getLabel(), (GeoList) arg[0], (GeoList) arg[1], (GeoList) arg[2], null);
			...
			case 4:
				if ((ok[0] = arg[0].isGeoList())
					...
					AlgoContingencyTable algo = new AlgoContingencyTable(
							cons, c.getLabel(), (GeoList) arg[0], (GeoList) arg[1], (GeoList) arg[2], (GeoText)
									arg[3]);
					GeoElement[] ret = {algo.getResult()};
					return ret;
				}
