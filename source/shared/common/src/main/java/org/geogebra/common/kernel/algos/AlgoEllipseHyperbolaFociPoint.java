...
public class AlgoEllipseHyperbolaFociPoint
	...
	public PPolynomial[] getBotanaPolynomials(GeoElementND geo)
		...
		if (type == GeoConicNDConstants.CONIC_ELLIPSE) {
			return getBotanaEllipse();
		} else if (type == GeoConicNDConstants.CONIC_HYPERBOLA) {
			return getBotanaHyperbola();
	...
	private PPolynomial[] getBotanaHyperbola() throws NoSymbolicParametersException {
		GeoPoint F1 = getA2d();
		GeoPoint F2 = getB2d();
		GeoPoint Q = getC2d();
	...
	private PPolynomial[] getBotanaEllipse() throws NoSymbolicParametersException {
		GeoPoint F1 = getA2d();
		GeoPoint F2 = getB2d();
		GeoPoint Q = getC2d();
