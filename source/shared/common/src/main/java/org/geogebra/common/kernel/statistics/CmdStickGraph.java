		...
		switch (n) {
			case 1:
				...
				if (arg[0].isGeoList()) {
					...
					AlgoStickGraph algo = new AlgoStickGraph(cons, c.getLabel(), (GeoList) arg[0]);
			...
			case 2:
				...
				if ((ok[0] = arg[0].isGeoList()) && (ok[1] = arg[1].isGeoList())) {
					...
					AlgoStickGraph algo =
							new AlgoStickGraph(cons, c.getLabel(), (GeoList) arg[0], (GeoList) arg[1]);
					GeoElement[] ret = {algo.getSum()};
					return ret;
					...
					AlgoStickGraph algo =
							new AlgoStickGraph(cons, c.getLabel(), (GeoList) arg[0], (GeoBoolean) arg[1]);
					GeoElement[] ret = {algo.getSum()};
					return ret;
				}
			...
			case 3:
				...
				if ((ok[0] = arg[0].isGeoList())
					...
					AlgoStickGraph algo = new AlgoStickGraph(
