...
public class SliderBlobSizeProperty extends AbstractRangeProperty<Integer> {

	private final SliderPropertyDelegate delegate;

	/**
	 * Creates a property for slider blob (point) size.
	 *
	 ...
	 */
	public SliderBlobSizeProperty(Localization localization, GeoElement element)
			throws NotApplicablePropertyException {
		super(localization, "PointSize", 1, 20, 1);
	...
	protected void setValueSafe(Integer value) {
		...
		numeric.setSliderBlobSize(value);
		numeric.updateVisualStyleRepaint(GProperty.POINT_STYLE);
	}
