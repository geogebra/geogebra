...
public interface SoundManager {
	 ...
	 */
	void playSequenceNote(int note, double duration, int instrument, int velocity);
	 ...
	 */
	void playFunction(GeoFunction geoFunction, double min, double max, int sampleRate, int bitDepth);
