...
/**
 * {@code PropertyCollection} containing {@code Property}s related to {@code GeoElement} visibility.
 */
public final class VisibilityPropertyCollection extends AbstractPropertyCollection<Property> {
	/**
	...
	public VisibilityPropertyCollection(
		...
		setProperties(Stream.of(
				...
				new LocationPropertyCollection(
