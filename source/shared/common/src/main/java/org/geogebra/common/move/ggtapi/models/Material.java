...
public class Material implements Serializable {
	...
	public JSONObject toJson(boolean storeLocalValues) {
		...
		putString(ret, "author_id", String.valueOf(getAuthorID()));
		putString(ret, "language", language);
		putString(ret, "author", getAuthor());
		putString(ret, "description", description);
		putString(ret, "timestamp", String.valueOf(timestamp));
		...
		putString(ret, "height", String.valueOf(height));
		putString(ret, "width", String.valueOf(width));
		putString(ret, "syncstamp", String.valueOf(syncStamp));
		putString(ret, "modified", String.valueOf(this.modified));
