		...
		switch (n) {
			...
			case 4:
				...
				if ((ok[2] = arg[2] instanceof GeoNumberValue)
					...
					if ((ok[0] = arg[0] instanceof VectorNDValue)
							...
							&& (ok[3] = arg[3] instanceof GeoNumberValue)) {
						ExpressionNode exp = kernel.convertNumberValueToExpressionNode(arg[0]);
			...
			case 5:
				...
				if ((ok[0] = arg[0] instanceof GeoNumberValue)
					...
					AlgoCurveCartesian algo = new AlgoCurveCartesian(
							cons,
							null,
							new GeoNumberValue[] {(GeoNumberValue) arg[0], (GeoNumberValue) arg[1]},
							(GeoNumeric) arg[2],
