		...
		switch (n) {
			case 2:
				...
				if ((ok[0] = arg[0].isGeoList()) && (ok[1] = arg[1].isGeoNumeric())) {
					...
					AlgoBarChart algo =
							new AlgoBarChart(cons, c.getLabel(), (GeoList) arg[0], (GeoNumeric) arg[1]);
					...
					AlgoBarChart algo =
							new AlgoBarChart(cons, c.getLabel(), (GeoList) arg[0], (GeoList) arg[1]);
			...
			case 3:
				...
				if ((ok[0] = arg[0] instanceof GeoNumberValue)
					...
					AlgoBarChart algo = new AlgoBarChart(
					...
					AlgoBarChart algo = new AlgoBarChart(
							cons, c.getLabel(), (GeoList) arg[0], (GeoList) arg[1], (GeoNumberValue) arg[2]);
