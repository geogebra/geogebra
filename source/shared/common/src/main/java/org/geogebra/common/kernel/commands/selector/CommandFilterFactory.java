...
public final class CommandFilterFactory {
	...
	public static CommandFilter createSciCalcCommandFilter() {
		CommandNameFilter commandNameFilter = new CommandNameFilter(false);
	...
	public static CommandFilter createGraphingCommandFilter() {
		...
		CommandFilter tableFilter = new CommandTableFilter(
				CommandsConstants.TABLE_CONIC,
				CommandsConstants.TABLE_TRANSFORMATION,
				CommandsConstants.TABLE_3D);
		CommandFilter nameFilter = createGraphingNameFilter();
		return new CompositeCommandFilter(noCasCommandFilter, tableFilter, nameFilter);
	}

	private static CommandFilter createGraphingNameFilter() {
		CommandNameFilter nameFilter = new CommandNameFilter(true);
		nameFilter.addCommands(
				Commands.OrthogonalVector,
				Commands.UnitOrthogonalVector,
				Commands.UnitVector,
				Commands.Cross,
				Commands.Dot,
				Commands.Mirror,
				...
				Commands.Angle,
				Commands.Diameter,
				Commands.Excentricity,
				Commands.FirstAxis,
				Commands.SecondAxis,
				Commands.FirstAxisLength,
				...
				Commands.Centroid,
				Commands.CircleArc,
				Commands.CircleSector,
				Commands.CircumcircleArc,
				Commands.CircumcircleSector,
				...
				Commands.Midpoint,
				Commands.Perimeter,
				Commands.LineBisector,
				Commands.OrthogonalLine,
				Commands.Polygon,
				Commands.Prove,
	...
	public static CommandFilter createCasCommandFilter() {
		...
		commandNameFilter.addCommands(
				...
				Commands.ConeInfinite,
				Commands.CylinderInfinite,
		...
		return new CompositeCommandFilter(
				commandNameFilter, new CommandTableFilter(Commands.TABLE_DISCRETE));
	}
