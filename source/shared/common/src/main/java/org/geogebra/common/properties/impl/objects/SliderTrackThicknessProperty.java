...
public class SliderTrackThicknessProperty extends AbstractRangeProperty<Integer>
	...
	/**
	 * Creates a property for slider track thickness.
	 *
	 ...
	 */
	public SliderTrackThicknessProperty(Localization localization, GeoElement element)
			throws NotApplicablePropertyException {
		super(localization, "Thickness", 1, 20, 1);
	...
	protected void setValueSafe(Integer value) {
		...
		numeric.setLineThickness(value);
		numeric.updateVisualStyleRepaint(GProperty.LINE_STYLE);
	}
