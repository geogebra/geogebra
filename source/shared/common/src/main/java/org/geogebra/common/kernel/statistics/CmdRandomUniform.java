...
public class CmdRandomUniform extends CmdTwoNumFunction {
	...
	@Override
	protected GeoElement doCommand2(Command a, GeoNumberValue b, GeoNumberValue c, GeoNumberValue d) {
		AlgoRandomUniformList algo = new AlgoRandomUniformList(cons, a.getLabel(), b, c, d);
		return algo.getResult();
	}
}
