...
public class PlotterBrushElements extends PlotterBrush {
	...
	@Override
	public void arcExtendedWithArrows(
			Coords center,
			Coords v1,
			Coords v2,
			double radius,
		...
		super.arcExtendedWithArrows(center, v1, v2, radius, arcStart, extent, longitude);
	...
	public void arcEllipse(
			Coords center, Coords v1, Coords v2, double a, double b, double arcStart, double extent) {
	...
	protected void drawTick(
			Coords p1b, Coords p2b, double i, float ticksThickness, float lineThickness) {
		setTextureX(i);
		moveTo(p1b);
		setTextureX(0);
