...
public enum Language {
	...
	// order
	Afrikaans(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			false, "af", "Afrikaans", Script.LATIN, ""),

	Albanian(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
	...
	Arabic(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
			"ar",
	...
	Arabic_Syria(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			false, "ar",
	...
	Armenian(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			true, "hy",
			"Armenian / \u0540\u0561\u0575\u0565\u0580\u0565\u0576",
			Script.ARMENIAN, ',', ""),
	...
	Chinese_Simplified(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			true, "zh",
			"Chinese Simplified / \u7B80\u4F53\u4E2D\u6587", Script.HANS, ',', '0', "CN", ""),

	Chinese_Traditional(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			true, "zh",
	...
	Danish(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
	...
	Esperanto(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
	...
	Filipino(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
	...
	Georgian(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			true, "ka",
	...
	Icelandic(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
	...
	Kannada(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			true, "kn", "Kannada", Script.KANNADA, ""),

	Kazakh(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
			"kk",
			"Kazakh / \u049A\u0430\u0437\u0430\u049B \u0442\u0456\u043B\u0456",
			Script.CYRILLIC, ',', ""),

	Khmer(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
			"km",
			"Khmer",
			Script.LATIN, '.', '\u17e0', ""),
	...
	Malay(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
			"ms", "Malay / Bahasa Malaysia", Script.LATIN, ""),

	Malayalam(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			false, "ml",
			"Malayalam / \u0D2E\u0D32\u0D2F\u0D3E\u0D33\u0D02",
			Script.MALAYALAM, '.', '\u0d66', ""),
	...
	Norwegian_Nynorsk(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			true, "nn", "Norwegian / Nynorsk",
			Script.LATIN, ',', '0', null, ""),

	Persian(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
			"fa", "Persian / \u0641\u0627\u0631\u0633\u06CC",
			Script.ARABIC, '.', '\u06f0', ""),
	...
	Russian(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			true, "ru",
	...
	Ukrainian(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$',
			true, "uk",
			"Ukrainian / \u0423\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430"
					+ " \u043C\u043E\u0432\u0430",
			Script.CYRILLIC, ',', "-\u0433\u043e"),

	Uyghur(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
			"ug", "Uyghur", Script.ARABIC, ""),

	Uzbek(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
	...
	Welsh(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
			"cy", "Welsh / Cymraeg", Script.LATIN, '.', '0', null, ""),

	Xhosa(EuclidianStyleConstants.RIGHT_ANGLE_STYLE_SQUARE, '$', true,
