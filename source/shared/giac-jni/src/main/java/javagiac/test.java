...
public class test {
	...
	public static void main(String argv[]) {
		...
		s=new String("[[1],[ii:=gbasis(subst([v9*v4+-1*v10*v3+-1*v9*v2+v3*v2+v10*v1+-1*v4*v1,v11*v6+-1*v12*v5+-1*v11*v2+v5*v2+v12*v1+-1*v6*v1," +
				...
				*/
		// s=new String("normal(regroup((when(type(723394816*x^4 + 970407680*x^3*y + 2893579264*x^3 -
		// 49757600*x^2*y^2 + 2911223040*x^2*y + 4340368896*x^2 - 251658000*x*y^3 - 99515200*x*y^2 +
		// 2911223040*x*y + 2893579264*x - 1988189375*y^4 + 6429177200*y^3 - 5528042464*y^2 +
		// 970407680*y = -723394816)==DOM_LIST,map(723394816*x^4 + 970407680*x^3*y + 2893579264*x^3 -
		// 49757600*x^2*y^2 + 2911223040*x^2*y + 4340368896*x^2 - 251658000*x*y^3 - 99515200*x*y^2 +
		// 2911223040*x*y + 2893579264*x - 1988189375*y^4 + 6429177200*y^3 - 5528042464*y^2 +
		// 970407680*y = -723394816,left),left(723394816*x^4 + 970407680*x^3*y + 2893579264*x^3 -
		// 49757600*x^2*y^2 + 2911223040*x^2*y + 4340368896*x^2 - 251658000*x*y^3 - 99515200*x*y^2 +
		// 2911223040*x*y + 2893579264*x - 1988189375*y^4 + 6429177200*y^3 - 5528042464*y^2 +
		// 970407680*y = -723394816)))-(when(type(723394816*x^4 + 970407680*x^3*y + 2893579264*x^3 -
		// 49757600*x^2*y^2 + 2911223040*x^2*y + 4340368896*x^2 - 251658000*x*y^3 - 99515200*x*y^2 +
		// 2911223040*x*y + 2893579264*x - 1988189375*y^4 + 6429177200*y^3 - 5528042464*y^2 +
		// 970407680*y = -723394816)==DOM_LIST,map(723394816*x^4 + 970407680*x^3*y + 2893579264*x^3 -
		// 49757600*x^2*y^2 + 2911223040*x^2*y + 4340368896*x^2 - 251658000*x*y^3 - 99515200*x*y^2 +
		// 2911223040*x*y + 2893579264*x - 1988189375*y^4 + 6429177200*y^3 - 5528042464*y^2 +
		// 970407680*y = -723394816,right),right(723394816*x^4 + 970407680*x^3*y + 2893579264*x^3 -
		// 49757600*x^2*y^2 + 2911223040*x^2*y + 4340368896*x^2 - 251658000*x*y^3 - 99515200*x*y^2 +
		// 2911223040*x*y + 2893579264*x - 1988189375*y^4 + 6429177200*y^3 - 5528042464*y^2 +
		// 970407680*y = -723394816)))))");
		// s=new String("normal(regroup((when(type(100000000*x^4 - 474000000*x^3*y + 400000000*x^3 +
		// 709690000*x^2*y^2 - 1422000000*x^2*y + 600000000*x^2 - 350760000*x*y^3 + 1419380000*x*y^2 -
		// 1422000000*x*y + 400000000*x - 247302961*y^4 + 253365922*y^3 + 407627039*y^2 - 474000000*y =
		// -100000000)==DOM_LIST,map(100000000*x^4 - 474000000*x^3*y + 400000000*x^3 + 709690000*x^2*y^2
		// - 1422000000*x^2*y + 600000000*x^2 - 350760000*x*y^3 + 1419380000*x*y^2 - 1422000000*x*y +
		// 400000000*x - 247302961*y^4 + 253365922*y^3 + 407627039*y^2 - 474000000*y =
		// -100000000,left),left(100000000*x^4 - 474000000*x^3*y + 400000000*x^3 + 709690000*x^2*y^2 -
		// 1422000000*x^2*y + 600000000*x^2 - 350760000*x*y^3 + 1419380000*x*y^2 - 1422000000*x*y +
		// 400000000*x - 247302961*y^4 + 253365922*y^3 + 407627039*y^2 - 474000000*y =
		// -100000000)))-(when(type(100000000*x^4 - 474000000*x^3*y + 400000000*x^3 + 709690000*x^2*y^2
		// - 1422000000*x^2*y + 600000000*x^2 - 350760000*x*y^3 + 1419380000*x*y^2 - 1422000000*x*y +
		// 400000000*x - 247302961*y^4 + 253365922*y^3 + 407627039*y^2 - 474000000*y =
		// -100000000)==DOM_LIST,map(100000000*x^4 - 474000000*x^3*y + 400000000*x^3 + 709690000*x^2*y^2
		// - 1422000000*x^2*y + 600000000*x^2 - 350760000*x*y^3 + 1419380000*x*y^2 - 1422000000*x*y +
		// 400000000*x - 247302961*y^4 + 253365922*y^3 + 407627039*y^2 - 474000000*y =
		// -100000000,right),right(100000000*x^4 - 474000000*x^3*y + 400000000*x^3 + 709690000*x^2*y^2 -
		// 1422000000*x^2*y + 600000000*x^2 - 350760000*x*y^3 + 1419380000*x*y^2 - 1422000000*x*y +
		// 400000000*x - 247302961*y^4 + 253365922*y^3 + 407627039*y^2 - 474000000*y =
		// -100000000)))))");
		// s=new String("1+2");
		...
		*/
		s =
				"eliminate([-1*v28+-1*v25+v24,-1*v27+v26+v23,-1*v30+v26+v23,-1*v29+v25+-1*v24,v31*v28+-1*v32*v27+-1*v31*v24+v27*v24+v32*v23+-1*v28*v23,v31*v30+-1*v32*v29+-1*v31*v26+v29*v26+v32*v25+-1*v30*v25,-1*v34+v25+-1*v23,-1*v33+-1*v26+v24,v35*v34+-1*v36*v33,v35*v30+-1*v36*v29+-1*v35*v26+v29*v26+v36*v25+-1*v30*v25,-1+-1*v40*v35+v40*v31],["
						+ v1 + "]))";
		s =
				"eliminate([v107+-1*v105+-1*v103,v108+-1*v106+-1*v104,v109+v105+-1*v103,v110+v106+-1*v104,v111*v108+-1*v112*v107+-1*v111*v106+v107*v106+v112*v105+-1*v108*v105,v111*v110+-1*v112*v109,-1*v113*v106+v114*v105,-1*v113*v112+v114*v111+v113*v104+-1*v111*v104+-1*v114*v103+v112*v103,2*v115+-1*v105,2*v116+-1*v106,-1+-1*v121*v116+v121*v114],[v121,v116,v115,v114,v113,v112,v111,v110,v109,v108,v107])]";

		String z1 = "v16,v12,v11,v10,v9,v8,v7,v6,v5";
		String z2 = "v16,v11,v10,v9,v8,v7,v6,v5,v12";

		s =
				"eliminate([2*v5+-1*v3,2*v6+-1*v4,2*v7+-1*v3,2*v8+-1*v4,v10+-1*v8+-1*v7,v9+v8+-1*v7,-1*v11*v10+v12*v9+v11*v8+-1*v9*v8+-1*v12*v7+v10*v7,-1*v11*v4+v12*v3,-1+-1*v16*v12+v16*v6],["
						+ z1
						+ "])]";

		String i =
				"2*v5+-1*v3,2*v6+-1*v4,2*v7+-1*v3,2*v8+-1*v4,v10+-1*v8+-1*v7,v9+v8+-1*v7,-1*v11*v10+v12*v9+v11*v8+-1*v9*v8+-1*v12*v7+v10*v7,-1*v11*v4+v12*v3,-1+-1*v16*v12+v16*v6";
		s = "gbasis([" + i + "],[v16,v12,v11,v10,v9,v8,v7,v6,v5],revlex)";
		s = "degree([[a:=gbasis([" + i + "],[v16,v11,v10,v9,v8,v7,v6,v5,v12],revlex)],a][1][1],v6)";

		s =
				"contains_vars(poly,var_list):={local ii; for (ii:=0; ii<size(var_list); ii++) { if (degree(poly,var_list[ii])>0) { return true } } return false}; contains_vars(c^2+a,[x,y,z,c]);"
