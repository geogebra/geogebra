...
class FunctionTemplateCatalog {
	...
	List<FunctionTemplate> createGeneralFunctions() {
		return Arrays.asList(
				...
				new FunctionTemplate(Tag.FRAC, "\\frac", createDownParameter(1), createUpParameter(0)),
				...
				new FunctionTemplate(
						Tag.NROOT, "\\sqrt", new Parameter[] {createDownParameter(0), createUpParameter(1)}, 1),
				new FunctionTemplate(
						Tag.LOG, "\\log", new Parameter[] {Parameter.BASIC, Parameter.BASIC}, 1),
				new FunctionTemplate(
						Tag.LOG_POWER,
						"\\log",
						new Parameter[] {Parameter.BASIC, Parameter.BASIC, Parameter.BASIC},
						1),
				new FunctionTemplate(
						Tag.DEF_INT,
						"\\int",
						new Parameter[] {createUpParameter(1), createDownParameter(0)},
						2),
				new FunctionTemplate(
						Tag.INTEGRAL,
						"\\int",
				...
				new FunctionTemplate(
						...
						Parameter.BASIC),
				new FunctionTemplate(
						Tag.INTEGRAL_SYMBOLIC,
						"\\int",
						Parameter.BASIC,
						Parameter.BASIC,
						Parameter.BASIC,
						Parameter.BASIC),
				new FunctionTemplate(Tag.LIM_EQ, "\\lim", new Parameter[] {Parameter.BASIC}, 1),
				new FunctionTemplate(
						Tag.PROD_EQ,
						"\\prod",
						new Parameter[] {createUpParameter(1), createDownParameter(0)},
						2),
				new FunctionTemplate(
						Tag.SUM_EQ, "\\sum", new Parameter[] {createUpParameter(1), createDownParameter(0)}, 2),
				new FunctionTemplate(Tag.VEC, "\\vec", Parameter.BASIC),
				new FunctionTemplate(
						Tag.ATOMIC_PRE,
						"\\atomicpre",
						createUpParameter(1),
						createDownParameter(0),
						Parameter.BASIC),
				new FunctionTemplate(
						Tag.ATOMIC_POST,
						"\\atomicpost",
				...
				new FunctionTemplate(
						Tag.VECTOR,
						"",
						new Parameter[] {createDownParameter(1), new Parameter(0, 2), createUpParameter(1)},
						0,
						2),
