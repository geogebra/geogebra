...
public final class FontLoader {
	...
	private static final FontProperty.FontFamily[] bundled = new FontProperty.FontFamily[]{
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_SCHWARZ,
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_SCHWARZ_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_TUERKIS,
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_TUERKIS_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_ORANGE_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_ORANGE,
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_GRUEN_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_GRUEN,
			FontProperty.FontFamily.BY_DS_LERNEN_1_2_OHNE_LINEATUR,
			FontProperty.FontFamily.BY_DS_LERNEN_3_SCHWARZ,
			FontProperty.FontFamily.BY_DS_LERNEN_3_SCHWARZ_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_3_TUERKIS,
			FontProperty.FontFamily.BY_DS_LERNEN_3_TUERKIS_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_3_ORANGE_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_3_ORANGE,
			FontProperty.FontFamily.BY_DS_LERNEN_3_GRUEN_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_3_GRUEN,
			FontProperty.FontFamily.BY_DS_LERNEN_4_SCHWARZ,
			FontProperty.FontFamily.BY_DS_LERNEN_4_SCHWARZ_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_4_TUERKIS,
			FontProperty.FontFamily.BY_DS_LERNEN_4_TUERKIS_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_4_ORANGE_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_4_ORANGE,
			FontProperty.FontFamily.BY_DS_LERNEN_4_GRUEN_FARBBAND,
			FontProperty.FontFamily.BY_DS_LERNEN_4_GRUEN,
			FontProperty.FontFamily.BY_DS_LERNEN_3_4_OHNE_LINEATUR,
			FontProperty.FontFamily.BY_DS_LERNEN_4_TUERKIS_FARBBAND,
