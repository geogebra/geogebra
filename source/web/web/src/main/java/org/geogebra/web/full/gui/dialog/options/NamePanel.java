...
class NamePanel extends OptionPanel
	...
	NamePanel(final AppW app, ShowLabelModel showLabelModel) {
		...
		InputPanelW inputPanelName = new InputPanelW(null, app, false);
		...
		InputPanelW inputPanelDef = new InputPanelW(null, app, false);
	...
	public void updateGUI(boolean showDefinition, boolean showCaption) {
		...
		if (showCaption) {
			...
			mainWidget.add(dynamicCaptionPanel.getWidget());
		}
	}
