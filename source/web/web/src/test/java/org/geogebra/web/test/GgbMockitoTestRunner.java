...
public class GgbMockitoTestRunner extends GwtMockitoTestRunner {
	...
	public GgbMockitoTestRunner(Class<?> unitTestClass) throws InitializationError {
		super(unitTestClass);
		StubGenerator.replaceMethodWithMock(Js.class, "asPropertyMap", JsPropertyMap.class);
		StubGenerator.replaceMethodWithMock(JsObject.class, "of", JsPropertyMap.class);
		StubGenerator.replaceMethodWithMock(DomGlobal.class, "setInterval", Double.class);
		StubGenerator.replaceMethodWithMock(DomGlobal.class, "setTimeout", Double.class);
		StubGenerator.replaceMethodWithMock(FileDropHandlerW.class, "registerDropHandler", Void.class);
		StubGenerator.replaceMethodWithMock(Canvas.class, "createIfSupported", Canvas.class);
		StubGenerator.replaceMethodWithMock(JLMContextHelper.class, "as", JLMContext2D.class);
		StubGenerator.replaceMethodWithMock(GGraphics2DW.class, "preventContextMenu", Void.class);
		StubGenerator.replaceMethodWithMock(Graphics2DW.class, "initFontParser", Void.class);
		StubGenerator.replaceMethodWithMock(
				RendererWithImplW.class, "getWebGLContext", WebGLRenderingContext.class);
		StubGenerator.replaceMethodWithMock(RendererImplShadersW.class, "getShader", WebGLShader.class);
		StubGenerator.replaceMethodWithMock(RendererImplShadersW.class, "glLinkProgram", Void.class);
		StubGenerator.replaceMethodWithMock(Uint8Array.class, "create", Uint8Array.class);
		StubGenerator.replaceMethodWithMock(
				RendererImplShadersW.class, "createAlphaTexture", Integer.class);
		StubGenerator.replaceMethodWithMock(Dom.class, "addEventListener", Void.class);
		StubGenerator.replaceMethodWithMock(
				GlobalHandlerRegistry.class, "addEventListener", Void.class);
		StubGenerator.replaceMethodWithMock(CopyPasteW.class, "installCutCopyPaste", Void.class);
		StubGenerator.replaceMethodWithMock(FormatFactoryW.class, "toPrecision", String.class);
		StubGenerator.replaceMethodWithMock(NativeRegExp.class, "exec", String.class);
		StubGenerator.replaceMethodWithMock(ClickAdapterW.class, "listenTo", Void.class);
		StubGenerator.replaceMethodWithMock(XMLHttpRequest.class, "send", XMLHttpRequest.class);
		StubGenerator.replaceMethodWithMock(StyleInjector.class, "inject", Void.class);
		StubGenerator.replaceMethodWithMock(Browser.class, "isSafariByVendor", Boolean.class);
		StubGenerator.replaceMethodWithMock(SVGResourcePrototype.class, "withFill", SafeUri.class);
		...
		StubGenerator.replaceMethodWithMock(elemental2.dom.Element.class, "setAttribute", Void.class);
		...
		StubGenerator.replaceMethodWithMock(CopyPasteW.class, "writeToExternalClipboard", Object.class);
		StubGenerator.replaceMethodWithMock(ResizeComposite.class, "onResize", Void.class);
