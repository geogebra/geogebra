...
public class AnimatedGifEncoderW implements FrameCollectorW {
	...
	public void addFrame(EuclidianViewWInterface view, double exportScale) {
		String url = view.getExportImageDataUrl(exportScale, false, App.ExportType.PNG, false);
		gifs.add(url);
	}
	...
	public void finish(int width, int height) {
		ExportLoader.onGifshotLoaded(() -> finish(gifs, filename, width, height, frameDelay * 0.001));
	}
