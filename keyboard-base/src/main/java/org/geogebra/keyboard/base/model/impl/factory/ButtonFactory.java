...
public class ButtonFactory {
	...
	WeightedButton createLatexInputButton(String formula, String action,
			float weight) {
	...
	WeightedButton createConstantInputButton(String input, String action,
			float weight) {
	...
	WeightedButton createTranslateInputButton(String translate, String input,
			float weight) {
	...
	WeightedButton createTranslateInputTranslateButton(String translate,
	...
	WeightedButton createInputTranslateButton(String name,
	...
	WeightedButton createCustomConstantButton(String resource, String action,
			float weight) {
	...
	WeightedButton createConstantInputTranslateButton(String resource,
			String translateInput, float weight) {
		return new WeightedButtonImpl(resource, ResourceType.DEFINED_CONSTANT,
