...
public abstract class QuadCurve2D implements Shape, Cloneable, GQuadCurve2D {
	...
	public static class Float extends QuadCurve2D {
		 ...
		 * 
		 * @param x1
		 *            ,&nbsp;y1 the starting point coordinates
		 * @param ctrlx
		 *            ,&nbsp;ctrly the coordinates of the control point
		 * @param x2
		 *            ,&nbsp;y2 the ending point coordinates
		 */
		 ...
		 * 
		 * @param x1
		 *            ,&nbsp;y1 the coordinates of the starting point
		 * @param ctrlx
		 *            ,&nbsp;ctrly the coordinates of the control point
		 * @param x2
		 *            ,&nbsp;y2 the coordinates of the ending point
		 */
	...
	/**
	 * A quadratic parametric curve segment specified with <code>double</code>
	 * coordinates.
	 */
	public static class Double extends QuadCurve2D implements
	        org.geogebra.common.awt.GQuadCurve2D {
		/**
		 * The x coordinate of the start point of the quadratic curve segment.
		 */
		public double x1;
		 ...
		 * Returns the start point.
		 * 
		 * @return a <code>Point2D</code> that is the starting point of this
		 *         <code>QuadCurve2D</code>.
		 */
		public Point2D getP1() {
		 ...
		 * Returns the control point.
		 * 
		 * @return a <code>Point2D</code> object that is the control point of
	...
	public void setCurve(Point2D p1, Point2D cp, Point2D p2) {
		setCurve(p1.getX(), p1.getY(), cp.getX(), cp.getY(), p2.getX(),
		        p2.getY());
	}
	 ...
	 *            coordinate values
	 * @param offset
	 *            the index into <code>pts</code> at which to start getting the
	 *            coordinate values and assigning them to this
	 *            <code>QuadCurve2D</code>
	 */
	...
	/**
	 * Returns the square of the flatness, or maximum distance of a controlpoint
	 * from the line connecting the endpoints, of the quadratic curve specified
	 ...
	 * connecting the endpoints, of the quadratic curve specified by the
	 ...
	 * Returns the square of the flatness, or maximum distance of a controlpoint
	 * from the line connecting the endpoints, of the quadratic curve specified
	 * by the controlpoints stored in the indicated array at the indicated
	 * index.
	 * 
	 * @param coords
	 *            an array containing coordinate values
	 * @param offset
	 *            the index into <code>coords</code> at which to to start
	 *            getting the values from the array and assigning them to a
	 *            quadratic curve
	 ...
	 *            an array containing coordinate values
	 * @param offset
	 *            the index into <code>coords</code> at which to start getting
	 *            the coordinate values and assigning them to a quadratic curve
	...
	/**
	 * Returns the square of the flatness, or maximum distance of a controlpoint
	 * from the line connecting the endpoints, of this <code>QuadCurve2D</code>.
	 * 
	...
	/**
	 * Returns the flatness, or maximum distance of a controlpoint from the line
	 * connecting the endpoints, of this <code>QuadCurve2D</code>.
	 * 
	 ...
	 * @return <code>true</code> if the specified coordinate is inside the
	 *         boundary of the shape of this <code>QuadCurve2D</code>;
	 ...
	 *         the boundary of the shape of this <code>QuadCurve2D</code>.
	 */
	 ...
	 * @return <code>true</code> if the shape of this <code>QuadCurve2D</code>
	 *         intersects the interior of the specified set of rectangular
	...
	public boolean intersects(double x, double y, double w, double h) {
		...
		if (!yoverlap) {
			...
			return (solveQuadratic(eqn, res) == 2
			        ...
			        res[0], x, x + w) * getTag(res[1], x, x + w) <= 0);
		}
		...
		if (!xoverlap) {
			...
			return (solveQuadratic(eqn, res) == 2
			        ...
			        res[0], y, y + h) * getTag(res[1], y, y + h) <= 0);
		}
	...
	/**
	 * Tests if the interior of the shape of this <code>QuadCurve2D</code>
	...
	/**
	 * Tests if the interior of the shape of this <code>QuadCurve2D</code>
	 * entirely contains the specified <code>Rectangle2D</code>.
	 * 
	 * @param r
	 *            the specified <code>Rectangle2D</code>
	 * @return <code>true</code> if the interior of the shape of this
	 ...
	 * Returns the bounding box of this <code>QuadCurve2D</code>.
	 * 
	 * @return a {@link Rectangle} that is the bounding box of the shape of this
	 *         <code>QuadCurve2D</code>.
	 */
