...
public abstract class Rectangle2D extends RectangularShape implements GRectangle2D {
     ...
     * @since 1.2
     */
    public static void intersect(GRectangle2D src1,
                                 GRectangle2D src2,
                                 GRectangle2D dest) {
     ...
     * @since 1.2
     */
    public abstract GRectangle2D createUnion(GRectangle2D r);
     ...
     * @since 1.2
     */
    public static void union(GRectangle2D src1,
                             GRectangle2D src2,
                             GRectangle2D dest) {
        ...
        ((RectangularShape) dest).setFrameFromDiagonal(x1, y1, x2, y2);
    }
     ...
     * @since 1.2
     */
    public void add(GRectangle2D r) {
