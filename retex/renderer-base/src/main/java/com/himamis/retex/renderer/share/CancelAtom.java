...
public class CancelAtom extends Atom {
	...
	public Atom duplicate() {
		return setFields(new CancelAtom(base, cancelType));
	}
	 ...
	 *            base object
	 * @param cancelType
	 *            what sort of cancelling
	 */
	public CancelAtom(Atom base, Type cancelType) {
		if (base == null) {
	...
	public Box createBox(TeXEnvironment env) {
		...
		return new Cancel(bbase, drt, cancelType);
	}
}
