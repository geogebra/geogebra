...
//	}
	...
	public static final Atom lmoustache_macro() throws ParseException {
		Atom at = new BigDelimiterAtom((SymbolAtom) SymbolAtom.get("lmoustache").duplicate(), 1);
		at.type = TeXConstants.TYPE_OPENING;
		return at;
	}

	public static final Atom rmoustache_macro() throws ParseException {
		Atom at = new BigDelimiterAtom((SymbolAtom) SymbolAtom.get("rmoustache").duplicate(), 1);
