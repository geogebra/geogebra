...
class MetaModelSymbols {
	...
	MetaGroupCollection createOperators() {
		...
		collection
				.addComponent(createOperator("sim", "NaN", "\\sim", '\u223c'));
		collection.addComponent(
		...
		collection
				.addComponent(createOperator("cup", "NaN", "\\cup", '\u222a'));
		collection
				.addComponent(createOperator("cap", "NaN", "\\cap", '\u2229'));
		collection.addComponent(
	...
	MetaGroupCollection createSymbols() {
		...
		collection
				.addComponent(createSymbol("inf", "\\infty", Unicode.INFINITY));
		...
		collection
				.addComponent(createSymbol("varsigma", "\\varsigma", '\u03c2'));
