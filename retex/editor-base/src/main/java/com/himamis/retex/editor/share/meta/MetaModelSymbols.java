...
class MetaModelSymbols {
	...
	MetaGroupCollection createOperators() {
		...
		collection.addComponent(
				createOperator("ne", "!=", "\\ne", Unicode.NOTEQUAL));
		collection.addComponent(createOperator("equal", "==", Unicode.QUESTEQ + "",
				Unicode.QUESTEQ));
		...
		collection.addComponent(createOperator("ll", "NaN", "\\ll", '\u226a'));
		collection.addComponent(createOperator("gg", "NaN", "\\gg", '\u226b'));

		collection.addComponent(createOperator("sim", "NaN", "\\sim", '\u223c'));
		collection.addComponent(createOperator("approx", "NaN", "\\approx", '\u2248'));
		collection.addComponent(createOperator("simeq", "NaN", "\\simeq", '\u2243'));
		collection.addComponent(createOperator("propto", "NaN", "\\propto", '\u221d'));

		collection.addComponent(createOperator("forall", "NaN", "\\forall", '\u2200'));
		collection.addComponent(createOperator("exists", "NaN", "\\exists", '\u2203'));
		...
		collection.addComponent(createOperator("supset", "NaN", "\\supset", '\u2283'));
		collection.addComponent(createOperator("subseteq", "NaN", "\\subseteq",
				Unicode.IS_SUBSET_OF));
		collection.addComponent(createOperator("supseteq", "NaN", "\\supseteq", '\u2287'));
		collection.addComponent(createOperator("cup", "NaN", "\\cup", '\u222a'));
		collection.addComponent(createOperator("cap", "NaN", "\\cap", '\u2229'));
		collection.addComponent(
				createOperator("in", "NaN", "\\in", Unicode.IS_ELEMENT_OF));
		collection.addComponent(createOperator("empty", "NaN", "\\emptyset", '\u2205'));

		collection.addComponent(createOperator("pm", "NaN", "\\pm", Unicode.PLUSMINUS));
		collection.addComponent(createOperator("prime", "NaN", "\\prime", '\u2032'));
		collection.addComponent(createOperator("circ", "NaN", "\\circ", '\u2218'));
		collection.addComponent(createOperator("partial", "NaN", "\\partial", '\u2202'));
		...
		collection.addComponent(createOperator("notleftrightarrow", "NaN",
				"\\not\\leftrightarrow", '\u21ae'));
		collection.addComponent(createOperator("vectorprod", "\\times", '\u2a2f'));
	...
	MetaGroupCollection createSymbols() {
		...
		collection.addComponent(createSymbol("inf", "\\infty", Unicode.INFINITY));

        //collection.addComponent(createSymbol("vareps", "\\varepsilon", '\u03f5'));
        //collection.addComponent(createSymbol("varth", "\\vartheta", '\u03b8'));
		//collection.addComponent(createSymbol("varpi", "\\varpi", Unicode.varpi));
		//collection.addComponent(createSymbol("varrho", "\\varrho", Unicode.varrho));

		for (Greek ch : Greek.values()) {
			collection.addComponent(createSymbol(ch.name(), "\\" + ch.getLaTeX(), ch.unicode));
		}

		collection.addComponent(createSymbol("varsigma", "\\varsigma", '\u03c2'));
