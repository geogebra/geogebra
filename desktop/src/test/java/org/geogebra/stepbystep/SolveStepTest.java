...
public class SolveStepTest {
	...
	public void trigonometricEquations() {
		...
		t("1/2+2sin(x)", "sin(x)+1", "x", 23, "((2)([k0])(pi) + (pi)/(6))", "((2)([k0])(pi)-(pi)/(6) + pi)");
		t("1/2+2sin(3x+1)", "sin(3x+1)+1", "x", 31, "(((2)([k0])(pi) + (pi)/(6)-1))/(3)", "-(((2)([k0])(pi) + (pi)/(6)-pi + 1))/(3)");
		t("(sin(2x+1))^2+1/2", "1", "x", 59, "(((2)([k0])(pi) + (pi)/(4)-1))/(2)", "-(((2)([k0])(pi) + (pi)/(4)-pi + 1))/(2)",
				"(((2)([k0])(pi)-(pi)/(4)-1))/(2)", "-(((2)([k0])(pi)-(pi)/(4)-pi + 1))/(2)");
		t("1/2+2cos(3x+1)", "cos(3x+1)+1", "x", 31, "(((2)([k0])(pi) + (pi)/(3)-1))/(3)",
				"-(((2)([k0])(pi) + (pi)/(3) + (-2)(pi) + 1))/(3)");
		t("3+2tan(x)", "tan(x)-1", "x", 9, "(arctan(-4) + ([k0])(pi))");
		t("2(sin(x))^2+(cos(x))^2+cos(x)", "1", "x", 31, "(arccos(-((nroot(5, 2)-1))/(2)) + (2)([k0])(pi))",
				"((2)([k0])(pi)-arccos(-((nroot(5, 2)-1))/(2)) + (2)(pi))");
		t("2(cos(x))^2+(sin(x))^2+sin(x)", "1", "x", 31, "(arcsin(-((nroot(5, 2)-1))/(2)) + (2)([k0])(pi))",
				"((2)([k0])(pi)-arcsin(-((nroot(5, 2)-1))/(2)) + pi)");
		t("2(cos(x))^2+2(sin(x))^2", "2", "x", 8, "R");
		t("sin(x)+cos(x)", "1", "x", 50, "((2)([k0])(pi) + (pi)/(2))", "((2)([k0])(pi) + (2)(pi)-(pi)/(2))", "(2)([k0])(pi)");
	}
