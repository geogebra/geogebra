...
public class SolveStepTest {
	...
	public void rationalEquations() {
		...
		t("1/(1+x)-2x/(2+x)", "7", "x", 16, "((nroot(13, 2)-11))/(9)", "-((nroot(13, 2) + 11))/(9)");
		t("1/x-1/(x+1)", "3", "x", 16, "((nroot(21, 2)-3))/(6)", "-((nroot(21, 2) + 3))/(6)");
		t("x-1/x", "2x", "x", 9);
		t("9", "x/3-x/4", "x", 6, "108");
		t("x+1/(x-1)", "2x-1", "x", 22, "0", "2");
		t("1/(x-6)+x/(x-2)", "4/(x^2-8x+12)", "x", 25, "-1");
		t("x/(1-x)", "(3+x)/x", "x", 16, "((nroot(7, 2)-1))/(2)", "-((nroot(7, 2) + 1))/(2)");
		t("((1)/(x)+1)^(2)", "((1)/(x+3)-2)^(2)", "x", 38, "((nroot(5, 2)-3))/(2)", "-((nroot(5, 2) + 3))/(2)",
				"((nroot(13, 2)-1))/(2)", "-((nroot(13, 2) + 1))/(2)");
	...
	public void qubicEquations() {
		...
		t("x^3 - (29 x^2)/12 + (37 x)/24 - 1/4", "0", "x", 27, "(1)/(4)", "(2)/(3)", "(3)/(2)");
	...
	public void higherOrderEquations() {
		t("x^4+2x+3", "2x+19", "x", 14, "nroot(16, 4)", "-nroot(16, 4)");
		t("x^4+2x+3", "2x+2", "x", 9);
		t("2x^5+2x+3", "2x+67", "x", 15, "nroot(32, 5)");
		t("x^4+4x^2+2", "0", "x", 30);
