...
public class SolveStepTest {
	...
	public void trigonometricEquations() {
		...
		t("1/2+2sin(x)", "sin(x)+1", "x", 23, "((2)([k1])(pi) + (pi)/(6))", "((2)([k2])(pi)-(pi)/(6) + pi)");
		t("1/2+2sin(3x+1)", "sin(3x+1)+1", "x", 31, "(((2)([k1])(pi) + (pi)/(6)-1))/(3)", "-(((2)([k2])(pi) + (pi)/(6)-pi + 1))/(3)");
		t("(sin(2x+1))^2+1/2", "1", "x", 59, "(((2)([k1])(pi) + (pi)/(4)-1))/(2)", "-(((2)([k2])(pi) + (pi)/(4)-pi + 1))/(2)",
				"(((2)([k3])(pi)-(pi)/(4)-1))/(2)", "-(((2)([k4])(pi)-(pi)/(4)-pi + 1))/(2)");
		t("1/2+2cos(3x+1)", "cos(3x+1)+1", "x", 31, "(((2)([k1])(pi) + (pi)/(3)-1))/(3)",
				"-(((2)([k2])(pi) + (pi)/(3) + (-2)(pi) + 1))/(3)");
