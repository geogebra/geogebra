...
public class SolveStepTest {
	...
	public void rationalEquations() {
		...
		t("1/(1+x)-2x/(2+x)", "7", "x", 15, "((nroot(52, 2)-22))/(18)", "((-nroot(52, 2)-22))/(18)");
		t("1/x-1/(x+1)", "3", "x", 15, "((nroot(21, 2)-3))/(6)", "((-nroot(21, 2)-3))/(6)");
		t("x-1/x", "2x", "x", 8);
		t("9", "x/3-x/4", "x", 5, "108");
		t("x+1/(x-1)", "2x-1", "x", 21, "0", "2");
		t("1/(x-6)+x/(x-2)", "4/(x^2-8x+12)", "x", 24, "-1");
		t("x/(1-x)", "(3+x)/x", "x", 15, "((nroot(28, 2)-2))/(4)", "((-nroot(28, 2)-2))/(4)");
		t("((1)/(x)+1)^(2)", "((1)/(x+3)-2)^(2)", "x", 35, "((nroot(45, 2)-9))/(6)", "((-nroot(45, 2)-9))/(6)", "((nroot(13, 2)-1))/(2)",
				"((-nroot(13, 2)-1))/(2)");
	...
	public void irrationalEquations() {
		...
		t("sqrt(x)+1", "sqrt(x+1)+sqrt(x+2)+1", "x", 24);
	...
	public void higherOrderEquations() {
		...
		t("x^6+4x^3+2", "0", "x", 33, "nroot((nroot(2, 2)-2), 3)", "nroot((-nroot(2, 2)-2), 3)");
		...
		t("((1+x)^(2)+1)^(2)+1", "10", "x", 31, "(nroot((nroot(9, 2)-1), 2)-1)", "(-nroot((nroot(9, 2)-1), 2)-1)");
	}
