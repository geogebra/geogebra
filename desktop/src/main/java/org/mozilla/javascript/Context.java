...
public class Context {
	...
	public final String getImplementationVersion() {
		if (implementationVersion == null) {
			...
			try {
				urls = Context.class.getClassLoader()
			...
			while (urls.hasMoreElements()) {
				...
				try {
					...
					if ("Mozilla Rhino"
							.equals(attrs.getValue("Implementation-Title"))) {
						implementationVersion = "Rhino "
	...
	static EvaluatorException reportRuntimeError2(String messageId, Object arg1,
			Object arg2) {
		String msg = ScriptRuntime.getMessage2(messageId, arg1, arg2);
		return reportRuntimeError(msg);
	}

	static EvaluatorException reportRuntimeError3(String messageId, Object arg1,
			Object arg2, Object arg3) {
		String msg = ScriptRuntime.getMessage3(messageId, arg1, arg2, arg3);
		return reportRuntimeError(msg);
	}

	static EvaluatorException reportRuntimeError4(String messageId, Object arg1,
	...
	public Object executeScriptWithContinuations(Script script,
			Scriptable scope) throws ContinuationPending {
