...
public interface DebuggableScript {
	...
	/**
	 * Get number of declared parameters and local variables. Return number of
	 * declared global variables if this script is not a function.
	 *
	 * @see #getParamCount()
	 * @see #getParamOrVarName(int index)
	 */
	...
	/**
	 * Returns true if this script or function were runtime-generated from
	 * JavaScript using <tt>eval</tt> function or <tt>Function</tt> or
	 * <tt>Script</tt> constructors.
	 */
	public boolean isGeneratedScript();

	/**
	 * Get array containing the line numbers that that can be passed to
	 * <code>DebugFrame.onLineChange()<code>. Note that line order in the
	 * resulting array is arbitrary
	 */
