...
final class NativeMath extends IdScriptableObject {
	...
	public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope,
		...
		case Id_cos:
			x = ScriptRuntime.toNumber(args, 0);
			x = (x == Double.POSITIVE_INFINITY || x == Double.NEGATIVE_INFINITY)
	...
	private Object js_imul(Object[] args) {
		...
		long result = (product >= (1L << 31L))
				? (product - Conversions.THIRTYTWO_BIT) : product;
	...
	private static final int Id_toSource = 1, Id_abs = 2, Id_acos = 3,
			...
			Id_sqrt = 18, Id_tan = 19, Id_cbrt = 20, Id_cosh = 21,
			Id_expm1 = 22, Id_hypot = 23, Id_log1p = 24, Id_log10 = 25,
			Id_sinh = 26, Id_tanh = 27, Id_imul = 28, Id_trunc = 29,
