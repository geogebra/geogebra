...
public class ClassCompiler {
	...
	/**
	 * Set the class name to use for main method implementation. The class must
	 * have a method matching
	...
	/**
	 * Build class name for a auxiliary class generated by compiler. If the
	 * compiler needs to generate extra classes beyond the main class, it will
	 * call this function to build the auxiliary class name. The default
	...
	/**
	 * Compile JavaScript source into one or more Java class files. The first
	 * compiled class will have name mainClassName. If the results of
	 * {@link #getTargetExtends()} or {@link #getTargetImplements()} are not
	 * null, then the first compiled class will extend the specified super class
