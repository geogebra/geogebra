...
public class Codegen implements Evaluator {
	...
	@Override
	public Object compile(CompilerEnvirons compilerEnv, ScriptNode tree,
		...
		String mainClassName = "org.mozilla.javascript.gen." + baseName + "_"
				+ serial;
	...
	public byte[] compileToClassFile(CompilerEnvirons compilerEnv,
			String mainClassName, ScriptNode scriptOrFn, String encodedSource,
	...
	private RuntimeException reportClassFileFormatException(
			ScriptNode scriptOrFn, String message) {
	...
	private void transform(ScriptNode tree) {
		...
		if (optLevel > 0) {
			/*
			 * Collect all of the contained functions into a hashtable so that
			 * the call optimizer can access the class name & parameter count
			 * for any call it encounters
			 */
			if (tree.getType() == Token.SCRIPT) {
				...
				for (int i = 0; i != functionCount; ++i) {
					...
					if (ofn.fnode
							.getFunctionType() == FunctionNode.FUNCTION_STATEMENT) {
	...
	private void emitDirectConstructor(ClassFileWriter cfw,
			OptFunctionNode ofn) {
		/*
		 * we generate .. Scriptable directConstruct(<directCallArgs>) {
		 * Scriptable newInstance = createObject(cx, scope); Object val =
		 * <body-name>(cx, scope, newInstance, <directCallArgs>); if (val
		 * instanceof Scriptable) { return (Scriptable) val; } return
		 * newInstance; }
		 */
		...
		cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
				"org/mozilla/javascript/BaseFunction", "createObject",
	...
	private void generateResumeGenerator(ClassFileWriter cfw) {
		...
		cfw.startMethod("resumeGenerator", "(Lorg/mozilla/javascript/Context;"
				+ "Lorg/mozilla/javascript/Scriptable;" + "ILjava/lang/Object;"
		...
		for (int i = 0; i < scriptOrFnNodes.length; i++) {
			...
			if (isGenerator(n)) {
				String type = "(" + mainClassSignature
						+ "Lorg/mozilla/javascript/Context;"
						+ "Lorg/mozilla/javascript/Scriptable;"
						+ "Ljava/lang/Object;"
	...
	private void generateCallMethod(ClassFileWriter cfw) {
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC,
				"org/mozilla/javascript/ScriptRuntime", "hasTopCall",
	...
	private void generateMain(ClassFileWriter cfw) {
		...
		cfw.addInvoke(ByteCode.INVOKESPECIAL, cfw.getClassName(), "<init>",
				"()V");
		// load 'args'
		cfw.add(ByteCode.ALOAD_0);
		// Call mainMethodClass.main(Script script, String[] args)
		cfw.addInvoke(ByteCode.INVOKESTATIC, mainMethodClass, "main",
	...
	private void generateExecute(ClassFileWriter cfw) {
		...
		cfw.addInvoke(ByteCode.INVOKEVIRTUAL, cfw.getClassName(), "call",
				"(Lorg/mozilla/javascript/Context;"
						+ "Lorg/mozilla/javascript/Scriptable;"
						+ "Lorg/mozilla/javascript/Scriptable;"
						+ "[Ljava/lang/Object;" + ")Ljava/lang/Object;");
	...
	private void generateScriptCtor(ClassFileWriter cfw) {
		...
		cfw.addLoadThis();
		cfw.addInvoke(ByteCode.INVOKESPECIAL, SUPER_CLASS_NAME, "<init>",
				"()V");
		// set id to 0
		cfw.addLoadThis();
		cfw.addPush(0);
	...
	private void generateFunctionConstructor(ClassFileWriter cfw) {
		...
		for (int i = start; i != end; ++i) {
			...
			cfw.addInvoke(ByteCode.INVOKESPECIAL, mainClassName,
					getFunctionInitMethodName(ofn), FUNCTION_INIT_SIGNATURE);
			cfw.add(ByteCode.RETURN);
		}
	...
	private void generateFunctionInit(ClassFileWriter cfw,
		...
		final int CONTEXT_ARG = 1;
		final int SCOPE_ARG = 2;
		cfw.startMethod(getFunctionInitMethodName(ofn), FUNCTION_INIT_SIGNATURE,
		...
		cfw.addALoad(SCOPE_ARG);
		cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
				"org/mozilla/javascript/NativeFunction", "initScriptFunction",
				"(Lorg/mozilla/javascript/Context;"
	...
	private void generateNativeFunctionOverrides(ClassFileWriter cfw,
		...
		for (int methodIndex = 0; methodIndex != SWITCH_COUNT; ++methodIndex) {
			...
			if (count > 1) {
				...
				// script/function
				cfw.addLoadThis();
				cfw.add(ByteCode.GETFIELD, cfw.getClassName(), ID_FIELD_NAME,
						"I");
			...
			for (int i = 0; i != count; ++i) {
				...
				case Do_getParamOrVarName:
					...
					if (paramAndVarCount == 0) {
						...
						// to the default case
						int paramSwitchStart = cfw.addTableSwitch(1,
								paramAndVarCount - 1);
	...
	private void emitRegExpInit(ClassFileWriter cfw) {
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC,
				"org/mozilla/javascript/ScriptRuntime", "checkRegExpProxy",
				"(Lorg/mozilla/javascript/Context;"
		...
		for (int i = 0; i != scriptOrFnNodes.length; ++i) {
			...
			for (int j = 0; j != regCount; ++j) {
				...
				cfw.addInvoke(ByteCode.INVOKEINTERFACE,
						"org/mozilla/javascript/RegExpProxy", "compileRegExp",
						"(Lorg/mozilla/javascript/Context;"
								+ "Ljava/lang/String;Ljava/lang/String;"
								+ ")Ljava/lang/Object;");
				cfw.add(ByteCode.PUTSTATIC, mainClassName, reFieldName,
						reFieldType);
			}
		}
	...
	private void emitConstantDudeInitializers(ClassFileWriter cfw) {
		...
		for (int i = 0; i != N; ++i) {
			...
			cfw.add(ByteCode.PUTSTATIC, mainClassName, constantName,
					constantType);
		}
	...
	void pushNumberAsObject(ClassFileWriter cfw, double num) {
		if (num == 0.0) {
			...
			cfw.add(ByteCode.GETSTATIC,
					"org/mozilla/javascript/optimizer/OptRuntime", "oneObj",
					"Ljava/lang/Double;");
			return;
			...
			String constantType = getStaticConstantWrapperType(num);
			cfw.add(ByteCode.GETSTATIC, mainClassName, constantName,
					constantType);
		}
	}
	...
	private static void addDoubleWrap(ClassFileWriter cfw) {
		cfw.addInvoke(ByteCode.INVOKESTATIC,
				"org/mozilla/javascript/optimizer/OptRuntime", "wrapDouble",
				"(D)Ljava/lang/Double;");
	}
...
class BodyCodegen {
	void generateBodyCode() {
		...
		if (isGenerator) {
			...
			String type = "(" + codegen.mainClassSignature
					+ "Lorg/mozilla/javascript/Context;"
					+ "Lorg/mozilla/javascript/Scriptable;"
					+ "Ljava/lang/Object;"
					+ "Ljava/lang/Object;I)Ljava/lang/Object;";
			cfw.startMethod(codegen.getBodyMethodName(scriptOrFn) + "_gen",
					type, (short) (ACC_STATIC | ACC_PRIVATE));
		} else {
	...
	private void generateGenerator() {
		...
		cfw.addInvoke(ByteCode.INVOKESPECIAL, codegen.mainClassName, "<init>",
	...
	private void generatePrologue() {
		...
		if (isGenerator) {
			...
			cfw.add(ByteCode.GETFIELD, OptRuntime.GeneratorState.CLASS_NAME,
			...
			List<Node> targets = ((FunctionNode) scriptOrFn)
					.getResumptionPoints();
			if (targets != null) {
		...
		if (hasVarsInRegs) {
			...
			for (int i = 0; i != varCount; ++i) {
				...
				if (compilerEnv.isGenerateDebugInfo()) {
					...
					String type = fnCurrent.isNumberVar(i) ? "D"
							: "Ljava/lang/Object;";
		...
		if (fnCurrent == null) {
			...
			if (fnCurrent.itsContainsCalls0) {
				...
				cfw.add(ByteCode.GETSTATIC,
						"org/mozilla/javascript/ScriptRuntime", "emptyArgs",
						"[Ljava/lang/Object;");
	...
	private void generateSetGeneratorResumptionPoint(int nextState) {
		...
		cfw.add(ByteCode.PUTFIELD, OptRuntime.GeneratorState.CLASS_NAME,
				OptRuntime.GeneratorState.resumptionPoint_NAME,
				OptRuntime.GeneratorState.resumptionPoint_TYPE);
	}
	...
	private void generateEpilogue() {
		...
		if (isGenerator) {
			...
			Map<Node, int[]> liveLocals = ((FunctionNode) scriptOrFn)
					.getLiveLocals();
			if (liveLocals != null) {
				List<Node> nodes = ((FunctionNode) scriptOrFn)
						.getResumptionPoints();
	...
	private void generateStatement(Node node) {
		...
		case Token.CATCH_SCOPE: {
			...
			addScriptRuntimeInvoke("newCatchScope", "(Ljava/lang/Throwable;"
					+ "Lorg/mozilla/javascript/Scriptable;"
					+ "Ljava/lang/String;" + "Lorg/mozilla/javascript/Context;"
					+ "Lorg/mozilla/javascript/Scriptable;"
					+ ")Lorg/mozilla/javascript/Scriptable;");
			cfw.addAStore(local);
		}
		...
		case Token.ENUM_INIT_ARRAY:
			...
			addScriptRuntimeInvoke("enumInit",
					"(Ljava/lang/Object;" + "Lorg/mozilla/javascript/Context;"
							+ "Lorg/mozilla/javascript/Scriptable;" + "I"
							+ ")Ljava/lang/Object;");
		...
		case Token.EXPR_VOID:
			if (child.getType() == Token.SETVAR) {
				/*
				 * special case this so as to avoid unnecessary load's & pop's
				 */
	...
	private void generateIntegerUnwrap() {
		cfw.addInvoke(ByteCode.INVOKEVIRTUAL, "java/lang/Integer", "intValue",
				"()I");
	}
	...
	private void generateThrowJavaScriptException() {
		...
		cfw.addInvoke(ByteCode.INVOKESPECIAL,
				"org/mozilla/javascript/JavaScriptException", "<init>",
	...
	private void generateExpression(Node node, Node parent) {
		...
		case Token.REF_CALL:
			...
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke("callRef",
					"(Lorg/mozilla/javascript/Callable;"
							+ "Lorg/mozilla/javascript/Scriptable;"
							+ "[Ljava/lang/Object;"
							+ "Lorg/mozilla/javascript/Context;"
		...
		case Token.TRUE:
			cfw.add(ByteCode.GETSTATIC, "java/lang/Boolean", "TRUE",
					"Ljava/lang/Boolean;");
			break;

		case Token.FALSE:
			cfw.add(ByteCode.GETSTATIC, "java/lang/Boolean", "FALSE",
					"Ljava/lang/Boolean;");
			break;
		...
		case Token.REGEXP: {
			...
			cfw.add(ByteCode.GETSTATIC, codegen.mainClassName,
					...
					"Ljava/lang/Object;");
			cfw.addInvoke(ByteCode.INVOKESTATIC,
					"org/mozilla/javascript/ScriptRuntime", "wrapRegExp",
					"(Lorg/mozilla/javascript/Context;"
							+ "Lorg/mozilla/javascript/Scriptable;"
							+ "Ljava/lang/Object;"
							+ ")Lorg/mozilla/javascript/Scriptable;");
		...
		case Token.ENUM_ID: {
			...
			if (type == Token.ENUM_NEXT) {
				addScriptRuntimeInvoke("enumNext",
		...
		case Token.MOD:
			visitArithmetic(node,
					type == Token.DIV ? ByteCode.DDIV : ByteCode.DREM, child,
					parent);
			break;
		...
		case Token.GETELEM:
			...
			cfw.addALoad(contextLocal);
			if (node.getIntProp(Node.ISNUMBER_PROP, -1) != -1) {
				addScriptRuntimeInvoke("getObjectIndex",
						"(Ljava/lang/Object;D"
								+ "Lorg/mozilla/javascript/Context;"
								+ ")Ljava/lang/Object;");
			} else {
				cfw.addALoad(variableObjectLocal);
				addScriptRuntimeInvoke("getObjectElem",
						"(Ljava/lang/Object;" + "Ljava/lang/Object;"
								+ "Lorg/mozilla/javascript/Context;"
								+ "Lorg/mozilla/javascript/Scriptable;"
								+ ")Ljava/lang/Object;");
		...
		case Token.SET_REF_OP: {
			...
			cfw.addALoad(contextLocal);
			cfw.addALoad(variableObjectLocal);
			addScriptRuntimeInvoke("refSet",
					"(Lorg/mozilla/javascript/Ref;" + "Ljava/lang/Object;"
							+ "Lorg/mozilla/javascript/Context;"
							+ "Lorg/mozilla/javascript/Scriptable;"
							+ ")Ljava/lang/Object;");
		}
		...
		case Token.REF_SPECIAL: {
			...
			cfw.addALoad(contextLocal);
			cfw.addALoad(variableObjectLocal);
			addScriptRuntimeInvoke("specialRef",
					"(Ljava/lang/Object;" + "Ljava/lang/String;"
							+ "Lorg/mozilla/javascript/Context;"
							+ "Lorg/mozilla/javascript/Scriptable;"
							+ ")Lorg/mozilla/javascript/Ref;");
		...
		case Token.REF_NS_NAME: {
			...
			case Token.REF_MEMBER:
				...
				signature = "(Ljava/lang/Object;" + "Ljava/lang/Object;"
						+ "Lorg/mozilla/javascript/Context;" + "I"
						+ ")Lorg/mozilla/javascript/Ref;";
				break;
			case Token.REF_NS_MEMBER:
				methodName = "memberRef";
	...
	private void generateYieldPoint(Node node, boolean exprContext) {
		...
		generateCheckForThrowOrClose(getTargetLabel(node), hasLocals,
				nextState);
	...
	private void visitFunction(OptFunctionNode ofn, int functionType) {
		...
		addOptRuntimeInvoke("initFunction",
				"(Lorg/mozilla/javascript/NativeFunction;" + "I"
						+ "Lorg/mozilla/javascript/Scriptable;"
						+ "Lorg/mozilla/javascript/Context;" + ")V");
	}
	...
	private void generateArrayLiteralFactory(Node node, int count) {
		String methodName = codegen.getBodyMethodName(scriptOrFn) + "_literal"
				+ count;
		initBodyGeneration();
		argsLocal = firstFreeLocal++;
		localsMax = firstFreeLocal;
		cfw.startMethod(methodName, "(Lorg/mozilla/javascript/Context;"
				+ "Lorg/mozilla/javascript/Scriptable;"
				+ "Lorg/mozilla/javascript/Scriptable;" + "[Ljava/lang/Object;"
				+ ")Lorg/mozilla/javascript/Scriptable;", ACC_PRIVATE);
	...
	private void visitArrayLiteral(Node node, Node child, boolean topLevel) {
		...
		if (!topLevel && (count > 10 || cfw.getCurrentCodeOffset() > 30000)
			...
			String methodName = codegen.getBodyMethodName(scriptOrFn)
					+ "_literal" + literals.size();
			cfw.addALoad(funObjLocal);
			cfw.addALoad(contextLocal);
			cfw.addALoad(variableObjectLocal);
			cfw.addALoad(thisObjLocal);
			cfw.addALoad(argsLocal);
			cfw.addInvoke(ByteCode.INVOKEVIRTUAL, codegen.mainClassName,
					methodName,
					"(Lorg/mozilla/javascript/Context;"
							+ "Lorg/mozilla/javascript/Scriptable;"
							+ "Lorg/mozilla/javascript/Scriptable;"
	...
	private void visitSpecialCall(Node node, int type, int specialType,
		...
		if (type == Token.NEW) {
			...
			callSignature = "(Lorg/mozilla/javascript/Context;"
					+ "Ljava/lang/Object;" + "[Ljava/lang/Object;"
					+ "Lorg/mozilla/javascript/Scriptable;"
					+ "Lorg/mozilla/javascript/Scriptable;" + "I" // call type
					+ ")Ljava/lang/Object;";
			cfw.addALoad(variableObjectLocal);
			cfw.addALoad(thisObjLocal);
	...
	private void visitStandardNew(Node node, Node child) {
		...
		generateCallArgArray(node, firstArgChild, false);
		addScriptRuntimeInvoke("newObject",
				"(Ljava/lang/Object;" + "Lorg/mozilla/javascript/Context;"
						+ "Lorg/mozilla/javascript/Scriptable;"
						+ "[Ljava/lang/Object;"
						+ ")Lorg/mozilla/javascript/Scriptable;");
	...
	private void visitOptimizedCall(Node node, OptFunctionNode target, int type,
			Node child) {
		Node firstArgChild = child.getNext();
		 ...
		 * in the aReg and the number is the dReg Else pass the JS object in the
		 * aReg and 0.0 in the dReg.
		 */
		...
		while (argChild != null) {
			...
			} else if (argChild.getIntProp(Node.ISNUMBER_PROP,
					-1) == Node.BOTH) {
				cfw.add(ByteCode.GETSTATIC, "java/lang/Void", "TYPE",
						"Ljava/lang/Class;");
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC, codegen.mainClassName,
				(type == Token.NEW) ? codegen.getDirectCtorName(target.fnode)
		...
		for (int i = 0; i != argCount; ++i) {
			...
			if (!directCall) {
				...
				if (dcp_register >= 0) {
					...
					generateExpression(argChild, node);
					int childNumberFlag = argChild
							.getIntProp(Node.ISNUMBER_PROP, -1);
	...
	private void generateFunctionAndThisObj(Node node, Node parent) {
		...
		case Token.GETELEM: {
			...
			if (type == Token.GETPROP) {
				...
				cfw.addALoad(contextLocal);
				cfw.addALoad(variableObjectLocal);
				addScriptRuntimeInvoke("getElemFunctionAndThis",
						"(Ljava/lang/Object;" + "Ljava/lang/Object;"
								+ "Lorg/mozilla/javascript/Context;"
								+ "Lorg/mozilla/javascript/Scriptable;"
								+ ")Lorg/mozilla/javascript/Callable;");
		...
		default: // including GETVAR
			generateExpression(node, parent);
			cfw.addALoad(contextLocal);
			addScriptRuntimeInvoke("getValueFunctionAndThis",
					"(Ljava/lang/Object;" + "Lorg/mozilla/javascript/Context;"
							+ ")Lorg/mozilla/javascript/Callable;");
			break;
		}
		...
		cfw.addALoad(contextLocal);
		addScriptRuntimeInvoke("lastStoredScriptable",
				"(Lorg/mozilla/javascript/Context;"
						+ ")Lorg/mozilla/javascript/Scriptable;");
	}
	...
	private void visitTryCatchFinally(Jump node, Node child) {
		/*
		 * Save the variable object, in case there are with statements enclosed
		 * by the try block and we catch some exception. We'll restore it for
		 * the catch block so that catch block statements get the right scope.
		 */
		...
		if (catchTarget != null) {
			...
			/*
			 * we also need to catch EcmaErrors and feed the associated error
	...
	private void generateCatchBlock(int exceptionType,
			short savedVariableObject, int catchLabel, int exceptionLocal,
			int handler) {
		if (handler == 0) {
	 ...
	 * finally block on the exception state stack is being inlined and skips the
	 * proper exception handlers until the finally block is generated.
	 */
	private class ExceptionManager {
		 ...
		 *
		 * @param exceptionType
		 *            one of the integer constants representing an exception
		 *            type
		 * @param handlerLabel
		 ...
		 *
		 * @param handlerLabels
		 *            a map from integer constants representing an exception
		 *            type to the label of the exception handler
		 * @param startLabel
		 ...
		 *            type
		 * @param endLabel
		 *            a label representing the end of the last bytecode that
		 ...
		 * block, we stop the handlers at the beginning of the finally block and
		 * set it as the finally block that has stopped the handlers. This
		 * prevents other inlined finally blocks from prematurely ending skip
		 * ranges and creating bad exception handler ranges.
		 *
		 * @param finallyBlock
		 *            the finally block that is being inlined
		 * @param finallyStart
		...
		void markInlineFinallyStart(Node finallyBlock, int finallyStart) {
			...
			ListIterator<ExceptionInfo> iter = exceptionInfo
					.listIterator(exceptionInfo.size());
		 ...
		 */
		private void endCatch(ExceptionInfo ei, int exceptionType,
				int catchEnd) {
			...
			if (currentStartPC != catchEndPC) {
				cfw.addExceptionHandler(ei.exceptionStarts[exceptionType],
						catchEnd, ei.handlerLabels[exceptionType],
						exceptionTypeToName(exceptionType));
			}
		}
	 ...
	 * block as implemented in the bytecode. This is because in some cases, the
	 * finally block really starts before any of the code in the Node. For
	 * example, the catch-all-rethrow finally block has a few instructions prior
	 * to the finally block made by the user.
	 *
	 * In addition, an end label that should be unmarked is given as a method
	 * parameter. It is the responsibility of any callers of this method to mark
	 * the label.
	 *
	 ...
	 *
	 * @param finallyTarget
	 *            a TARGET node directly preceding a FINALLY node or a FINALLY
	 *            node itself
	 * @param finallyStart
	 *            a pre-marked label that indicates the actual start of the
	 *            finally block in the bytecode.
	 * @param finallyEnd
	 *            an unmarked label that will indicate the actual end of the
	 *            finally block in the bytecode.
	 */
	...
	/**
	 * Save the current code offset. This saved code offset is used to compute
	 * instruction counts in subsequent calls to {@link #addInstructionCount()}.
	 */
	 ...
	 * executed instructions and call <code>observeInstructionCount()</code> if
	 * a threshold is exceeded.<br>
	 ...
	 * other blocks that don't have any ops - this allows for monitoring/killing
	 * of while(true) loops and such.
	 */
	...
	private void visitIncDec(Node node) {
		...
		case Token.GET_REF: {
			...
			cfw.addALoad(variableObjectLocal);
			cfw.addPush(incrDecrMask);
			addScriptRuntimeInvoke("refIncrDecr",
					"(Lorg/mozilla/javascript/Ref;"
							+ "Lorg/mozilla/javascript/Context;"
							+ "Lorg/mozilla/javascript/Scriptable;"
							+ "I)Ljava/lang/Object;");
	...
	private static boolean isArithmeticNode(Node node) {
		int type = node.getType();
		return (type == Token.SUB) || (type == Token.MOD) || (type == Token.DIV)
				|| (type == Token.MUL);
	}
	...
	private int nodeIsDirectCallParameter(Node node) {
		if (node.getType() == Token.GETVAR && inDirectCallFunction
	...
	private boolean varIsDirectCallParameter(int varIndex) {
		return fnCurrent.isParameter(varIndex) && inDirectCallFunction
				&& !itsForcedObjectParameters;
	}
	...
	private void visitIfJumpEqOp(Node node, Node child, int trueGOTO,
		...
		if (child.getType() == Token.NULL || rChild.getType() == Token.NULL) {
			...
			if (type == Token.SHEQ || type == Token.SHNE) {
				int testCode = (type == Token.SHEQ) ? ByteCode.IFNULL
						: ByteCode.IFNONNULL;
	...
	private void visitStrictSetName(Node node, Node child) {
		...
		cfw.addALoad(variableObjectLocal);
		cfw.addPush(name);
		addScriptRuntimeInvoke("strictSetName",
				"(Lorg/mozilla/javascript/Scriptable;" + "Ljava/lang/Object;"
						+ "Lorg/mozilla/javascript/Context;"
						+ "Lorg/mozilla/javascript/Scriptable;"
						+ "Ljava/lang/String;" + ")Ljava/lang/Object;");
	...
	private void visitSetConst(Node node, Node child) {
		...
		cfw.addALoad(contextLocal);
		cfw.addPush(name);
		addScriptRuntimeInvoke("setConst",
				"(Lorg/mozilla/javascript/Scriptable;" + "Ljava/lang/Object;"
						+ "Lorg/mozilla/javascript/Context;"
						+ "Ljava/lang/String;" + ")Ljava/lang/Object;");
	}
	...
	private void visitGetProp(Node node, Node child) {
		...
		/*
		 * for 'this.foo' we call getObjectProp(Scriptable...) which can skip
		 * some casting overhead.
		 */
		int childType = child.getType();
	...
	private void visitSetElem(int type, Node node, Node child) {
		...
		cfw.addALoad(variableObjectLocal);
		if (indexIsNumber) {
			addScriptRuntimeInvoke("setObjectIndex",
					"(Ljava/lang/Object;" + "D" + "Ljava/lang/Object;"
							+ "Lorg/mozilla/javascript/Context;"
							+ "Lorg/mozilla/javascript/Scriptable;"
							+ ")Ljava/lang/Object;");
		} else {
			addScriptRuntimeInvoke("setObjectElem",
					"(Ljava/lang/Object;" + "Ljava/lang/Object;"
							+ "Ljava/lang/Object;"
							+ "Lorg/mozilla/javascript/Context;"
							+ "Lorg/mozilla/javascript/Scriptable;"
	...
	private void visitDotQuery(Node node, Node child) {
		...
		addScriptRuntimeInvoke("updateDotQuery",
				"(Z" + "Lorg/mozilla/javascript/Scriptable;"
						+ ")Ljava/lang/Object;");
		cfw.add(ByteCode.DUP);
	...
	private void addScriptRuntimeInvoke(String methodName,
		...
		cfw.addInvoke(ByteCode.INVOKESTATIC,
				"org.mozilla.javascript.ScriptRuntime", methodName,
				methodSignature);
	}
	...
	private void addOptRuntimeInvoke(String methodName,
			String methodSignature) {
		cfw.addInvoke(ByteCode.INVOKESTATIC,
				"org/mozilla/javascript/optimizer/OptRuntime", methodName,
				methodSignature);
	}
	 ...
	 * 
	 * @param isConst
	 *            true iff the variable is const
