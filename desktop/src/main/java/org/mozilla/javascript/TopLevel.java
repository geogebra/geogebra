 ...
 *
 * <p>
 * ECMA 262 requires that most constructors used internally construct objects
 * with the original prototype object as value of their [[Prototype]] internal
 * property. Since built-in global constructors are defined as writable and
 * deletable, this means they should be cached to protect against redefinition
 * at runtime.
 * </p>
 *
 * <p>
 ...
 * {@link ScriptRuntime#setBuiltinProtoAndParent
 ...
 *
 * <p>
 * Calling {@link org.mozilla.javascript.Context#initStandardObjects()} with an
 * instance of this class as argument will automatically cache built-in classes
 * after initialization. For other setups involving top-level scopes that
 * inherit global properties from their proptotypes (e.g. with dynamic scopes)
 * embeddings should explicitly call {@link #cacheBuiltins()} to initialize the
 * class cache for each top-level scope.
 * </p>
 */
public class TopLevel extends IdScriptableObject {
	 ...
	 * {@link ScriptRuntime#initStandardObjects
	 ...
	 * scope is not initialized through <code>initStandardObjects()</code>.
	 */
	 ...
	 */
	public static Function getBuiltinCtor(Context cx, Scriptable scope,
			Builtins type) {
	 ...
	 * <code>type</code> from the given <code>scope</code>. If the scope is not
	 * an instance of this class or does have a cache of native errors, the
	 * constructor is looked up via normal property lookup.
	 *
	 * @param cx
	 *            the current Context
	 ...
	 * <code>type</code>. Returns null if {@link #cacheBuiltins()} has not been
	...
	/**
	 * Get the cached native error constructor from this scope with the given
	 * <code>type</code>. Returns null if {@link #cacheBuiltins()} has not been
	 * called on this object.
	 * 
	 * @param type
