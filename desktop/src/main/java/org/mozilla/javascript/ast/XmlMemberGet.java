...
/**
 * AST node for E4X ".@" and ".." expressions, such as {@code foo..bar},
 * {@code foo..@bar}, {@code @foo.@bar}, and {@code foo..@ns::*}. The right-hand
 * node is always an {@link XmlRef}.
 * <p>
 *
...
public class XmlMemberGet extends InfixExpression {
	...
	/**
	 * Constructs a new {@code XmlMemberGet} node. Updates bounds to include
	 * {@code target} and {@code ref} nodes.
	 */
	 ...
	 * evaluated. Should never be {@code null}.
	 */
	...
	/**
	 * Returns the right-side XML member ref expression. Should never be
	 * {@code null} unless the code is malformed.
	 */
