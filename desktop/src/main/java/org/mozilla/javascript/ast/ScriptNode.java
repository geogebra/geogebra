...
public class ScriptNode extends Scope {
	...
	/**
	 * Sets the URI, path or descriptive text indicating the origin of this
	 * script's source code.
	 */
	...
	/**
	 * Returns the start offset of the encoded source. Only valid if
	 * {@link #getEncodedSource} returns non-{@code null}.
	 */
	...
	/**
	 * Returns the end offset of the encoded source. Only valid if
	 * {@link #getEncodedSource} returns non-{@code null}.
	 */
	 ...
	 * for use in implementing the {@code Object.toSource} method of JavaScript
	 * objects. This source encoding is only recorded during code generation. It
	 * must be passed back to
	...
	/**
	 * Sets base (starting) line number for this script or function. This is a
	 * one-time operation, and throws an exception if the line number has
	 * already been set.
	 */
	...
	/**
	 * Adds a {@link FunctionNode} to the functions table for codegen. Does not
	 ...
	 *
	 * @param flattenAllTables
	 *            if true, flatten all symbol tables, included nested block
	 *            scope symbol tables. If false, just flatten the script's or
