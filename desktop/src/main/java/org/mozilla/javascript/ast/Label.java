...
/**
 * AST node representing a label. It is a distinct node type so it can record
 * its length and position for code-processing tools. Node type is
 * {@link Token#LABEL}.
 * <p>
 */
public class Label extends Jump {
	 ...
	 *             if name is {@code null} or the empty string.
	 */
