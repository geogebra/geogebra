...
public class XmlLiteral extends AstNode {
	...
	/**
	 * Sets fragment list, removing any existing fragments first. Sets the
	 * parent pointer for each fragment in the list to this node.
	 * 
	 * @param fragments
	 *            fragment list. Replaces any existing fragments.
	 * @throws IllegalArgumentException}
	 *             if {@code fragments} is {@code null}
	 */
