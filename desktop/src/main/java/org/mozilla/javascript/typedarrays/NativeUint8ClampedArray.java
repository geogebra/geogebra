 ...
 * "Uint8ClampedArray" interface. It also implements List<Integer> for direct
 * manipulation in Java. Bytes inserted that fall out of the range (0 <= X <
 * 256) will be adjusted so that they match before insertion.
 */
