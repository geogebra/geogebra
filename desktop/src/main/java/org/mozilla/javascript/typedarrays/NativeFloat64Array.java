...
/**
 * An array view that stores 64-bit quantities and implements the JavaScript
 * "Float64Array" interface. It also implements List<Double> for direct
...
public class NativeFloat64Array extends NativeTypedArrayView<Double> {
	...
	protected Object js_get(int index) {
		...
		long base = ByteIo.readUint64Primitive(arrayBuffer.buffer,
	...
	protected Object js_set(int index, Object c) {
		...
		ByteIo.writeUint64(arrayBuffer.buffer,
				(index * BYTES_PER_ELEMENT) + offset, base, false);
		return null;
	}
