...
/**
 * An array view that stores 32-bit quantities and implements the JavaScript
 * "Uint32Array" interface. It also implements List<Long> for direct
...
public class NativeUint32Array extends NativeTypedArrayView<Long> {
	...
	@Override
	protected NativeTypedArrayView construct(NativeArrayBuffer ab, int off,
			int len) {
	...
	@Override
	protected NativeTypedArrayView realThis(Scriptable thisObj,
			IdFunctionObject f) {
	...
	protected Object js_get(int index) {
		...
		return ByteIo.readUint32(arrayBuffer.buffer,
				(index * BYTES_PER_ELEMENT) + offset, false);
	}
	...
	protected Object js_set(int index, Object c) {
		...
		ByteIo.writeUint32(arrayBuffer.buffer,
				(index * BYTES_PER_ELEMENT) + offset, val, false);
		return null;
	}
