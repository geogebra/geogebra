			...
			public Object invoke(Object proxy, Method method, Object[] args) {
				...
				if (method.getDeclaringClass() == Object.class) {
					...
					if (methodName.equals("equals")) {
						Object other = args[0];
						// Note: we could compare a proxy and its wrapped
						// function
						// as equal here but that would break symmetry of
						// equal().
						// The reason == suffices here is that proxies are
						// cached
						// in ScriptableObject (see
				...
				return adapter.invoke(cf, target, topScope, proxy, method,
						args);
			}
		};
		Object proxy;
