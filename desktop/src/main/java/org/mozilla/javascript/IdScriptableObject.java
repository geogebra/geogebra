...
public abstract class IdScriptableObject extends ScriptableObject
	 ...
	 * 
	 * @param f
	 *            function that is attempting to convert 'this' object.
	...
	@Override
	public void defineOwnProperty(Context cx, Object key,
		...
		if (key instanceof String) {
			...
			if (info != 0) {
				...
				if (isAccessorDescriptor(desc)) {
					...
					ScriptableObject current = getOwnPropertyDescriptor(cx,
							key);
