...
final class NativeNumber extends IdScriptableObject {
	...
	protected void fillConstructorProperties(IdFunctionObject ctor) {
		...
		ctor.defineProperty("MAX_SAFE_INTEGER",
				ScriptRuntime.wrapNumber(MAX_SAFE_INTEGER), attr);
		ctor.defineProperty("MIN_SAFE_INTEGER",
				ScriptRuntime.wrapNumber(MIN_SAFE_INTEGER), attr);

		addIdFunctionProperty(ctor, NUMBER_TAG, ConstructorId_isFinite,
				"isFinite", 1);
		addIdFunctionProperty(ctor, NUMBER_TAG, ConstructorId_isNaN, "isNaN",
				1);
		addIdFunctionProperty(ctor, NUMBER_TAG, ConstructorId_isInteger,
				"isInteger", 1);
		addIdFunctionProperty(ctor, NUMBER_TAG, ConstructorId_isSafeInteger,
				"isSafeInteger", 1);
		addIdFunctionProperty(ctor, NUMBER_TAG, ConstructorId_parseFloat,
				"parseFloat", 1);
		addIdFunctionProperty(ctor, NUMBER_TAG, ConstructorId_parseInt,
				"parseInt", 1);
	...
	public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope,
		...
		case Id_toLocaleString: {
			...
			int base = (args.length == 0 || args[0] == Undefined.instance) ? 10
	...
	private boolean isDoubleSafeInteger(Double d) {
		return (isDoubleInteger(d) && (d.doubleValue() <= MAX_SAFE_INTEGER)
	...
	private static final int ConstructorId_isFinite = -1,
			ConstructorId_isNaN = -2, ConstructorId_isInteger = -3,
			ConstructorId_isSafeInteger = -4, ConstructorId_parseFloat = -5,
			ConstructorId_parseInt = -6,

			Id_constructor = 1, Id_toString = 2, Id_toLocaleString = 3,
			Id_toSource = 4, Id_valueOf = 5, Id_toFixed = 6,
			Id_toExponential = 7, Id_toPrecision = 8, MAX_PROTOTYPE_ID = 8;
