...
public interface ClassShutter {
	 ...
	 * attempts to load class "a", then attempts to load class "a.b", then
	 * finally attempts to load class "a.b.c". On a Rhino installation without
	 * any ClassShutter set, and without any of the above classes, the
	 * expression "Packages.a.b.c" will result in a [JavaPackage a.b.c] and not
	 * an error.
	 * <p>
	 ...
	 * assumes the class is not present. So for "java.lang.System.out.println"
	 * the lookup of "java.lang.System" is skipped and thus Rhino assumes that
	 * "java.lang.System" doesn't exist. So then for "java.lang.System.out",
	 * Rhino attempts to load the class "java.lang.System.out" because it
	 * assumes that "java.lang.System" is a package name.
	 * <p>
	 * 
	 * @param fullClassName
	 *            the full name of the class (including the package name, with
	 *            '.' as a delimiter). For example the standard string class is
	 *            "java.lang.String"
