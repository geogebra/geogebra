...
public abstract class RendererGL2 extends RendererD
	...
	protected void setGLForPicking() {
		...
		jogl.getGL2().glDisable(GL2ES1.GL_ALPHA_TEST);
		jogl.getGL2().glDisable(GL.GL_BLEND);
		disableLighting();
		disableTextures();
