 ...
 *
 */
public abstract class RendererDToPushDown extends Renderer implements GLEventListener {
	 ...
	 */
	public RendererDToPushDown(EuclidianView3D view, boolean useCanvas, RendererType type) {
		super(view, type);
