...
public interface PlugLetIF {
	 ...
	 * 
	 * @param api
	 *            The API the plugin can use
	 * @param args
	 *            The args given in plugin.properties
	 */
	public void init(GgbAPID api, String args);

	/**
	 * The method to run the plugin program Called by choosing in menu.
	 */
	public void execute();

	/**
	 * For possible future use More natural in Runnable/Threads
	 */
	public void start();
