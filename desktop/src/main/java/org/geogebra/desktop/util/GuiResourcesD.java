...
public enum GuiResourcesD implements ImageResourceD {
	...
	STYLEBAR_START_ARROW("org/geogebra/common/icons/svg/common/start_arrow.svg"),

	STYLEBAR_START_ARROW_FILLED("org/geogebra/common/icons/svg/common/start_arrow_filled.svg"),

	STYLEBAR_START_CIRCLE("org/geogebra/common/icons/svg/common/start_circle.svg"),

	STYLEBAR_START_CIRCLE_OUTLINED("org/geogebra/common/icons/svg/common/start_circle_outlined.svg"),

	STYLEBAR_START_DEFAULT("org/geogebra/common/icons/svg/common/start_default.svg"),

	STYLEBAR_START_LINE("org/geogebra/common/icons/svg/common/start_line.svg"),

	STYLEBAR_START_SQUARE("org/geogebra/common/icons/svg/common/start_square.svg"),

	STYLEBAR_START_SQUARE_OUTLINED("org/geogebra/common/icons/svg/common/start_square_outlined.svg"),
