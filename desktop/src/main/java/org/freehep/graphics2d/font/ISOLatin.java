...
public class ISOLatin extends AbstractCharTable {
	...
	public ISOLatin() {
		...
		nameToEnc.put("breve", Integer.valueOf(150));
		encToName[150] = "breve";
		...
		nameToEnc.put("caron", Integer.valueOf(159));
		encToName[159] = "caron";
		...
		nameToEnc.put("circumflex", Integer.valueOf(147));
		...
		nameToEnc.put("divide", Integer.valueOf(183));
		...
		nameToEnc.put("dotaccent", Integer.valueOf(151));
		...
		nameToEnc.put("dotlessi", Integer.valueOf(144));
		...
		nameToEnc.put("grave", Integer.valueOf(145));
		encToName[145] = "grave";
		...
		nameToEnc.put("hungarumlaut", Integer.valueOf(157));
		...
		nameToEnc.put("hyphen", Integer.valueOf(173));
		...
		nameToEnc.put("ogonek", Integer.valueOf(158));
		...
		nameToEnc.put("ring", Integer.valueOf(154));
		encToName[154] = "ring";
		...
		nameToEnc.put("tilde", Integer.valueOf(148));
		encToName[148] = "tilde";
