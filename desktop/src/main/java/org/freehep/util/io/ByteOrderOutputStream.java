...
public class ByteOrderOutputStream extends BitOutputStream implements
     ...
     * @throws IOException if write fails FIXME, should this throw an exception ?
     */
     ...
     * 
     * @param bytes int array to write as bytes
     * @throws IOException if write fails
     */
     ...
     * 
     * @param shorts short array to write
     * @throws IOException if write fails
     */
     ...
     * 
     * @param s int to write as unsigned short
     * @throws IOException if write fails
     */
     ...
     * 
     * @param shorts int array to write as unsigned shorts
     * @throws IOException if write fails
     */
     ...
     * 
     * @param i long to write as unsigned int
     * @throws IOException if write fails
     */
     ...
     * 
     * @param ints long array to write as unsigned ints
     * @throws IOException if write fails
     */
