...
public abstract class AlgoPolyhedronNet extends AlgoElement3D {
	...
	protected abstract void setOutputSideTop(int n, GeoPolygon3D polygon, int step, GeoSegmentND[] segments);
	 ...
	 */
	protected void rotate(GeoPoint3D point, Coords pointCoords, Coords projectCoords,  Coords o, Coords vs, double f, Coords fd, double dist, boolean test){
