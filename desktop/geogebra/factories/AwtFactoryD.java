...
public class AwtFactoryD extends AwtFactory {
	...
	public GBasicStroke newMyBasicStroke(float f) {
		return new geogebra.awt.GBasicStrokeD(f, GBasicStroke.CAP_ROUND,
	...
	public GBasicStroke newBasicStrokeJoinMitre(float f) {
		return new geogebra.awt.GBasicStrokeD(f, GBasicStroke.CAP_SQUARE,
	...
	public GAlphaComposite newAlphaComposite(int rule, float alpha) {
		return new geogebra.awt.GAlphaCompositeD(
	...
	@Override
	public geogebra.euclidian.event.ActionListenerD newActionListener(
