...
public class WorksheetExportDialog extends JDialog {
				...
				Thread runner = new Thread() {
					public void run() {
						...
						if(modeSwitch.getSelectedIndex() == TAB_HTML) {
							...
							GeoGebraTubeExportGUI ggtExport = new GeoGebraTubeExportGUI(app);
	...
	public String getAppletTag(Application app, File ggbFile, int width,
		...
		if (includeHTML5) {
			appendWithLineBreak(sb,	"<script type=\"text/javascript\" language=\"javascript\" src=\"http://www.geogebra.org/web/xs/web/web.nocache.js\"></script>");
