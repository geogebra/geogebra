...
public class LaTeXPanel extends JPanel {
	...
	private Dimension drawEquationToImage() {
		...
		geogebra.common.awt.GDimension fd = app.getDrawEquation().drawEquation(
				app, null, new geogebra.awt.GGraphics2DD(g2image), 0, 0, latex,
				app.getPlainFontCommon(), false,
				new geogebra.awt.GColorD(getForeground()),
				new geogebra.awt.GColorD(getBackground()), true, false);
	...
	public void paint(Graphics g) {
		if (app.exporting) {
			...
			app.getDrawEquation().drawEquation(app, null,
					new geogebra.awt.GGraphics2DD((Graphics2D) g), 0, 0, latex,
					app.getPlainFontCommon(), false,
					new geogebra.awt.GColorD(getForeground()),
					new geogebra.awt.GColorD(getBackground()), true, false);
		} else {
