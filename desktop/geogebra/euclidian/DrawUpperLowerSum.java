        ...
        if (isVisible) {
        	try {
	            if (geo.doHighlighting()) {
	                g2.setPaint(geogebra.awt.Color.getAwtColor((geogebra.awt.Color) sum.getSelColor()));
			...
			try {
				if (geo.lineThickness > 0) {
					g2.setPaint(geogebra.awt.Color.getAwtColor((geogebra.awt.Color) sum.getObjectColor()));
