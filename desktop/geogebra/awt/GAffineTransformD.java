...
public class GAffineTransformD implements geogebra.common.awt.GAffineTransform {
	...
	public static java.awt.geom.AffineTransform getAwtAffineTransform(
			geogebra.common.awt.GAffineTransform a) {
	...
	public GShape createTransformedShape(geogebra.common.awt.GShape shape) {
		...
		ret = at.createTransformedShape(geogebra.awt.GGenericShapeD
				.getAwtShape(shape));
		return new geogebra.awt.GGenericShapeD(ret);
	}

	public GPoint2D transform(geogebra.common.awt.GPoint2D p,
			geogebra.common.awt.GPoint2D p2) {
