...
public class GArc2DD extends geogebra.common.awt.GArc2D implements GRectangularShapeD{
	...
	public GPoint2D getStartPoint() {
		...
		return new geogebra.awt.GPoint2DD((java.awt.geom.Point2D.Double)impl.getStartPoint());
	}

	@Override
	public GPoint2D getEndPoint() {
		return new geogebra.awt.GPoint2DD((java.awt.geom.Point2D.Double)impl.getEndPoint());
	}
