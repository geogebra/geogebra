...
public class Hangul  extends Frame
{
	...
	Hangul()	{
		...
		setTitle("\uD55C\uAE00 \uC624\uD1A0\uB9C8\uD0C0 - \uB2E4\uBE44\uB3C4\uD504\uD321");                   /********* \uD0C0\uC774\uD2C0 \uBA85 -> \uD559\uBC88 & \uC774\uB984 ***********/
		setVisible(true);
	...
	String choSungs_ = " \u3131\u3134 \u3145\u3132 \u3141\u314B \u3137\u3148\u3147\u3139\u3142 \u314C\u314A\u3138\u3146\u3143\u314D\u314E";		/*** \uCD08\uC131 \uC0C1\uD0DC\uBCC4 \uAC12  ***/
                      //01 2 34 5 67 8 91 1 1 1 1 11 1 1 1 2 2 2
                      //                0 1 2 3 4 56 7 8 9 0 1 2
	int choState_ = 0;		// \uCD08\uC131 \uCD08\uAE30\uC0C1\uD0DC
	
	/************************* \uCD08\uC131 \uC0C1\uD0DC \uBCC0\uD654\uD568\uC218 START***********************/  // \uC218\uC815\uD544\uC694
	void moveCho(int num) {
		if (num >= 5 && num <= 8) return;  // \uB9CC\uC57D \uBAA8\uC74C\uC774 \uB4E4\uC5B4\uC654\uB2E4\uBA74 \uB418\uB3CC\uC544\uAC04\uB2E4
		if (0 <= choState_ && choState_ <= 22)  {
			choState_ = choTransTable[choState_][num];
			state_ = 1;
			if (choState_ < 0) {   // choState_\uAC00 0\uBCF4\uB2E4 \uC791\uB2E4\uBA74 \uC5D0\uB7EC -> \uB9AC\uC14B, \uC5D0\uB7EC\uBA54\uC138\uC9C0\uB97C \uBCF4\uB0B8\uB2E4.
				reset();
				setError();
			} else cho_.setText(""+choSungs_.charAt(choState_));
		} 
		else {
			reset();
			setError();
	...
	void moveJung(int num) {
		if (num >= 4 && num <= 7) {
			...
			if (jungState_ == -1) {
				reset();
				setError();
			} else jung_.setText(""+jungSungs_.charAt(jungState_));
		}
	}
	/************************* \uC911\uC131 \uC0C1\uD0DC \uBCC0\uD654\uD568\uC218 END***********************/
	...
	String jongSungs_ = " \u3131\u3134 \u3145\u3132 \u3141\u314B \u3137\u3148\u3147\u3139\u3142 \u314C\u314A\u3138\u3146\u3143\u314D\u314E\u3133\u3135\u3136\u313A\u313B\u313C\u313D \u313E\u313F\u3140\u3144";		/*** \uC885\uC131 \uC0C1\uD0DC\uBCC4 \uAC12  ***/
	...
	/************************* \uC885\uC131 \uC0C1\uD0DC \uBCC0\uD654\uD568\uC218 START***********************/  // \uC218\uC815\uD544\uC694
	int moveJong(int num) {
		if (0 <= jongState_ && jongState_ <= 34)  {
			jongState_ = jongTransTable[jongState_][num];
			state_ = 3;
			if (jongState_ < 0) {   // jongState_\uAC00 0\uBCF4\uB2E4 \uC791\uB2E4\uBA74 \uC5D0\uB7EC -> \uB9AC\uC14B, \uC5D0\uB7EC\uBA54\uC138\uC9C0\uB97C \uBCF4\uB0B8\uB2E4.
				reset();
				setError();
			} else jong_.setText(""+jongSungs_.charAt(jongState_));
		} 
		else {
			reset();
			setError();
	...
	// \uD604\uC7AC \uCD08\uC131, \uC911\uC131\uC774 \uBC1B\uC544\uB4E4\uC5EC\uC9C4 \uC0C1\uD0DC\uC778\uAC00\uB97C \uB098\uD0C0\uB0C4
	int state_ = 0;
	int jong_change_cho; // \uC885\uC131\uC744 \uCD08\uC131\uC73C\uB85C \uBCC0\uD658
	class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e)	{
			...
			/******* \uC0AC\uC6A9\uC790\uAC00 \uC785\uB825\uD55C \uBC84\uD2BC\uC744 \uC815\uC218\uD615\uC73C\uB85C \uBCC0\uD658 ************/
			int num = 0;
			if(e.getActionCommand() == "\u3131") num = 0;
			else if(e.getActionCommand() == "\u3134") num = 1;
			else if(e.getActionCommand() == "-") num = 2;
			else if(e.getActionCommand() == "\u3145") num = 3;
			else if(e.getActionCommand() == "\u314F") num = 4;
			else if(e.getActionCommand() == "\u3153") num = 5;
			else if(e.getActionCommand() == "\u3161") num = 6;
			else if(e.getActionCommand() == "\u3163") num = 7;
			/********************************************************/
			
			
			record_.setText(record_.getText()+e.getActionCommand());
			// \uC0C1\uD0DC 0 : \uCC98\uC74C \uC2DC\uC791\uD55C \uC0C1\uD0DC, \uC544\uC9C1 \uCD08\uC131\uC774 \uB098\uC624\uC9C0 \uC54A\uC740 \uC0C1\uD0DC
			// \uC0C1\uD0DC 1 : \uCD08\uC131\uC774 \uB098\uC628 \uC0C1\uD0DC. \uCD08\uC131\uC774 \uC138\uBC88 \uB354 \uB098\uC62C \uC218 \uC788\uB2E4.
			// \uC0C1\uD0DC 2 : \uC911\uC131\uC774 \uB098\uC628 \uC0C1\uD0DC. \uC911\uC131\uC774 \uC138\uBC88 \uB354 \uB098\uC62C \uC218 \uC788\uB2E4.
			// \uC0C1\uD0DC 3 : \uC885\uC131\uC774 \uB098\uC628 \uC0C1\uD0DC. \uC885\uC131\uC774 \uC138\uBC88 \uB354 \uB098\uC62C \uC218 \uC788\uB2E4.
			// \uC774\uD6C4 \uC911\uC131\uC774\uB098 \uC885\uC131\uC774 \uB354 \uB098\uC628\uB2E4\uBA74 \uC0C1\uD0DC\uB97C 1\uB85C \uB9CC\uB4E0\uB2E4.

			// \uC0C1\uD0DC\uAC00 0\uC774\uB098 1\uC778\uB370 \uCD08\uC131\uC774 \uB098\uC628 \uACBD\uC6B0
			...
			// \uC911\uC131\uC744 \uB354 \uBC1B\uC544\uB4E4\uC774\uBA74 \uB428
			  ...
			  // \uC0C1\uD0DC\uAC00 2\uC778\uB370 \uC790\uC74C\uC774 \uB098\uC628 \uACBD\uC6B0 -> \uC885\uC131
			  else if (state_ == 2 && isCho(num)){
				  jong_change_cho = moveJong(num);  // \uC885\uC131\uC758 \uC0C1\uD0DC\uAC12 \uC800\uC7A5, \uD6C4\uC5D0 \uBAA8\uC74C\uC774 \uB098\uC624\uBA74 \uCD08\uC131\uC73C\uB85C \uBCC0\uD658
			  }
			  // \uC0C1\uD0DC\uAC00 2\uC778\uB370 \uC790\uC74C\uC774 \uB098\uC628 \uACBD\uC6B0 -> \uC885\uC131, \uCD08\uC131
			  else if (state_ == 3 && isCho(num)){
				  jong_change_cho = moveJong(num);  // \uC885\uC131\uC758 \uC0C1\uD0DC\uAC12 \uC800\uC7A5, \uD6C4\uC5D0 \uBAA8\uC74C\uC774 \uB098\uC624\uBA74 \uCD08\uC131\uC73C\uB85C \uBCC0\uD658
				  if(jong_change_cho >22){
					  if(jong_change_cho == 23) jong_change_cho=4;
					  if(jong_change_cho == 24) jong_change_cho=11;
					  if(jong_change_cho == 25) jong_change_cho=22;
					  if(jong_change_cho == 26) jong_change_cho=1;
					  if(jong_change_cho == 27) jong_change_cho=7;
					  if(jong_change_cho == 28) jong_change_cho=14;
					  if(jong_change_cho == 29) jong_change_cho=4;
					  if(jong_change_cho == 30) jong_change_cho=3;
					  if(jong_change_cho == 31) jong_change_cho=16;
					  if(jong_change_cho == 32) jong_change_cho=21;
					  if(jong_change_cho == 33) jong_change_cho=22;
					  if(jong_change_cho == 34) jong_change_cho=4;
				  }
			  }
			  // \uC0C1\uD0DC\uAC00 3\uC778\uB370 \uBAA8\uC74C\uC774 \uB098\uC628 \uACBD\uC6B0 -> \uC911\uC131, \uC55E\uC758 \uC885\uC131\uC744 \uCD08\uC131\uC73C\uB85C \uBCC0\uD658\uD574\uC57C \uD55C\uB2E4
			  else if (state_ == 3 && !isCho(num)){
				  reset();
				  cho_.setText(""+choSungs_.charAt(jong_change_cho));
				  moveJung(num);
			  }
			  // \uADF8 \uC774\uC678\uC758 \uACBD\uC6B0\uB294 \uC5D0\uB7EC\uC784 (\uC608\uB97C \uB4E4\uC5B4 \uC0C1\uD0DC\uAC00 0\uC778\uB370 \uC911\uC131\uC774 \uB098\uC628 \uACBD\uC6B0)
			  else {
				reset();
				setError();
			}
		...
		boolean isCho(int n) {
			if(4 <= n && n <= 7) return false;   // \uBC84\uD2BC \u314F,\u3153,\u3163,\u3161\uB97C \uC120\uD0DD\uD558\uAC8C \uB418\uBA74 \uCD08\uC131\uC774 \uC544\uB2D8
			return true;
		}
	}
}
