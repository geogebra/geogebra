 ...
 * The method <code>createWebView(String startURL)</code> has to be called to create and initialize the webView
 * 
 * @author stefan
 *
 */
public abstract class WebViewDialog extends JDialog {
	...
	/** The webview in this dialog. is created by the method <code>createWebView</code>. */
	...
	/**
	 * Creates and initializes the webview. This method has to be called from implementing dialogs to create the WebView.
	 * @param startURL The initial URL that will be loaded in the webview
	 ...
	 * @param startURL The Start URL that is loaded in the WebView
	 */
	...
	/**
	 * Returns the javaFX webEngine instance that is associated with this web view.
	 * @return The instance of WebEngine or null, if the web view was not created yet.
	 */
	...
	/**
	 * This method is called after a page was loaded in the WebView and can be overwritten
	...
	/**
	 * Can be overwritten to handle hyperlink clicks. This handler is only called, when <code>addHyperlinkListener()</code> was called.
	 *   
	 * @param href The URL of the clicked hyperlink
	 * @param absoluteURL If href is a relative URL this is the absolute URL. Otherwise this is the same as href.
	 * @param domainName The domainname of the clicked link.
	 * @param ev The web event that was triggered. Can be used to gather more detailed information about the clicked element or to 
	 * prevent the default action by calling <code>ev.preventDefault()</code>.
	 */
	...
	/**
	 * Adds a listener for clicks on hyperlinks, if not added yet. This method has to be called from <code>onPageLoaded</code>.
	 * 
	 * Calls the method <code>onLinkClicked(String href)</code> when a link was clicked 
	 */
                ...
                if (domEventType.equals(EVENT_TYPE_CLICK)) {
                    ...
                    if (href != null) {
                        ...
                        if (!href.startsWith("http://") && !href.startsWith("https://")) {
                        	domainName = (String) getWebEngine().executeScript("window.location.origin");
                        	absoluteURL = domainName + href;
                        } else {
                        	domainName = getDomainNameFromURL(absoluteURL);
                        }
                    	WebViewDialog.this.onHyperlinkClicked(href, absoluteURL, domainName, ev);
                    }
                }
