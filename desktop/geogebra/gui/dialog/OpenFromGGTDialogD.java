...
/**
 * A dialog for searching and opening materials from GeoGebraTube
 * This dialog will show a web view that opens a special version of the search dialog from GeoGebraTube
 * 
 * @author stefan
 *
 */
public class OpenFromGGTDialogD extends WebViewDialog {
	...
	private static String GGT_URL = "http://test.geogebratube.org:8080/widgetprovider/index/widgettype/desktop";
	...
	protected void onPageLoaded() {
		...
		/**
		 * Add an alert handler that listens to the alert call that passes the URL of the material to open to this webview
		 */
