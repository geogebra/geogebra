...
public class MatchingBlockManager {
     ...
     * @param pane the GeoGebraEditorPane associated with this Manager
     * @param lr if true the matching is from left to right
     * @param highlighter the highlighter to use
     */
    public MatchingBlockManager(Document doc, GeoGebraEditorPane pane, boolean lr, Highlighter highlighter) {
        this.doc = doc;
        this.pane = pane;
     ...
     * @param type one of the three values : GeoGebraKeywordsPainter.FILLED
     ...
     */
    public class GeoGebraKeywordsPainter extends DefaultHighlighter.DefaultHighlightPainter {
