...
2: { cmd: "Integral[x^2]", result: "x³ / 3 + arbconst(1)", notes:"" },
3: { cmd:"Integral[x^2]", result:"x³ / 3 + arbconst(1)" },
4: { cmd:"Integral[x^2,0,1]", result:"1/3" },
5: { cmd:"Integral[t^2]", result:"t³ / 3 + arbconst(1)" },
6: { cmd:"Integral[t^2,t]", result:"t³ / 3 + arbconst(1)" },
...
19: { cmd:"Cauchy[20,3,2]", result:"", notes:"(-2 atan(1 / 20) + π) / (2π) "},
...
25: { cmd:"ChiSquared[7,4]", result:"gammaRegularized(7 / 2, 2)", notes:"needs numeric check too, more digits needed" },
26: { cmd:"CompleteSquare[x^2-4x+3]", result:"(x - 2)² - 1" },
27: { cmd:"CompleteSquare[y^2-8y+3]", result:"(y - 4)² - 13" },
28: { cmd:"CommonDenominator[1/(x^2-1),1/(x+1)]", result:"x²-1" },
...
42: { cmd:"Degree[x^3*y^2+y^2-x,y]", result:"5" },
...
61: { cmd:"FDistribution[3,7,2]", result:"betaRegularized(3 / 2, 7 / 2, 6 / 13)", notes:"Reduce gives 0.797306357513350797 in Numeric mode" },
62: { cmd:"Flatten[{{1,2},{3,4}}]", result:"{1,2,3,4}" },
63: { cmd:"First[{3,4,5}]", result:"{3}" },
64: { cmd:"First[{3,4,5,6,7,8},2]", result:"{3,4}" },
65: { cmd:"FitExp[ {(0.44, 0.42), (1.7, 0.48), (2.7, 1.2), (3.5, 1.78), (4.36, 2.64), (5.12, 3.76), (5.78, 4.66)} ]", result:"0.290435875517995ℯ^(0.493486684688428x)" },
66: { cmd:"FitLog[ {(0.44, 0.42), (1.7, 0.48), (2.7, 1.2), (3.5, 1.78), (4.36, 2.64), (5.12, 3.76), (5.78, 4.66)} ]", result:"1.45942046561421ln(x) + 0.713291243375409" },
67: { cmd:"FitPoly[ {(0.44, 0.42), (1.7, 0.48), (2.7, 1.2), (3.5, 1.78), (4.36, 2.64), (5.12, 3.76), (5.78, 4.66)} ,3]", result:"-0.00777623749522 x³ + 0.228417298038848x² - 0.341171655092853x + 0.511167962733187" },
68: { cmd:"FitPow[ {(0.44, 0.42), (1.7, 0.48), (2.7, 1.2), (3.5, 1.78), (4.36, 2.64), (5.12, 3.76), (5.78, 4.66)}]", result:"0.601030151244602x^0.961817104673967" },
...
73: { cmd:"HyperGeometric[100,40,10,3,true]", result:"0.374237582463086" },
74: { cmd:"HyperGeometric[100,40,10,3,false]", result:"0.220430742685563" },
...
80: { cmd:"Integral[sec(x)]", result:"2((-1)/8ln(abs(sin(x)+1/sin(x)-2))+1/8ln(abs(sin(x)+1/sin(x)+2)))+arbconst(1)" },
81: { cmd:"Derivative[Integral[sec(x)]]", result:"" },
82: { cmd:"Integral[y^2]", result:"1 / 3 y³ + c_1" },
...
117: { cmd:"LimitAbove[ln(x),0]", result:"-infinity" },
...
122: { cmd:"Median[{4,5,3,7,8,8,8,9}]", result:"15/2", notes:"median does an evalf before sorting data, answer is therefore numeric" },
...
128: { cmd:"NIntegral[exp(x^2),0,5]", result:"7354153747.83713" },
129: { cmd:"NIntegral[exp(y^2),0,5]", result:"7354153747.83713" },
...
134: { cmd:"NSolutions[sin(x)]", result:"{0}" },
135: { cmd:"NSolutions[sin(x),x=4]", result:"{3.14159265360127}" },
136: { cmd:"NSolve[sin(x)]", result:"{x=0}" },
137: { cmd:"NSolve[sin(x),x=4]", result:"{x = 3.14159265360127}" },
138: { cmd:"Numerator[1/x+x^2]", result:"x³+1" },
139: { cmd:"Numeric[pi]", result:"3.14159265358979", notes:"Reduce gives pi, check" },
...
145: { cmd:"Pascal[10,0.4,8,true]", result:"betaRegularized(10, 9, 0.4)" },
...
167: { cmd:"Root[x^5-x+1]", result:"{x = -1.167303978261419}" },
...
192: { cmd:"Solve[sin(x)=0]", result:"{x = 2k_1 π, x = 2k_1 π + π}" },
193: { cmd:"Solve[sin(x)=3]", result:"{}" },
194: { cmd:"SolveODE[y'=y / x]", result:"y = x c_1" },
...
205: { cmd:"Tangent[1/3, x^2]", result:"y = (6x-1)/9" },
...
209: { cmd:"TDistribution[4,2]", result:"(-betaRegularized(2, 1 / 2, 1 / 2) + betaRegularized(2, 1 / 2, 1) + 1) / 2", notes:"0.941941738241592" },
210: { cmd:"ToComplex[(1,2)]", result:"1+2ί" },
211: { cmd:"ToExponential1+2ί]", result:"sqrt(5) ℯ^(atan(2) ί)" },
