...
public class VectorialPointValuePair implements Serializable {
    ...
    public VectorialPointValuePair(final double[] point, final double[] value) {
        this.point = (point == null) ? null : Cloner.clone(point);
        this.value = (value == null) ? null : Cloner.clone(value);
    }
    ...
    public VectorialPointValuePair(final double[] point, final double[] value,
        ...
        this.point = copyArray ?
                      ((point == null) ? null : Cloner.clone(point)) :
                      point;
        this.value = copyArray ?
                      ((value == null) ? null : Cloner.clone(value)) :
                      value;
    }
    ...
    public double[] getPoint() {
        return (point == null) ? null : Cloner.clone(point);
    }
    ...
    public double[] getValue() {
        return (value == null) ? null : Cloner.clone(value);
    }
