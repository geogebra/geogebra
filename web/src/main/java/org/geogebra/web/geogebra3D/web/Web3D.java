package org.geogebra.web.geogebra3D.web;
...
//		setLocaleToQueryParam();
	...
	native void exportArticleTagRenderer() /*-{
	    $wnd.GGW_ext.render = $entry(@org.geogebra.web.geogebra3D.web.Web3D::renderArticleElement(Lcom/google/gwt/dom/client/Element;Lcom/google/gwt/core/client/JavaScriptObject;));
    }-*/;
	
	private native void exportGGBElementRenderer() /*-{
	 	$wnd.renderGGBElement = $entry(@org.geogebra.web.geogebra3D.web.Web3D::renderArticleElement(Lcom/google/gwt/dom/client/Element;Lcom/google/gwt/core/client/JavaScriptObject;));
	...
	static void startGeoGebra(ArrayList<ArticleElement> geoGebraMobileTags) {
		...
		org.geogebra.web.web.gui.applet.GeoGebraFrameBoth.main(geoGebraMobileTags, (AppletFactory) GWT.create(AppletFactory.class), Web.getLAF(geoGebraMobileTags));
