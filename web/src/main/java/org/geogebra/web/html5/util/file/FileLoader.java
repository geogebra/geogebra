...
public class FileLoader {
	 ...
	 */
	public static void loadFile(final String fileUrl, final Callback callback) {
		HttpRequest httpRequest = UtilFactoryW.getPrototype().newHttpRequest();
		httpRequest.sendRequestPost(fileUrl, "GET", new AjaxCallback() {
			@Override
