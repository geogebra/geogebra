...
public class ZoomPanel extends FlowPanel
    ...
    /**
     * @param view        The Euclidian View to put zoom buttons onto.
     * @param app         see {@link AppW}
     * @param rightBottom whether this is placed in the right bottom
     * @param zoomable    whether zoom buttons are allowed in this view
     */
     ...
     *
     * @param hidden whether this should be hidden
     */
    ...
    /**
     * @param bottomRight whether the zoom panel's parent is now bottom right panel
     */
