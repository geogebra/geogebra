 ...
 * </p>
 */
public class MySplitlayoutPanel extends MyDockLayoutPanel {
  ...
  /**
   * Construct a new {@link MySplitlayoutPanel} with the default splitter size of
   * 8px.
   */
  ...
  /**
   * Construct a new {@link MySplitlayoutPanel} with the specified splitter size
   * in pixels.
   *
