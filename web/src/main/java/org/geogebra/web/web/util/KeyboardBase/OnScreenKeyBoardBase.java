 ...
 */
public class OnScreenKeyBoardBase extends PopupPanel {
	 ...
	 */
	private HashMap<KeyBoardButtonBase, String> updateButton = new HashMap<KeyBoardButtonBase, String>();
	 ...
	 * @return
	 */
	private KeyPanelBase getControlKeyPanel() {
	 ...
	 */
	private KeyBoardButtonBase addButton(String caption, int index,
			KeyPanelBase panel) {
	 ...
	 * @return {@link KeyBoardButtonBase}
	 */
	private KeyBoardButtonBase addButton(String caption, String feedback,
	 ...
	 */
	private KeyBoardButtonFunctionalBase addFunctionalButton(int index,
			KeyPanelBase keyPanel, String caption, Action action) {
		KeyBoardButtonFunctionalBase button = new KeyBoardButtonFunctionalBase(caption,
		        this, action);
	 ...
	 * @return {@link KeyBoardButtonFunctionalBase}
	 */
	private KeyBoardButtonFunctionalBase addFunctionalButton(ImageResource image,
 Action action, int index, KeyPanelBase keyPanel) {
		KeyBoardButtonFunctionalBase button = new KeyBoardButtonFunctionalBase(image,
		        this, action);
		keyPanel.addToRow(index, button);
		return button;
	}
	 ...
	 * @param accent
	 */
	private void setToAccents(String accent, KeyBoardButtonBase source) {
		accentButton = source;
	...
	void updateKeys(String updateSection, String language) {
		...
		for (int i = 0; i < NUM_LETTER_BUTTONS; i++) {
			...
			if (!(button instanceof KeyBoardButtonFunctionalBase)) {
				...
				// TODO
				String newCaption = loc.getKey(generateKey(i), updateSection,
						language);
