...
public class PopupPanel extends SimplePanel implements SourcesPopupEvents,
		...
		public void setState(boolean showing, boolean isUnloading) {
			...
			if (animate) {
				...
				if (showing) {
					...
					curPanel.getElement().getStyle().setProperty("position",
							"absolute");
	...
	/**
	 * @deprecated Use {@link #addCloseHandler} instead. This method does
	 *             nothing.
	 */
	@Override
	@Deprecated
	 ...
	 *             the object returned by {@link #addCloseHandler} instead. This
	 *             method does nothing.
	 */
	@Override
	@Deprecated
