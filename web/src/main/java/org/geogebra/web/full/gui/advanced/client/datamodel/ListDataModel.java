...
public interface ListDataModel {
	 ...
	 *
	 * @param id
	 *            an unique ID of the item. If there is an item with the same
	 *            ID, this method replaces it with a new value.
	 * @param item
	 *            is an item to be placed into the list.
	 */
	 ...
	 *
	 * @param listener
	 *            is a listener to remove.
	 */
	void removeListModelListener(ListModelListener listener);

	/**
	 * Adds all the items from the map where each key is an item unique ID and
	 * each value is an item itself.
	 *
	 * @param items
	 *            is a map of items to add all.
	 */
