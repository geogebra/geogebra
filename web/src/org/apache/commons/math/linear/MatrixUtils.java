...
//ARimport java.io.IOException;
//ARimport java.io.ObjectInputStream;
//ARimport java.io.ObjectOutputStream;
//ARimport java.lang.reflect.Array;
//ARimport java.math.BigDecimal;
//ARimport java.util.Arrays;
...
public class MatrixUtils {
     ...
     * @since 2.0
     */
    /*ARpublic static <T extends FieldElement<T>> FieldMatrix<T> createFieldMatrix(final Field<T> field,
                                                                               final int rows,
                                                                               final int columns) {
        return (rows * columns <= 4096) ?
     ...
     * @since 2.0
     */
    /*ARpublic static <T extends FieldElement<T>> FieldMatrix<T> createFieldMatrix(T[][] data) {
        return (data.length * data[0].length <= 4096) ?
     ...
     * @since 2.0
     */
    /*ARpublic static <T extends FieldElement<T>> FieldMatrix<T>
     ...
     * @throws NullPointerException if <code>data</code>is null
     */
    /*ARpublic static RealVector createRealVector(double[] data) {
     ...
     * @throws NullPointerException if <code>data</code>is null
     */
    /*ARpublic static <T extends FieldElement<T>> FieldVector<T> createFieldVector(final T[] data) {
     ...
     */
    /*ARpublic static RealMatrix createRowRealMatrix(double[] rowData) {
     ...
     */
    /*ARpublic static RealMatrix createColumnRealMatrix(double[] columnData) {
     ...
     */
    /*ARpublic static void checkSubMatrixIndex(final AnyMatrix m,
     ...
     */
    /*ARpublic static Array2DRowRealMatrix fractionMatrixToRealMatrix(final FieldMatrix<Fraction> m) {
    ...
    /*ARprivate static class FractionMatrixConverter extends DefaultFieldMatrixPreservingVisitor<Fraction> {
*/
        /** Converted array. */
        /*ARprivate double[][] data;*/

        /** Simple constructor. */
        /*ARpublic FractionMatrixConverter() {
            super(Fraction.ZERO);
        }*/
         ...
         * @return converted matrix
         */
        /*ARArray2DRowRealMatrix getConvertedMatrix() {
     ...
     * @return converted matrix
     */
    /*ARpublic static Array2DRowRealMatrix bigFractionMatrixToRealMatrix(final FieldMatrix<BigFraction> m) {
    ...
    /*ARprivate static class BigFractionMatrixConverter extends DefaultFieldMatrixPreservingVisitor<BigFraction> {
*/
        /** Converted array. */
        /*ARprivate double[][] data;*/

        /** Simple constructor. */
        /*ARpublic BigFractionMatrixConverter() {
     ...
     */
    /*ARpublic static void serializeRealVector(final RealVector vector,
     ...
     */
    /*ARpublic static void deserializeRealVector(final Object instance,
     ...
     */
    /*ARpublic static void serializeRealMatrix(final RealMatrix matrix,
                                           final ObjectOutputStream oos)
        throws IOException {
     ...
     */
    /*ARpublic static void deserializeRealMatrix(final Object instance,
                                             final String fieldName,
                                             final ObjectInputStream ois)
      throws ClassNotFoundException, IOException {
        try {
