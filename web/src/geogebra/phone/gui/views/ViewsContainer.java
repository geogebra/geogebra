...
/**
 * 
 * A {@link ScrollPanel} containing all existing views (algebra, graphics,
 * worksheets, options)
 *
 */
public class ViewsContainer extends SimplePanel implements ResizeListener {
	...
	/**
	 * not in use yet - to swipe views // private void swipe(boolean toLeft) {
	 * // int switchTo = toLeft ? 1 : -1; // View view =
	 * getView(this.currentView.getIndex() + switchTo); // if (view != null) {
	 * // scrollTo(view); // } // } // // @Override // public void
	 * scrollToLeft() { // swipe(true); // } // // @Override // public void
	 * scrollToRight() { // swipe(false); // } //
	 **/
