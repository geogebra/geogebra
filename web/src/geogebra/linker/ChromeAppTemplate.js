 ...
 * the License.
 * 
 * Modified by gabor, to avoid doc.write
 */
...
window.__MODULE_FUNC__ = function() {
  ...
  function computeScriptBase() {
    ...
    //avoid doc.write $doc.write('<script id="__gwt_marker___MODULE_NAME__"></script>');
    markerScript = $doc.createElement("script");
    markerScript.setAttribute("id", "__gwt_marker___MODULE_NAME__");
    $doc.appendChild(markerScript);
