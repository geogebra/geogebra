...
public class ScriptManagerW extends ScriptManager {
	...
	private native void initAppletFunctions(
		...
		$wnd[ggbApplet].login = function(xml) {
			ggbAPI.@geogebra.html5.main.GgbAPI::login(Ljava/lang/String;)(xml);
		};
		...
		$wnd[ggbApplet].openMaterial = function(material) {
			ggbAPI.@geogebra.html5.main.GgbAPI::openMaterial(Ljava/lang/String;)(material);
		};
		
		$wnd[ggbApplet].ensureEditing = function() {
			ggbAPI.@geogebra.html5.main.GgbAPI::ensureEditing()();
		};
		...
		$wnd[ggbApplet].registerStoreUndoListener = function(JSFunctionName) {
			ggbAPI.@geogebra.html5.main.GgbAPI::registerStoreUndoListener(Ljava/lang/String;)(JSFunctionName);
		};
		...
		$wnd[ggbApplet].registerClientListener = function(JSFunctionName) {
			ggbAPI.@geogebra.html5.main.GgbAPI::registerClientListener(Ljava/lang/String;)(JSFunctionName);
		};
		
		$wnd[ggbApplet].unregisterClientListener = function(JSFunctionName) {
			ggbAPI.@geogebra.html5.main.GgbAPI::unregisterClientListener(Ljava/lang/String;)(JSFunctionName);
		};
