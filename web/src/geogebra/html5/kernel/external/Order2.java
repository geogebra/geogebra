...
final class Order2 extends Curve {
	...
	public static void insert(Vector curves, double tmp[], double x0,
	...
	public static void addInstance(Vector curves, double x0, double y0,
	...
	public Order2(double x0, double y0, double cx0, double cy0, double x1,
	...
	public Curve getSubCurve(double ystart, double yend, int dir) {
		...
		return new Order2(eqn[i + 0], ystart, eqn[i + 2], eqn[i + 3],
		        eqn[i + 4], yend, dir);
	}
