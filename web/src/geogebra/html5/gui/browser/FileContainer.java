...
public class FileContainer extends HorizontalPanel implements ResizeListener {
	...
	/*
	 * private StandardButton locationSkyDrive; private StandardButton
	 * locationLocal;
	 */
	...
	protected EventRenderable loginCallback = new EventRenderable(){
		...
		public void renderEvent(BaseEvent e){
			GoogleDriveOperationW op = ((AppW) FileContainer.this.app).getGoogleDriveOperation();
			if (active && op.isLoggedIntoGoogle()) {
				op.initFileNameItems(FileContainer.this.bg);
				active = false;
			}
		}
	};
