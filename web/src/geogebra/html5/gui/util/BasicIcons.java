...
public class BasicIcons {
	...
	protected static Canvas getTmpCanvas(int w, int h) {
		...
		ctx.clearRect(0, 0, tmpCanvas.getCoordinateSpaceWidth(),
		        tmpCanvas.getCoordinateSpaceHeight());
		return tmpCanvas;
	}

	public static ImageData createUpDownTriangleIcon(boolean isRollOver,
	        boolean isEnabled) {
		int h = 18;
		int w = 12;
