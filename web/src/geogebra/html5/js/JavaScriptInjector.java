...
public class JavaScriptInjector {
    ...
    public static void inject(TextResource scriptResource) {
    	if (DOM.getElementById(scriptResource.getName()) == null) {
    		ScriptElement element = createScriptElement(scriptResource.getName());
	...
	/**
	 * @param js to inject
	 * @return wheter the js injected already, or not. This check is made during injection, but can be useful.
	 */
