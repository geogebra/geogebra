 ...
 * <ul>
 * <li><code>private void writeObject(java.io.ObjectOutputStream s)</code></li>
 * <li><code>private void readObject(java.io.ObjectInputStream s)</code></li>
 * </ul>
 *
...
public class AffineTransform implements Cloneable {
	 ...
	 *            the angle of rotation in radians
	 * @param x
	 *            ,&nbsp;y the coordinates of the anchor point of the rotation
	 ...
	 *
	 * @param m00
	 *            ,&nbsp;m01,&nbsp;m02,&nbsp;m10,&nbsp;m11,&nbsp;m12 the 6
	 *            floating point values that compose the 3x3 transformation
	 *            matrix
	 */
