...
public class EuclidianView3DWnoWebGL extends EuclidianView3DW {
	...
	public void onResize(){
		...
		g2p.getCanvas().getElement().getParentElement().getStyle().setWidth(g2p.getCoordinateSpaceWidth(), Unit.PX);
		g2p.getCanvas().getElement().getParentElement().getStyle().setHeight(g2p.getCoordinateSpaceHeight(), Unit.PX);
	}
