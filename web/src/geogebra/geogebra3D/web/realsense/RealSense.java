...
public class RealSense {
		...
		$wnd
				...
				.then(
						function(result) {
							...
							return @geogebra.geogebra3D.web.realsense.RealSense::sense
				...
				.then(
						function(result) {
							...
							return @geogebra.geogebra3D.web.realsense.RealSense::handConfiguration
									.EnableAllAlerts();
						})
				.then(
						function(result) {
	...
	public static native void realSenseClose() /*-{
		@geogebra.geogebra3D.web.realsense.RealSense::sense
				.Close()
				.then(
						function(result) {
