...
public class GAffineTransformW implements geogebra.common.awt.GAffineTransform {
	...
	public void transform(GPoint2D p, GPoint2D p2) {
		geogebra.web.openjdk.awt.geom.Point2D point = geogebra.web.awt.GPoint2DW
		        .getGawtPoint2D(p);
		geogebra.web.openjdk.awt.geom.Point2D point2 = geogebra.web.awt.GPoint2DW
		        .getGawtPoint2D(p2);
	...
	public geogebra.common.awt.GAffineTransform createInverse() throws Exception {
		...
		return new geogebra.web.awt.GAffineTransformW(at.createInverse());
	}
