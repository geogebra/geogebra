...
public class GRectangle2DW implements geogebra.common.awt.GRectangle2D, geogebra.web.awt.GShapeW {
	...
	public GPathIterator getPathIterator(GAffineTransform affineTransform) {
		return new geogebra.web.awt.GPathIteratorW(getImpl().getPathIterator(geogebra.web.awt.GAffineTransformW.getGawtAffineTransform(affineTransform)));
    }

	public GPathIterator getPathIterator(GAffineTransform at, double flatness) {
		return new geogebra.web.awt.GPathIteratorW(getImpl().getPathIterator(geogebra.web.awt.GAffineTransformW.getGawtAffineTransform(at), flatness));
    }
	...
	public geogebra.common.awt.GRectangle2D createIntersection(
	    ...
	    return new geogebra.web.awt.GRectangle2DW(
	    		getImpl().createIntersection(geogebra.web.awt.GRectangle2DW.getGawtRectangle2D(r)));

    }

	public static geogebra.web.openjdk.awt.geom.Rectangle2D getGawtRectangle2D(
			geogebra.common.awt.GRectangle2D p){
		if(!(p instanceof geogebra.web.awt.GRectangle2DW))
			return null;
		return ((geogebra.web.awt.GRectangle2DW)p).getImpl();
    }
