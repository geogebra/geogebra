...
public class GArc2DW extends geogebra.common.awt.GArc2D implements GShapeW {
	...
	public GPathIterator getPathIterator(GAffineTransform affineTransform) {
		return new geogebra.web.awt.GPathIteratorW( 
				impl.getPathIterator(geogebra.web.awt.GAffineTransformW.getGawtAffineTransform(affineTransform)));
	}

	
	public GPathIterator getPathIterator(GAffineTransform at, double flatness) {
		return new geogebra.web.awt.GPathIteratorW(
				impl.getPathIterator(geogebra.web.awt.GAffineTransformW.getGawtAffineTransform(at), flatness));
	}
