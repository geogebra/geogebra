...
public class BasicStroke implements geogebra.common.awt.BasicStroke {
    ...
    public geogebra.common.awt.Shape createStrokedShape(geogebra.common.awt.Shape s) {
        w2 = width / 2.0;
     ...
     */
    void createSolidShape(geogebra.common.awt.PathIterator pathIterator) {
     ...
     * @param pathIterator - the PathIterator of source shape
     */
    void createDashedShape(geogebra.common.awt.PathIterator pathIterator) {
        double coords[] = new double[6];
        mx = my = cx = cy = 0.0;
        smx = smy = scx = scy = 0.0;
        isMove = false;
    ...
    static class BufferedPath {
        ...
        geogebra.common.awt.GeneralPath createGeneralPath() {
