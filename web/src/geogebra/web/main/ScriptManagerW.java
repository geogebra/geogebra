...
public class ScriptManagerW extends ScriptManager {
	...
	private native void initAppletFunctions(
		...
		$wnd[ggbApplet].getBase64 = function(param1, param2) {
			if(param2){
				return ggbAPI.@geogebra.web.main.GgbAPI::getBase64(Lboolean;Lcom/google/gwt/core/client/JavaScriptObject;)(param1, param2);
			}else{
				return ggbAPI.@geogebra.web.main.GgbAPI::getBase64(Lcom/google/gwt/core/client/JavaScriptObject;)(param1);
			}
		}
		...
		$wnd[ggbApplet].evalGeoGebraCAS = function(cmdString) {
			return ggbAPI.@geogebra.web.main.GgbAPI::evalGeoGebraCAS(Ljava/lang/String;)(cmdString);
		};

		$wnd[ggbApplet].evalCommandCAS = function(cmdString) {
			return ggbAPI.@geogebra.web.main.GgbAPI::evalCommandCAS(Ljava/lang/String;)(cmdString);
		};
