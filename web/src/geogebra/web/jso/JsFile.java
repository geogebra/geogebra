...
public class JsFile extends JsBlob {
	 ...
	 * There are numerous file name variations on different systems;
	...
	/**
	 * The last modified date of the file as valid HTML5 date string
	 * or the empty string if it is not known.
	 * 
