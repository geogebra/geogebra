...
public final class HashCode {
    ...
    public static int combine(int hashCode, float value) {    
        //AR int v = Float.floatToIntBits(value);
    	int v = new Float(value).hashCode();//AR imperfect in GWT
        return combine(hashCode, v);
    }
    ...
    public static int combine(int hashCode, double value) {    
        //AR long v = Double.doubleToLongBits(value);
    	long v = new Double(value).hashCode();//AR
        return combine(hashCode, v);
    }
