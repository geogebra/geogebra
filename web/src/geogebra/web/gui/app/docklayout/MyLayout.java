 ...
 * the License.
 */
package geogebra.web.gui.app.docklayout;
 ...
 * and pass it to {@link #MyLayout(Element)}. Rather than attaching child elements
 * directly to the element managed by this {@link MyLayout}, use the
 * {@link MyLayout#attachChild(Element)} method. This will attach the child
 * element and return a {@link MyLayout.Layer} object which is used to manage the
 * child.
 * </p>
 * 
 * <p>
 * A separate {@link MyLayout.Layer} instance is associated with each child
...
public class MyLayout {
  ...
  /**
   * Callback interface used by {@link MyLayout#layout(int, AnimationCallback)}
   ...
   * <ul>
   * <li>{@link MyLayout.Layer#setLeftRight}</li>
   * <li>{@link MyLayout.Layer#setLeftWidth}</li>
   * <li>{@link MyLayout.Layer#setRightWidth}</li>
   * <li>{@link MyLayout.Layer#setTopBottom}</li>
   * <li>{@link MyLayout.Layer#setTopHeight}</li>
   * <li>{@link MyLayout.Layer#setBottomHeight}</li>
   * </ul>
   * </p>
   * 
   * <p>
   ...
   */
  public MyLayout(Element parent) {
