...
import geogebra.web.gui.app.docklayout.MyLayout.AnimationCallback;
import geogebra.web.gui.app.docklayout.MyLayout.Layer;
 ...
 * </p>
 */
public class MyLayoutCommand implements ScheduledCommand {

  private boolean scheduled, canceled;
  private int duration;
  private MyLayout.AnimationCallback callback;
   ...
   * @param layout
   */
  public MyLayoutCommand(MyLayout layout) {
    this.layout = layout;
  }
  ...
  public final void execute() {
    ...
    layout.layout(duration, new MyLayout.AnimationCallback() {
