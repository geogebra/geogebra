		...
		el.onchange = function(event) {
			...
			if (files.length) {
				...
				for (var i = 0, j = files.length; i < j; ++i) {
					...
					appl.@geogebra.html5.main.AppW::openFileAsImage(Lcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;)(fileToHandle, dialog.@geogebra.web.gui.dialog.FileInputDialog::getNativeHideAndFocus()());				
					break
				}
			}
		};
