...
public class DomHelperImpl implements DomHelper {
	...
	private native void nativeSetProperty(JavaScriptObject target, String name, String value) /*-{
		target[name] = value;
	}-*/;
	
	public native void nativeSetNativeEventHandler(Element element, String eventName, Handler handler) /*-{
