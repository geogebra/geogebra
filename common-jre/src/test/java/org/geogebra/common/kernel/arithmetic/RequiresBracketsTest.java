...
public class RequiresBracketsTest extends BaseUnitTest {
	...
	public void testFunctionMinusFunction() {
		...
		lookup("eq1").setToStringMode(EquationForm.Linear.USER.rawValue);
	...
	public void testFunctionsTimesFunction() {
		...
		lookup("eq0").setToStringMode(EquationForm.Quadric.USER.rawValue);
		lookup("eq1").setToStringMode(EquationForm.Quadric.USER.rawValue);
		lookup("eq2").setToStringMode(EquationForm.Quadric.USER.rawValue);
		lookup("eq3").setToStringMode(EquationForm.Quadric.USER.rawValue);
